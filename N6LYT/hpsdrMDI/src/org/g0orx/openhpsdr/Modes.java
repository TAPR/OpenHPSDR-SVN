...
public class Modes {
    ...
    private static Mode[] modes = {
        new Mode("LSB", LSB, LSBfilters),
        new Mode("USB", USB, USBfilters),
        new Mode("DSB", DSB, DSBfilters),
        new Mode("CWL", CWL, CWLfilters),
        new Mode("CWU", CWU, CWUfilters),
        new Mode("FMN", FMN, FMNfilters),
        new Mode("AM", AM, AMfilters),
        new Mode("DIGU", DIGU, DIGUfilters),
        new Mode("SPEC", SPEC, SPECfilters),
        new Mode("DIGL", DIGL, DIGLfilters),
        new Mode("SAM", SAM, SAMfilters),
        new Mode("DRM", DRM, DRMfilters)
    };
