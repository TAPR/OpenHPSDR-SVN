...
namespace MsgBoxCheck
{
	public class MessageBox
	{
        ...
        // modified to add yes/no buttons and store result.
        public DialogResult Show(string strKey, string strValue, string strCheck, string strText, string strTitle, MessageBoxButtons buttons, MessageBoxIcon icon)
        {
            DialogResult dr;

            RegistryKey regKey = Registry.CurrentUser.CreateSubKey(strKey);
            int? savedValue = regKey.GetValue(strValue) as int?;

            if (savedValue != null) return (DialogResult)savedValue;
            ...
            if (m_bCheck) regKey.SetValue(strValue, (int)dr);
            return dr;
        }
        ...
        {
            return Show(strKey, strValue, strCheck, strText, strTitle, buttons, MessageBoxIcon.None);
        }

        public DialogResult Show(string strKey, string strValue, DialogResult dr, string strCheck, string strText, string strTitle)
        {
            return Show(strKey, strValue, strCheck, strText, strTitle, MessageBoxButtons.OK, MessageBoxIcon.None);
        }

        public DialogResult Show(string strKey, string strValue, DialogResult dr, string strCheck, string strText)
        {
            return Show(strKey, strValue, strCheck, strText, "", MessageBoxButtons.OK, MessageBoxIcon.None);
        }
