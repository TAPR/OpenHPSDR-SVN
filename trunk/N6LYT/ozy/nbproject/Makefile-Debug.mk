...
LDLIBSOPTIONS=-ljack -lusb

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug.mk dist/Debug/${PLATFORM}/ozy

dist/Debug/${PLATFORM}/ozy: ${OBJECTFILES}
	${MKDIR} -p dist/Debug/${PLATFORM}
	${LINK.c} -o dist/Debug/${PLATFORM}/ozy ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
${OBJECTDIR}/ozy_buffers.o: ozy_buffers.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/ozy_buffers.o ozy_buffers.c

${OBJECTDIR}/jack_client.o: jack_client.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/jack_client.o jack_client.c
...
${OBJECTDIR}/command_thread.o: command_thread.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/command_thread.o command_thread.c

${OBJECTDIR}/ozy_client.o: ozy_client.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/ozy_client.o ozy_client.c

${OBJECTDIR}/ozy_to_jack.o: ozy_to_jack.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/ozy_to_jack.o ozy_to_jack.c

${OBJECTDIR}/jack_ringbuffer.o: jack_ringbuffer.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/jack_ringbuffer.o jack_ringbuffer.c

${OBJECTDIR}/spectrum_buffers.o: spectrum_buffers.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/spectrum_buffers.o spectrum_buffers.c

${OBJECTDIR}/jack_buffers.o: jack_buffers.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/jack_buffers.o jack_buffers.c

${OBJECTDIR}/ozy_ringbuffer.o: ozy_ringbuffer.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/ozy_ringbuffer.o ozy_ringbuffer.c
