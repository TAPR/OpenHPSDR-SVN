...
public class AHPSDRActivity extends Activity implements SensorEventListener {
		...
		case MENU_CONNECTION:
			...
			builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int whichButton) {
					...
					connection.close();
					server=value;	
					connection = new Connection(server, BASE_PORT + receiver,width, useRTP);
					connection.setSpectrumView(spectrumView);
					connection.connect();
					connection.start();
					connection.setFrequency(frequency);
			...
			*/
            ...
            final TextView server_text = (TextView) dialog.findViewById(R.id.server);
            server_text.setText(server);
            final TextView receiver_text = (TextView) dialog.findViewById(R.id.receiver);
            receiver_text.setText(Integer.toString(receiver));
            ...
            button.setOnClickListener(new OnClickListener() {
                public void onClick(View v) {
                	...
                	receiver=Integer.parseInt(receiver_text.getText().toString());
					Log.i("Server",server);
					Log.i("receiver",Integer.toString(receiver));
					update.close();
					mode=connection.getMode();
					frequency=connection.getFrequency();
					filterLow=connection.getFilterLow();
	...
	private int BASE_PORT = 10800;
	private int AUDIO_PORT = 10900;
