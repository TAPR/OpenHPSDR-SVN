...
public:
    ...
    void setupUi(QMainWindow *UI)
    {
        ...
        gridLayout->addWidget(spectrumFrame, 0, 0, 1, 3);
        ...
        gridLayout->addWidget(waterfallFrame, 1, 0, 1, 3);
        ...
        toolBar = new QToolBar(UI);
        toolBar->setObjectName(QString::fromUtf8("toolBar"));
        UI->addToolBar(Qt::TopToolBarArea, toolBar);
    ...
    void retranslateUi(QMainWindow *UI)
    {
        ...
        actionConfigure->setText(QApplication::translate("UI", "Configure", 0, QApplication::UnicodeUTF8));
        actionQuit->setText(QApplication::translate("UI", "Quit", 0, QApplication::UnicodeUTF8));
        ...
        menuFile->setTitle(QApplication::translate("UI", "File", 0, QApplication::UnicodeUTF8));
        toolBar->setWindowTitle(QApplication::translate("UI", "toolBar", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
