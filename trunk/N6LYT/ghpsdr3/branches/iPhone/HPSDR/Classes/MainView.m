...
- (void)drawRect:(CGRect)rect {
	...
	//CGContextShowTextAtPoint(context,370,315.0,"iHPSDR (by G0ORX)",17);
...
- (void)touchesMoved:(NSSet *)touches withEvent:(UIEvent *)event {
	...
	//sprintf(command,"scrollFrequency %d", (int)(lastLocation.x-touchLocation.x));
	//sendCommand(command);
	lastLocation=touchLocation;
	//fprintf(stderr,"touchesMoved\n");
	
	//fprintf(stderr,"%s (%f,%f)\n",command,touchLocation.x,touchLocation.y);
}
