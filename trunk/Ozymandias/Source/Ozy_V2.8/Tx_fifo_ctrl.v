...
input  wire     [11:0] FWD;				// Forward power from ADC AIN4 on Penny(Lane)
input  wire     [11:0] REV;				// Reverse power from ADC AIN3 on Penny(Lane)

wire [7:0] Merc1_version;

assign Merc1_version = (Merc_serialno < 8'd33) ? 8'd33 : Merc_serialno;
...
localparam  MAX_ADDR = 4; // can go from 0 to 31 if needed
...
begin 
  case (tx_addr)
    ...
    begin
      ...
      C2_DATA = Merc1_version/*serialno*/;
    ...
    4:
    begin
      C1_DATA = {Merc1_version/*serialno*/[6:0], ADC_OVERLOAD};   //Mercury1 version & ovld report
      C2_DATA = {Merc2_version[6:0], ADC_OVERLOAD2};  //Mercury2 version & ovld report
      C3_DATA = {Merc3_version[6:0], ADC_OVERLOAD3};  //Mercury3 version & ovld report
      C4_DATA = {Merc4_version[6:0], ADC_OVERLOAD4};  //Mercury4 version & ovld report
    end
