...
void usage(void) {
  printf("write_i2c built @: %s %s\n", __DATE__, __TIME__);
  printf("usage: write_I2C <VID> <PID> <i2c_address in hex> <value1 in hex> <value2 in hex> <value3 in hex> <count in dec (1-3)>\n"); 
  return; 
} 
...
//printf("debug point 1\n");
  ...
  value1 = strtol(argv[4], NULL, 16);
  value2 = strtol(argv[5], NULL, 16);
  value3 = strtol(argv[6], NULL, 16);
