...
ECHO G. Program using Penelope_V1.7
ECHO H. Program using Penelope_V1.8
ECHO Q. Quit
ECHO.
SET Choice=
...
GOTO CONTINUE
:ItemG
%DIRECTORY% -c USB-Blaster Penelope_v1.7.cdf
GOTO CONTINUE
:ItemH
%DIRECTORY% -c USB-Blaster Penelope_v1.8.cdf
GOTO CONTINUE
:CONTINUE
PAUSE
CLS
