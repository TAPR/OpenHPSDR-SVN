...
5. To program Mercury run the batch file Program-Mercury-EPCS16.bat, select which version of Mercury code you wish to load
...
9. Test Mercury and Penelope with PowerSDR. If necessary recalibrate Frequency and Level.
