...
//VE3NEA
//JTAG function request
#define VRQ_JTAG_FUNC      0x0F
//JTAG function ID's
#define JF_PORT            0x00  //read/write port E
#define JF_LIST_DEV        0x01  //list devices in the chain
#define JF_START_CFG       0x02  //start fpga configuration
#define JF_XFER_CFG        0x03  //transfer fpga data
#define JF_END_CFG         0x04  //end fpga configuration
