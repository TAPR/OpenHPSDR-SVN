...
//                             computations
//------------------------------------------------------------------------------
reg signed [71:0] work_reg;


wire signed [71:0] new_intg_value = work_reg + ram_output;
wire signed [71:0] new_comb_value = work_reg - ram_output;


wire signed [71:0] ram_input = is_comb ? work_reg : new_intg_value;
wire signed [71:0] ram_output;
...
always @(posedge clock)
  case (state)
    ...
    7:
      begin
      out_data <= work_reg[71:48] + work_reg[47];
        out_strobe <= 1;
      rdaddress <= 0;
        state <= 0;
        end
