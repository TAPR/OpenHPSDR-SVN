   ...
   000F                     483 	.ds 1
                    ...
                    FC00    680 _EP8FIFOBUF	=	0xfc00
                            ...
                            707 	.area CSEG    (CODE)
                            708 ;------------------------------------------------------------
                            709 ;Allocation info for local variables in function 'fpga_load_begin'
                            710 ;------------------------------------------------------------
                            711 ;------------------------------------------------------------
   ...
   03C9                     716 _fpga_load_begin:
                    ...
                    0000    723 	ar0 = 0x00
                    0001    724 	ar1 = 0x01
                            725 ;Initial/src/fpga_load.c:41: HPSDR_ALTERA_CONFIG &= ~bmALTERA_BITS;		// clear all bits (NCONFIG low)
                            726 ;     genAnd
   03C9 53 A0 C0            727 	anl	_IOC,#0xC0
                            728 ;Initial/src/fpga_load.c:42: udelay (40);					// wait 40 us
                            729 ;     genCall
   03CC 75 82 28            730 	mov	dpl,#0x28
   03CF 12 05 21            731 	lcall	_udelay
                            732 ;Initial/src/fpga_load.c:43: HPSDR_ALTERA_CONFIG |= bmALTERA_NCONFIG;	// set NCONFIG high
                            733 ;     genOr
   03D2 43 A0 02            734 	orl	_IOC,#0x02
                            735 ;Initial/src/fpga_load.c:49: while ((HPSDR_ALTERA_CONFIG & bmALTERA_NSTATUS) == 0) // wait for NSTATUS to go high
   03D5                     736 00101$:
                            737 ;     genAnd
   03D5 74 10               738 	mov	a,#0x10
   03D7 55 A0               739 	anl	a,_IOC
                            740 ;     genCmpEq
                            741 ;	Peephole 112.b	changed ljmp to sjmp
                            742 ;	Peephole 115.b	jump optimization
   03D9 FA                  743 	mov	r2,a
   03DA 60 F9               744 	jz	00101$
   03DC                     745 00110$:
                            746 ;Initial/src/fpga_load.c:55: return 1;
                            747 ;     genRet
   03DC 75 82 01            748 	mov	dpl,#0x01
   03DF                     749 00106$:
   03DF 22                  750 	ret
                            751 ;------------------------------------------------------------
                            752 ;Allocation info for local variables in function 'clock_out_config_byte'
                            753 ;------------------------------------------------------------
                            754 ;bits                      Allocated to registers 
                            755 ;------------------------------------------------------------
                            756 ;Initial/src/fpga_load.c:74: clock_out_config_byte (unsigned char bits) _naked
                            757 ;	-----------------------------------------
                            758 ;	 function clock_out_config_byte
                            759 ;	-----------------------------------------
   03E0                     760 _clock_out_config_byte:
                            761 ;	naked function: no prologue.
                            762 ;Initial/src/fpga_load.c:121: _endasm;
                            763 ;     genInline
   03E0 E5 82               764 	        mov a, dpl
   03E2 13                  765 	        rrc a
   03E3 92 A0               766 	        mov _bitALTERA_DATA0,c
   03E5 D2 A2               767 	        setb _bitALTERA_DCLK
   03E7 C2 A2               768 	        clr _bitALTERA_DCLK
   03E9 13                  769 	        rrc a
   03EA 92 A0               770 	        mov _bitALTERA_DATA0,c
   03EC D2 A2               771 	        setb _bitALTERA_DCLK
   03EE C2 A2               772 	        clr _bitALTERA_DCLK
   03F0 13                  773 	        rrc a
   03F1 92 A0               774 	        mov _bitALTERA_DATA0,c
   03F3 D2 A2               775 	        setb _bitALTERA_DCLK
   03F5 C2 A2               776 	        clr _bitALTERA_DCLK
   03F7 13                  777 	        rrc a
   03F8 92 A0               778 	        mov _bitALTERA_DATA0,c
   03FA D2 A2               779 	        setb _bitALTERA_DCLK
   03FC C2 A2               780 	        clr _bitALTERA_DCLK
   03FE 13                  781 	        rrc a
   03FF 92 A0               782 	        mov _bitALTERA_DATA0,c
   0401 D2 A2               783 	        setb _bitALTERA_DCLK
   0403 C2 A2               784 	        clr _bitALTERA_DCLK
   0405 13                  785 	        rrc a
   0406 92 A0               786 	        mov _bitALTERA_DATA0,c
   0408 D2 A2               787 	        setb _bitALTERA_DCLK
   040A C2 A2               788 	        clr _bitALTERA_DCLK
   040C 13                  789 	        rrc a
   040D 92 A0               790 	        mov _bitALTERA_DATA0,c
   040F D2 A2               791 	        setb _bitALTERA_DCLK
   0411 C2 A2               792 	        clr _bitALTERA_DCLK
   0413 13                  793 	        rrc a
   0414 92 A0               794 	        mov _bitALTERA_DATA0,c
   0416 D2 A2               795 	        setb _bitALTERA_DCLK
   0418 C2 A2               796 	        clr _bitALTERA_DCLK
   041A 22                  797 	        ret
   041B                     798 00101$:
                            799 ;	naked function: no epilogue.
                            800 ;------------------------------------------------------------
                            801 ;Allocation info for local variables in function 'clock_out_bytes'
                            802 ;------------------------------------------------------------
                            803 ;p                         Allocated with name '_clock_out_bytes_PARM_2'
                            804 ;bytecount                 Allocated to registers r2 
                            805 ;------------------------------------------------------------
                            806 ;Initial/src/fpga_load.c:125: clock_out_bytes (unsigned char bytecount,
                            807 ;	-----------------------------------------
                            808 ;	 function clock_out_bytes
                            809 ;	-----------------------------------------
   041B                     810 _clock_out_bytes:
                            811 ;     genReceive
   041B AA 82               812 	mov	r2,dpl
                            813 ;Initial/src/fpga_load.c:128: while (bytecount-- > 0)
                            814 ;     genAssign
   041D AB 0D               815 	mov	r3,_clock_out_bytes_PARM_2
   041F AC 0E               816 	mov	r4,(_clock_out_bytes_PARM_2 + 1)
                            817 ;     genAssign
   0421                     818 00101$:
                            819 ;     genAssign
   0421 8A 05               820 	mov	ar5,r2
                            821 ;     genMinus
                            822 ;     genMinusDec
   0423 1A                  823 	dec	r2
                            824 ;     genCmpGt
                            825 ;     genCmp
                            826 ;     genIfxJump
                            827 ;	Peephole 108	removed ljmp by inverse jump logic
                            828 ;	Peephole 132.b	optimized genCmpGt by inverse logic (acc differs)
   0424 ED                  829 	mov	a,r5
   0425 24 FF               830 	add	a,#0xff - 0x00
   0427 50 12               831 	jnc	00104$
   0429                     832 00108$:
                            833 ;Initial/src/fpga_load.c:129: clock_out_config_byte (*p++);
                            834 ;     genPointerGet
                            835 ;     genFarPointerGet
   0429 8B 82               836 	mov	dpl,r3
   042B 8C 83               837 	mov	dph,r4
   042D E0                  838 	movx	a,@dptr
   042E FD                  839 	mov	r5,a
   042F A3                  840 	inc	dptr
   0430 AB 82               841 	mov	r3,dpl
   0432 AC 83               842 	mov	r4,dph
                            843 ;     genCall
   0434 8D 82               844 	mov	dpl,r5
   0436 12 03 E0            845 	lcall	_clock_out_config_byte
                            846 ;	Peephole 112.b	changed ljmp to sjmp
   0439 80 E6               847 	sjmp	00101$
   043B                     848 00104$:
   043B 22                  849 	ret
                            850 ;------------------------------------------------------------
                            851 ;Allocation info for local variables in function 'fpga_load_xfer'
                            852 ;------------------------------------------------------------
                            853 ;bytecount                 Allocated with name '_fpga_load_xfer_PARM_2'
                            854 ;p                         Allocated to registers 
                            855 ;------------------------------------------------------------
                            856 ;Initial/src/fpga_load.c:146: fpga_load_xfer (xdata unsigned char *p, unsigned char bytecount)
                            857 ;	-----------------------------------------
                            858 ;	 function fpga_load_xfer
                            859 ;	-----------------------------------------
   043C                     860 _fpga_load_xfer:
                            861 ;     genReceive
   043C 85 82 0D            862 	mov	_clock_out_bytes_PARM_2,dpl
   043F 85 83 0E            863 	mov	(_clock_out_bytes_PARM_2 + 1),dph
                            864 ;Initial/src/fpga_load.c:148: clock_out_bytes (bytecount, p);
                            865 ;     genCall
   0442 85 0F 82            866 	mov	dpl,_fpga_load_xfer_PARM_2
   0445 12 04 1B            867 	lcall	_clock_out_bytes
                            868 ;Initial/src/fpga_load.c:149: return 1;
                            869 ;     genRet
   0448 75 82 01            870 	mov	dpl,#0x01
   044B                     871 00101$:
   044B 22                  872 	ret
                            873 ;------------------------------------------------------------
                            874 ;Allocation info for local variables in function 'fpga_load_end'
                            875 ;------------------------------------------------------------
                            876 ;status                    Allocated to registers r2 
                            877 ;------------------------------------------------------------
                            878 ;Initial/src/fpga_load.c:156: fpga_load_end (void)
                            879 ;	-----------------------------------------
                            880 ;	 function fpga_load_end
                            881 ;	-----------------------------------------
   044C                     882 _fpga_load_end:
                            883 ;Initial/src/fpga_load.c:158: unsigned char status = HPSDR_ALTERA_CONFIG;
                            884 ;     genAssign
   044C AA A0               885 	mov	r2,_IOC
                            886 ;Initial/src/fpga_load.c:163: if ((status & bmALTERA_NSTATUS) == 0)		// failed to program
                            887 ;     genAnd
   044E 74 10               888 	mov	a,#0x10
   0450 5A                  889 	anl	a,r2
                            890 ;     genCmpEq
                            891 ;	Peephole 115.b	jump optimization
   0451 FB                  892 	mov	r3,a
   0452 60 02               893 	jz	00112$
   0454                     894 00111$:
                            895 ;	Peephole 112.b	changed ljmp to sjmp
   0454 80 04               896 	sjmp	00104$
   0456                     897 00112$:
                            898 ;Initial/src/fpga_load.c:164: return 0;
                            899 ;     genRet
   0456 75 82 00            900 	mov	dpl,#0x00
                            901 ;	Peephole 112.b	changed ljmp to sjmp
                            902 ;	Peephole 251.b	replaced sjmp to ret with ret
   0459 22                  903 	ret
   045A                     904 00104$:
                            905 ;Initial/src/fpga_load.c:166: if ((status & bmALTERA_CONF_DONE) == bmALTERA_CONF_DONE)
                            906 ;     genAnd
   045A 53 02 08            907 	anl	ar2,#0x08
                            908 ;     genCmpEq
                            909 ;	Peephole 112.b	changed ljmp to sjmp
                            910 ;	Peephole 199	optimized misc jump sequence
   045D BA 08 04            911 	cjne	r2,#0x08,00106$
                            912 ;00113$:
                            913 ;	Peephole 200	removed redundant sjmp
   0460                     914 00114$:
                            915 ;Initial/src/fpga_load.c:167: return 1;					// everything's cool
                            916 ;     genRet
   0460 75 82 01            917 	mov	dpl,#0x01
                            918 ;	Peephole 112.b	changed ljmp to sjmp
                            919 ;Initial/src/fpga_load.c:172: return 0;
                            920 ;     genRet
                            921 ;	Peephole 237.a	removed sjmp to ret
   0463 22                  922 	ret
   0464                     923 00106$:
   0464 75 82 00            924 	mov	dpl,#0x00
   0467                     925 00107$:
   0467 22                  926 	ret
                            927 	.area CSEG    (CODE)
                            928 	.area XINIT   (CODE)
