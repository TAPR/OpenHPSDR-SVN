   ...
   0AED                     734 _setup_descriptors:
                    ...
                    0001    742 	ar1 = 0x01
                            ...
                            744 ;     genAssign
   0AED 90 E6 80            745 	mov	dptr,#_USBCS
   0AF0 E0                  746 	movx	a,@dptr
                            747 ;     genAnd
                            748 ;	Peephole 105	removed redundant mov
   0AF1 FA                  749 	mov	r2,a
                            750 ;     genIfxJump
                            751 ;	Peephole 111	removed ljmp by inverse jump logic
   0AF2 30 E7 19            752 	jnb	acc.7,00102$
   0AF5                     753 00107$:
                            754 ;Initial/src/lib/usb_common.c:69: current_device_descr  = high_speed_device_descr;
                            755 ;     genAddrOf
   0AF5 75 23 00            756 	mov	_current_device_descr,#_high_speed_device_descr
   0AF8 75 24 E0            757 	mov	(_current_device_descr + 1),#(_high_speed_device_descr >> 8)
                            758 ;Initial/src/lib/usb_common.c:70: current_devqual_descr = high_speed_devqual_descr;
                            759 ;     genAddrOf
   0AFB 75 25 12            760 	mov	_current_devqual_descr,#_high_speed_devqual_descr
   0AFE 75 26 E0            761 	mov	(_current_devqual_descr + 1),#(_high_speed_devqual_descr >> 8)
                            762 ;Initial/src/lib/usb_common.c:71: current_config_descr  = high_speed_config_descr;
                            763 ;     genAddrOf
   0B01 75 27 1C            764 	mov	_current_config_descr,#_high_speed_config_descr
   0B04 75 28 E0            765 	mov	(_current_config_descr + 1),#(_high_speed_config_descr >> 8)
                            766 ;Initial/src/lib/usb_common.c:72: other_config_descr    = full_speed_config_descr;
                            767 ;     genAddrOf
   0B07 75 29 6A            768 	mov	_other_config_descr,#_full_speed_config_descr
   0B0A 75 2A E0            769 	mov	(_other_config_descr + 1),#(_full_speed_config_descr >> 8)
   ...
   0B0E                     773 00102$:
                            ...
                            775 ;     genAddrOf
   0B0E 75 23 4E            776 	mov	_current_device_descr,#_full_speed_device_descr
   0B11 75 24 E0            777 	mov	(_current_device_descr + 1),#(_full_speed_device_descr >> 8)
                            778 ;Initial/src/lib/usb_common.c:77: current_devqual_descr = full_speed_devqual_descr;
                            779 ;     genAddrOf
   0B14 75 25 60            780 	mov	_current_devqual_descr,#_full_speed_devqual_descr
   0B17 75 26 E0            781 	mov	(_current_devqual_descr + 1),#(_full_speed_devqual_descr >> 8)
                            782 ;Initial/src/lib/usb_common.c:78: current_config_descr  = full_speed_config_descr;
                            783 ;     genAddrOf
   0B1A 75 27 6A            784 	mov	_current_config_descr,#_full_speed_config_descr
   0B1D 75 28 E0            785 	mov	(_current_config_descr + 1),#(_full_speed_config_descr >> 8)
                            786 ;Initial/src/lib/usb_common.c:79: other_config_descr    = high_speed_config_descr;
                            787 ;     genAddrOf
   0B20 75 29 1C            788 	mov	_other_config_descr,#_high_speed_config_descr
   0B23 75 2A E0            789 	mov	(_other_config_descr + 1),#(_high_speed_config_descr >> 8)
   0B26                     790 00104$:
   0B26 22                  791 	ret
                            792 ;------------------------------------------------------------
   ...
   0B27                     800 _isr_SUDAV:
                            ...
                            802 ;     genAnd
   0B27 53 91 EF            803 	anl	_EXIF,#0xEF
                            804 ;     genAssign
   0B2A 75 A1 00            805 	mov	_INT2CLR,#0x00
                            806 ;Initial/src/lib/usb_common.c:87: _usb_got_SUDAV = 1;
                            807 ;     genAssign
   0B2D D2 03               808 	setb	__usb_got_SUDAV
   0B2F                     809 00101$:
   0B2F 32                  810 	reti
                            ...
                            823 ;	-----------------------------------------
   0B30                     824 _isr_USBRESET:
   0B30 C0 E0               825 	push	acc
   0B32 C0 F0               826 	push	b
   0B34 C0 82               827 	push	dpl
   0B36 C0 83               828 	push	dph
   0B38 C0 02               829 	push	(0+2)
   0B3A C0 03               830 	push	(0+3)
   0B3C C0 04               831 	push	(0+4)
   0B3E C0 05               832 	push	(0+5)
   0B40 C0 06               833 	push	(0+6)
   0B42 C0 07               834 	push	(0+7)
   0B44 C0 00               835 	push	(0+0)
   0B46 C0 01               836 	push	(0+1)
   0B48 C0 D0               837 	push	psw
   0B4A 75 D0 00            838 	mov	psw,#0x00
                            839 ;Initial/src/lib/usb_common.c:93: clear_usb_irq ();
                            840 ;     genAnd
   0B4D 53 91 EF            841 	anl	_EXIF,#0xEF
                            842 ;     genAssign
   0B50 75 A1 00            843 	mov	_INT2CLR,#0x00
                            844 ;Initial/src/lib/usb_common.c:94: setup_descriptors ();
                            845 ;     genCall
   0B53 12 0A ED            846 	lcall	_setup_descriptors
   0B56                     847 00101$:
   0B56 D0 D0               848 	pop	psw
   0B58 D0 01               849 	pop	(0+1)
   0B5A D0 00               850 	pop	(0+0)
   0B5C D0 07               851 	pop	(0+7)
   0B5E D0 06               852 	pop	(0+6)
   0B60 D0 05               853 	pop	(0+5)
   0B62 D0 04               854 	pop	(0+4)
   0B64 D0 03               855 	pop	(0+3)
   0B66 D0 02               856 	pop	(0+2)
   0B68 D0 83               857 	pop	dph
   0B6A D0 82               858 	pop	dpl
   0B6C D0 F0               859 	pop	b
   0B6E D0 E0               860 	pop	acc
   0B70 32                  861 	reti
                            862 ;------------------------------------------------------------
                            ...
                            869 ;	-----------------------------------------
   0B71                     870 _isr_HIGHSPEED:
   0B71 C0 E0               871 	push	acc
   0B73 C0 F0               872 	push	b
   0B75 C0 82               873 	push	dpl
   0B77 C0 83               874 	push	dph
   0B79 C0 02               875 	push	(0+2)
   0B7B C0 03               876 	push	(0+3)
   0B7D C0 04               877 	push	(0+4)
   0B7F C0 05               878 	push	(0+5)
   0B81 C0 06               879 	push	(0+6)
   0B83 C0 07               880 	push	(0+7)
   0B85 C0 00               881 	push	(0+0)
   0B87 C0 01               882 	push	(0+1)
   0B89 C0 D0               883 	push	psw
   0B8B 75 D0 00            884 	mov	psw,#0x00
                            885 ;Initial/src/lib/usb_common.c:100: clear_usb_irq ();
                            886 ;     genAnd
   0B8E 53 91 EF            887 	anl	_EXIF,#0xEF
                            888 ;     genAssign
   0B91 75 A1 00            889 	mov	_INT2CLR,#0x00
                            890 ;Initial/src/lib/usb_common.c:101: setup_descriptors ();
                            891 ;     genCall
   0B94 12 0A ED            892 	lcall	_setup_descriptors
   0B97                     893 00101$:
   0B97 D0 D0               894 	pop	psw
   0B99 D0 01               895 	pop	(0+1)
   0B9B D0 00               896 	pop	(0+0)
   0B9D D0 07               897 	pop	(0+7)
   0B9F D0 06               898 	pop	(0+6)
   0BA1 D0 05               899 	pop	(0+5)
   0BA3 D0 04               900 	pop	(0+4)
   0BA5 D0 03               901 	pop	(0+3)
   0BA7 D0 02               902 	pop	(0+2)
   0BA9 D0 83               903 	pop	dph
   0BAB D0 82               904 	pop	dpl
   0BAD D0 F0               905 	pop	b
   0BAF D0 E0               906 	pop	acc
   0BB1 32                  907 	reti
                            908 ;------------------------------------------------------------
                            ...
                            915 ;	-----------------------------------------
   0BB2                     916 _usb_install_handlers:
                            917 ;Initial/src/lib/usb_common.c:107: setup_descriptors ();	    // ensure that they're set before use
                            918 ;     genCall
   0BB2 12 0A ED            919 	lcall	_setup_descriptors
                            920 ;Initial/src/lib/usb_common.c:109: hook_uv (UV_SUDAV,     (unsigned short) isr_SUDAV);
                            921 ;     genCast
   0BB5 75 2B 27            922 	mov	_hook_uv_PARM_2,#_isr_SUDAV
   0BB8 75 2C 0B            923 	mov	(_hook_uv_PARM_2 + 1),#(_isr_SUDAV >> 8)
                            924 ;     genCall
   0BBB 75 82 00            925 	mov	dpl,#0x00
   0BBE 12 07 7A            926 	lcall	_hook_uv
                            927 ;Initial/src/lib/usb_common.c:110: hook_uv (UV_USBRESET,  (unsigned short) isr_USBRESET);
                            928 ;     genCast
   0BC1 75 2B 30            929 	mov	_hook_uv_PARM_2,#_isr_USBRESET
   0BC4 75 2C 0B            930 	mov	(_hook_uv_PARM_2 + 1),#(_isr_USBRESET >> 8)
                            931 ;     genCall
   0BC7 75 82 10            932 	mov	dpl,#0x10
   0BCA 12 07 7A            933 	lcall	_hook_uv
                            934 ;Initial/src/lib/usb_common.c:111: hook_uv (UV_HIGHSPEED, (unsigned short) isr_HIGHSPEED);
                            935 ;     genCast
   0BCD 75 2B 71            936 	mov	_hook_uv_PARM_2,#_isr_HIGHSPEED
   0BD0 75 2C 0B            937 	mov	(_hook_uv_PARM_2 + 1),#(_isr_HIGHSPEED >> 8)
                            938 ;     genCall
   0BD3 75 82 14            939 	mov	dpl,#0x14
   0BD6 12 07 7A            940 	lcall	_hook_uv
                            941 ;Initial/src/lib/usb_common.c:113: USBIE = bmSUDAV | bmURES | bmHSGRANT;
                            942 ;     genAssign
   0BD9 90 E6 5C            943 	mov	dptr,#_USBIE
   0BDC 74 31               944 	mov	a,#0x31
   0BDE F0                  945 	movx	@dptr,a
   0BDF                     946 00101$:
   0BDF 22                  947 	ret
                            948 ;------------------------------------------------------------
   ...
   0BE0 E5 82               968 	mov	a,dpl
   0BE2 54 7F               969 	anl	a,#0x7F
   0BE4 FA                  970 	mov	r2,a
   0BE5 24 F7               971 	add	a,#0xff - 0x08
   0BE7 50 04               972 	jnc	00102$
   0BE9                     973 00109$:
                            974 ;Initial/src/lib/usb_common.c:125: return 0;
                            975 ;     genRet
   0BE9 75 82 00            976 	mov	dpl,#0x00
   ...
   0BF4                     995 00104$:
                            ...
                            997 ;     genAnd
   0BF4 53 02 01            998 	anl	ar2,#0x01
                            999 ;     genCmpEq
                           1000 ;	Peephole 241.c	optimized compare
   0BF7 E4                 1001 	clr	a
   0BF8 BA 00 01           1002 	cjne	r2,#0x00,00112$
   0BFB 04                 1003 	inc	a
   0BFC                    1004 00112$:
   0BFC                    1005 00113$:
   0BFC F5 82              1006 	mov	dpl,a
                           1007 ;     genRet
   0BFE                    1008 00105$:
   0BFE 22                 1009 	ret
                           1010 ;------------------------------------------------------------
   ...
   0C01 BA 01 0C           1026 	cjne	r2,#0x01,00102$
                           1027 ;00112$:
                           1028 ;	Peephole 200	removed redundant sjmp
   0C04                    1029 00113$:
                           1030 ;Initial/src/lib/usb_common.c:140: return EP1OUTCS;
                           1031 ;     genAssign
   0C04 90 E6 A1           1032 	mov	dptr,#_EP1OUTCS
   0C07 E0                 1033 	movx	a,@dptr
   0C08 FB                 1034 	mov	r3,a
                           1035 ;     genCast
   0C09 7C 00              1036 	mov	r4,#0x00
                           1037 ;     genRet
   0C0B 8B 82              1038 	mov	dpl,r3
   0C0D 8C 83              1039 	mov	dph,r4
   ...
   0C10 BA 81 0C           1048 	cjne	r2,#0x81,00104$
                           1049 ;00114$:
                           1050 ;	Peephole 200	removed redundant sjmp
   0C13                    1051 00115$:
                           1052 ;Initial/src/lib/usb_common.c:143: return EP1INCS;
                           1053 ;     genAssign
   0C13 90 E6 A2           1054 	mov	dptr,#_EP1INCS
   0C16 E0                 1055 	movx	a,@dptr
   0C17 FB                 1056 	mov	r3,a
                           1057 ;     genCast
   0C18 7C 00              1058 	mov	r4,#0x00
                           1059 ;     genRet
   0C1A 8B 82              1060 	mov	dpl,r3
   0C1C 8C 83              1061 	mov	dph,r4
   ...
   0C1F                    1065 00104$:
                           ...
                           1067 ;     genAnd
   0C1F 53 02 7F           1068 	anl	ar2,#0x7F
   ...
   0C22 BA 00 0C           1073 	cjne	r2,#0x00,00106$
                           1074 ;00116$:
                           1075 ;	Peephole 200	removed redundant sjmp
   0C25                    1076 00117$:
                           1077 ;Initial/src/lib/usb_common.c:148: return EP0CS;
                           1078 ;     genAssign
   0C25 90 E6 A0           1079 	mov	dptr,#_EP0CS
   0C28 E0                 1080 	movx	a,@dptr
   0C29 FB                 1081 	mov	r3,a
                           1082 ;     genCast
   0C2A 7C 00              1083 	mov	r4,#0x00
                           1084 ;     genRet
   0C2C 8B 82              1085 	mov	dpl,r3
   0C2E 8C 83              1086 	mov	dph,r4
   ...
   0C31                    1090 00106$:
                           ...
                           1092 ;     genAssign
   0C31 90 E6 A3           1093 	mov	dptr,#_EP2CS
   0C34 E0                 1094 	movx	a,@dptr
   0C35 FB                 1095 	mov	r3,a
                           1096 ;     genCast
   0C36 7C 00              1097 	mov	r4,#0x00
                           1098 ;     genRightShift
                           1099 ;     genRightShiftLiteral
                           1100 ;     genrshOne
   0C38 EA                 1101 	mov	a,r2
   0C39 C3                 1102 	clr	c
   0C3A 13                 1103 	rrc	a
   0C3B FA                 1104 	mov	r2,a
                           1105 ;     genCast
   0C3C 7D 00              1106 	mov	r5,#0x00
                           1107 ;     genPlus
                           1108 ;	Peephole 236.g	used r2 instead of ar2
   0C3E EA                 1109 	mov	a,r2
                           1110 ;	Peephole 236.a	used r3 instead of ar3
   0C3F 2B                 1111 	add	a,r3
   0C40 FB                 1112 	mov	r3,a
                           1113 ;	Peephole 236.g	used r5 instead of ar5
   0C41 ED                 1114 	mov	a,r5
                           1115 ;	Peephole 236.b	used r4 instead of ar4
   0C42 3C                 1116 	addc	a,r4
                           1117 ;     genCast
                           1118 ;     genRet
                           1119 ;	Peephole 235	loading dph directly from a(ccumulator), r4 not set
   0C43 8B 82              1120 	mov	dpl,r3
   0C45 F5 83              1121 	mov	dph,a
   0C47                    1122 00107$:
   0C47 22                 1123 	ret
                           1124 ;------------------------------------------------------------
                           ...
                           1131 ;	-----------------------------------------
   0C48                    1132 _usb_handle_set_feature:
                           1133 ;Initial/src/lib/usb_common.c:155: switch (bRequestType & bmRT_RECIP_MASK)
                           1134 ;     genPointerGet
                           1135 ;     genFarPointerGet
   0C48 90 E6 B8           1136 	mov	dptr,#_SETUPDAT
   0C4B E0                 1137 	movx	a,@dptr
   0C4C FA                 1138 	mov	r2,a
                           1139 ;     genAnd
   0C4D 53 02 1F           1140 	anl	ar2,#0x1F
                           1141 ;     genCmpEq
   0C50 BA 00 02           1142 	cjne	r2,#0x00,00121$
                           1143 ;	Peephole 112.b	changed ljmp to sjmp
   0C53 80 05              1144 	sjmp	00101$
   0C55                    1145 00121$:
                           1146 ;     genCmpEq
   ...
   0C55 BA 02 5B           1151 	cjne	r2,#0x02,00112$
   0C58 80 12              1152 	sjmp	00106$
                           1153 ;00122$:
   0C5A                    1154 00101$:
                           1155 ;Initial/src/lib/usb_common.c:158: switch (wValueL)
                           1156 ;     genPointerGet
                           1157 ;     genFarPointerGet
   0C5A 90 E6 BA           1158 	mov	dptr,#(_SETUPDAT + 0x0002)
   0C5D E0                 1159 	movx	a,@dptr
   0C5E FA                 1160 	mov	r2,a
                           1161 ;     genCmpEq
   0C5F BA 01 02           1162 	cjne	r2,#0x01,00123$
                           1163 ;	Peephole 112.b	changed ljmp to sjmp
   0C62 80 05              1164 	sjmp	00104$
   0C64                    1165 00123$:
                           1166 ;     genCmpEq
   0C64 BA 02 02           1167 	cjne	r2,#0x02,00124$
                           1168 ;	Peephole 112.b	changed ljmp to sjmp
   0C67 80 03              1169 	sjmp	00106$
   0C69                    1170 00124$:
                           1171 ;Initial/src/lib/usb_common.c:165: default:
   0C69                    1172 00104$:
                           1173 ;Initial/src/lib/usb_common.c:166: fx2_stall_ep0 ();
                           1174 ;     genCall
   0C69 12 05 64           1175 	lcall	_fx2_stall_ep0
   ...
   0C6C 90 E6 BA           1181 	mov	dptr,#(_SETUPDAT + 0x0002)
   0C6F E0                 1182 	movx	a,@dptr
                           1183 ;     genCmpEq
                           1184 ;	Peephole 115.b	jump optimization
   0C70 FA                 1185 	mov	r2,a
   0C71 60 02              1186 	jz	00126$
   0C73                    1187 00125$:
                           1188 ;	Peephole 112.b	changed ljmp to sjmp
   0C73 80 3E              1189 	sjmp	00112$
   0C75                    1190 00126$:
                           1191 ;Initial/src/lib/usb_common.c:174: if (plausible_endpoint (wIndexL))
                           1192 ;     genPointerGet
                           1193 ;     genFarPointerGet
   0C75 90 E6 BC           1194 	mov	dptr,#(_SETUPDAT + 0x0004)
   0C78 E0                 1195 	movx	a,@dptr
                           1196 ;     genCall
                           1197 ;	Peephole 244.c	loading dpl from a instead of r2
   0C79 FA                 1198 	mov	r2,a
   0C7A F5 82              1199 	mov	dpl,a
   0C7C 12 0B E0           1200 	lcall	_plausible_endpoint
   0C7F E5 82              1201 	mov	a,dpl
                           1202 ;     genIfx
                           1203 ;     genIfxJump
                           1204 ;	Peephole 110	removed ljmp by inverse jump logic
   0C81 60 2D              1205 	jz	00109$
   0C83                    1206 00127$:
                           1207 ;Initial/src/lib/usb_common.c:175: *epcs (wIndexL) |= bmEPSTALL;
                           1208 ;     genPointerGet
                           1209 ;     genFarPointerGet
   0C83 90 E6 BC           1210 	mov	dptr,#(_SETUPDAT + 0x0004)
   0C86 E0                 1211 	movx	a,@dptr
                           1212 ;     genCall
                           1213 ;	Peephole 244.c	loading dpl from a instead of r2
   0C87 FA                 1214 	mov	r2,a
   0C88 F5 82              1215 	mov	dpl,a
   0C8A 12 0B FF           1216 	lcall	_epcs
   0C8D AA 82              1217 	mov	r2,dpl
   0C8F AB 83              1218 	mov	r3,dph
                           1219 ;     genPointerGet
                           1220 ;     genFarPointerGet
   0C91 90 E6 BC           1221 	mov	dptr,#(_SETUPDAT + 0x0004)
   0C94 E0                 1222 	movx	a,@dptr
                           1223 ;     genCall
                           1224 ;	Peephole 244.c	loading dpl from a instead of r4
   0C95 FC                 1225 	mov	r4,a
   0C96 F5 82              1226 	mov	dpl,a
   0C98 C0 02              1227 	push	ar2
   0C9A C0 03              1228 	push	ar3
   0C9C 12 0B FF           1229 	lcall	_epcs
   0C9F D0 03              1230 	pop	ar3
   0CA1 D0 02              1231 	pop	ar2
                           1232 ;     genPointerGet
                           1233 ;     genFarPointerGet
   0CA3 E0                 1234 	movx	a,@dptr
   0CA4 FC                 1235 	mov	r4,a
                           1236 ;     genOr
   0CA5 43 04 01           1237 	orl	ar4,#0x01
                           1238 ;     genPointerSet
                           1239 ;     genFarPointerSet
   0CA8 8A 82              1240 	mov	dpl,r2
   0CAA 8B 83              1241 	mov	dph,r3
   0CAC EC                 1242 	mov	a,r4
   0CAD F0                 1243 	movx	@dptr,a
                           1244 ;	Peephole 112.b	changed ljmp to sjmp
   0CAE 80 03              1245 	sjmp	00112$
   0CB0                    1246 00109$:
                           1247 ;Initial/src/lib/usb_common.c:177: fx2_stall_ep0 ();
                           1248 ;     genCall
   0CB0 12 05 64           1249 	lcall	_fx2_stall_ep0
   ...
   0CB3 02 05 64           1256 	ljmp	_fx2_stall_ep0
                           1257 ;------------------------------------------------------------
                           ...
                           1264 ;	-----------------------------------------
   0CB6                    1265 _usb_handle_clear_feature:
                           1266 ;Initial/src/lib/usb_common.c:189: switch (bRequestType & bmRT_RECIP_MASK)
                           1267 ;     genPointerGet
                           1268 ;     genFarPointerGet
   0CB6 90 E6 B8           1269 	mov	dptr,#_SETUPDAT
   0CB9 E0                 1270 	movx	a,@dptr
   0CBA FA                 1271 	mov	r2,a
                           1272 ;     genAnd
   0CBB 53 02 1F           1273 	anl	ar2,#0x1F
                           1274 ;     genCmpEq
   0CBE BA 00 02           1275 	cjne	r2,#0x00,00118$
                           1276 ;	Peephole 112.b	changed ljmp to sjmp
   0CC1 80 05              1277 	sjmp	00101$
   0CC3                    1278 00118$:
                           1279 ;     genCmpEq
   ...
   0CC3 BA 02 58           1284 	cjne	r2,#0x02,00110$
   0CC6 80 07              1285 	sjmp	00105$
                           1286 ;00119$:
   0CC8                    1287 00101$:
                           1288 ;Initial/src/lib/usb_common.c:193: switch (wValueL)
                           1289 ;     genPointerGet
                           1290 ;     genFarPointerGet
   0CC8 90 E6 BA           1291 	mov	dptr,#(_SETUPDAT + 0x0002)
   0CCB E0                 1292 	movx	a,@dptr
   ...
   0CCC 02 05 64           1300 	ljmp	_fx2_stall_ep0
   0CCF                    1301 00105$:
                           1302 ;Initial/src/lib/usb_common.c:202: if (wValueL == FS_ENDPOINT_HALT && plausible_endpoint (wIndexL))
                           1303 ;     genPointerGet
                           1304 ;     genFarPointerGet
   0CCF 90 E6 BA           1305 	mov	dptr,#(_SETUPDAT + 0x0002)
   0CD2 E0                 1306 	movx	a,@dptr
                           1307 ;     genCmpEq
                           1308 ;	Peephole 115.b	jump optimization
   0CD3 FA                 1309 	mov	r2,a
   0CD4 60 02              1310 	jz	00121$
   0CD6                    1311 00120$:
                           1312 ;	Peephole 112.b	changed ljmp to sjmp
   0CD6 80 43              1313 	sjmp	00107$
   0CD8                    1314 00121$:
                           1315 ;     genPointerGet
                           1316 ;     genFarPointerGet
   0CD8 90 E6 BC           1317 	mov	dptr,#(_SETUPDAT + 0x0004)
   0CDB E0                 1318 	movx	a,@dptr
                           1319 ;     genCall
                           1320 ;	Peephole 244.c	loading dpl from a instead of r2
   0CDC FA                 1321 	mov	r2,a
   0CDD F5 82              1322 	mov	dpl,a
   0CDF 12 0B E0           1323 	lcall	_plausible_endpoint
   0CE2 E5 82              1324 	mov	a,dpl
                           1325 ;     genIfx
                           1326 ;     genIfxJump
                           1327 ;	Peephole 110	removed ljmp by inverse jump logic
   0CE4 60 35              1328 	jz	00107$
   0CE6                    1329 00122$:
                           1330 ;Initial/src/lib/usb_common.c:204: *epcs (wIndexL) &= ~bmEPSTALL;
                           1331 ;     genPointerGet
                           1332 ;     genFarPointerGet
   0CE6 90 E6 BC           1333 	mov	dptr,#(_SETUPDAT + 0x0004)
   0CE9 E0                 1334 	movx	a,@dptr
                           1335 ;     genCall
                           1336 ;	Peephole 244.c	loading dpl from a instead of r2
   0CEA FA                 1337 	mov	r2,a
   0CEB F5 82              1338 	mov	dpl,a
   0CED 12 0B FF           1339 	lcall	_epcs
   0CF0 AA 82              1340 	mov	r2,dpl
   0CF2 AB 83              1341 	mov	r3,dph
                           1342 ;     genPointerGet
                           1343 ;     genFarPointerGet
   0CF4 90 E6 BC           1344 	mov	dptr,#(_SETUPDAT + 0x0004)
   0CF7 E0                 1345 	movx	a,@dptr
                           1346 ;     genCall
                           1347 ;	Peephole 244.c	loading dpl from a instead of r4
   0CF8 FC                 1348 	mov	r4,a
   0CF9 F5 82              1349 	mov	dpl,a
   0CFB C0 02              1350 	push	ar2
   0CFD C0 03              1351 	push	ar3
   0CFF 12 0B FF           1352 	lcall	_epcs
   0D02 D0 03              1353 	pop	ar3
   0D04 D0 02              1354 	pop	ar2
                           1355 ;     genPointerGet
                           1356 ;     genFarPointerGet
   0D06 E0                 1357 	movx	a,@dptr
   0D07 FC                 1358 	mov	r4,a
                           1359 ;     genAnd
   0D08 53 04 FE           1360 	anl	ar4,#0xFE
                           1361 ;     genPointerSet
                           1362 ;     genFarPointerSet
   0D0B 8A 82              1363 	mov	dpl,r2
   0D0D 8B 83              1364 	mov	dph,r3
   0D0F EC                 1365 	mov	a,r4
   0D10 F0                 1366 	movx	@dptr,a
                           1367 ;Initial/src/lib/usb_common.c:205: fx2_reset_data_toggle (wIndexL);
                           1368 ;     genPointerGet
                           1369 ;     genFarPointerGet
   0D11 90 E6 BC           1370 	mov	dptr,#(_SETUPDAT + 0x0004)
   0D14 E0                 1371 	movx	a,@dptr
                           1372 ;     genCall
                           1373 ;	Peephole 244.c	loading dpl from a instead of r2
   0D15 FA                 1374 	mov	r2,a
   0D16 F5 82              1375 	mov	dpl,a
   ...
   0D18 02 05 6D           1379 	ljmp	_fx2_reset_data_toggle
   0D1B                    1380 00107$:
   ...
   0D1B 02 05 64           1388 	ljmp	_fx2_stall_ep0
   0D1E                    1389 00110$:
   ...
   0D1E 02 05 64           1394 	ljmp	_fx2_stall_ep0
   0D21                    1395 00112$:
   0D21 22                 1396 	ret
                           1397 ;------------------------------------------------------------
                           ...
                           1404 ;	-----------------------------------------
   0D22                    1405 _usb_handle_get_status:
                           1406 ;Initial/src/lib/usb_common.c:219: switch (bRequestType & bmRT_RECIP_MASK)
                           1407 ;     genPointerGet
                           1408 ;     genFarPointerGet
   0D22 90 E6 B8           1409 	mov	dptr,#_SETUPDAT
   0D25 E0                 1410 	movx	a,@dptr
   0D26 FA                 1411 	mov	r2,a
                           1412 ;     genAnd
   0D27 53 02 1F           1413 	anl	ar2,#0x1F
                           1414 ;     genCmpEq
   0D2A BA 00 02           1415 	cjne	r2,#0x00,00115$
                           1416 ;	Peephole 112.b	changed ljmp to sjmp
   0D2D 80 0A              1417 	sjmp	00101$
   0D2F                    1418 00115$:
                           1419 ;     genCmpEq
   0D2F BA 01 02           1420 	cjne	r2,#0x01,00116$
                           1421 ;	Peephole 112.b	changed ljmp to sjmp
   0D32 80 1B              1422 	sjmp	00102$
   0D34                    1423 00116$:
                           1424 ;     genCmpEq
   ...
   0D34 BA 02 61           1429 	cjne	r2,#0x02,00107$
   0D37 80 2A              1430 	sjmp	00103$
                           1431 ;00117$:
   0D39                    1432 00101$:
                           1433 ;Initial/src/lib/usb_common.c:222: EP0BUF[0] = bmGSDA_SELF_POWERED;	// FIXME app should handle
                           1434 ;     genPointerSet
                           1435 ;     genFarPointerSet
   0D39 90 E7 40           1436 	mov	dptr,#_EP0BUF
   0D3C 74 01              1437 	mov	a,#0x01
   0D3E F0                 1438 	movx	@dptr,a
                           1439 ;Initial/src/lib/usb_common.c:223: EP0BUF[1] = 0;
                           1440 ;     genPointerSet
                           1441 ;     genFarPointerSet
   0D3F 90 E7 41           1442 	mov	dptr,#(_EP0BUF + 0x0001)
   ...
   0D42 E4                 1448 	clr	a
   0D43 F0                 1449 	movx	@dptr,a
   0D44 90 E6 8A           1450 	mov	dptr,#_EP0BCH
   0D47 F0                 1451 	movx	@dptr,a
                           1452 ;Initial/src/lib/usb_common.c:225: EP0BCL = 2;
                           1453 ;     genAssign
   0D48 90 E6 8B           1454 	mov	dptr,#_EP0BCL
   0D4B 74 02              1455 	mov	a,#0x02
   0D4D F0                 1456 	movx	@dptr,a
   ...
   0D4F 90 E7 40           1466 	mov	dptr,#_EP0BUF
   ...
   0D52 E4                 1477 	clr	a
   0D53 F0                 1478 	movx	@dptr,a
   0D54 90 E7 41           1479 	mov	dptr,#(_EP0BUF + 0x0001)
   0D57 F0                 1480 	movx	@dptr,a
   0D58 90 E6 8A           1481 	mov	dptr,#_EP0BCH
   0D5B F0                 1482 	movx	@dptr,a
                           1483 ;Initial/src/lib/usb_common.c:232: EP0BCL = 2;
                           1484 ;     genAssign
   0D5C 90 E6 8B           1485 	mov	dptr,#_EP0BCL
   0D5F 74 02              1486 	mov	a,#0x02
   0D61 F0                 1487 	movx	@dptr,a
   ...
   0D63 90 E6 BC           1497 	mov	dptr,#(_SETUPDAT + 0x0004)
   0D66 E0                 1498 	movx	a,@dptr
                           1499 ;     genCall
                           1500 ;	Peephole 244.c	loading dpl from a instead of r2
   0D67 FA                 1501 	mov	r2,a
   0D68 F5 82              1502 	mov	dpl,a
   0D6A 12 0B E0           1503 	lcall	_plausible_endpoint
   0D6D E5 82              1504 	mov	a,dpl
                           1505 ;     genIfx
                           1506 ;     genIfxJump
                           1507 ;	Peephole 110	removed ljmp by inverse jump logic
   0D6F 60 24              1508 	jz	00105$
   0D71                    1509 00118$:
                           1510 ;Initial/src/lib/usb_common.c:238: EP0BUF[0] = *epcs (wIndexL) & bmEPSTALL;
                           1511 ;     genPointerGet
                           1512 ;     genFarPointerGet
   0D71 90 E6 BC           1513 	mov	dptr,#(_SETUPDAT + 0x0004)
   0D74 E0                 1514 	movx	a,@dptr
                           1515 ;     genCall
                           1516 ;	Peephole 244.c	loading dpl from a instead of r2
   0D75 FA                 1517 	mov	r2,a
   0D76 F5 82              1518 	mov	dpl,a
   0D78 12 0B FF           1519 	lcall	_epcs
                           1520 ;     genPointerGet
                           1521 ;     genFarPointerGet
   0D7B E0                 1522 	movx	a,@dptr
   0D7C FA                 1523 	mov	r2,a
                           1524 ;     genAnd
   0D7D 53 02 01           1525 	anl	ar2,#0x01
                           1526 ;     genPointerSet
                           1527 ;     genFarPointerSet
   0D80 90 E7 40           1528 	mov	dptr,#_EP0BUF
   0D83 EA                 1529 	mov	a,r2
   0D84 F0                 1530 	movx	@dptr,a
                           1531 ;Initial/src/lib/usb_common.c:239: EP0BUF[1] = 0;
                           1532 ;     genPointerSet
                           1533 ;     genFarPointerSet
   0D85 90 E7 41           1534 	mov	dptr,#(_EP0BUF + 0x0001)
   ...
   0D88 E4                 1540 	clr	a
   0D89 F0                 1541 	movx	@dptr,a
   0D8A 90 E6 8A           1542 	mov	dptr,#_EP0BCH
   0D8D F0                 1543 	movx	@dptr,a
                           1544 ;Initial/src/lib/usb_common.c:241: EP0BCL = 2;
                           1545 ;     genAssign
   0D8E 90 E6 8B           1546 	mov	dptr,#_EP0BCL
   0D91 74 02              1547 	mov	a,#0x02
   0D93 F0                 1548 	movx	@dptr,a
   ...
   0D95 02 05 64           1560 	ljmp	_fx2_stall_ep0
   0D98                    1561 00107$:
   ...
   0D98 02 05 64           1566 	ljmp	_fx2_stall_ep0
   0D9B                    1567 00109$:
   0D9B 22                 1568 	ret
                           1569 ;------------------------------------------------------------
                           ...
                           1577 ;	-----------------------------------------
   0D9C                    1578 _usb_handle_get_descriptor:
                           1579 ;Initial/src/lib/usb_common.c:255: switch (wValueH)
                           1580 ;     genPointerGet
                           1581 ;     genFarPointerGet
   0D9C 90 E6 BB           1582 	mov	dptr,#(_SETUPDAT + 0x0003)
   0D9F E0                 1583 	movx	a,@dptr
   0DA0 FA                 1584 	mov	r2,a
                           1585 ;     genCmpEq
   0DA1 BA 01 02           1586 	cjne	r2,#0x01,00127$
                           1587 ;	Peephole 112.b	changed ljmp to sjmp
   0DA4 80 17              1588 	sjmp	00101$
   0DA6                    1589 00127$:
                           1590 ;     genCmpEq
   0DA6 BA 02 02           1591 	cjne	r2,#0x02,00128$
                           1592 ;	Peephole 112.b	changed ljmp to sjmp
   0DA9 80 3C              1593 	sjmp	00105$
   0DAB                    1594 00128$:
                           1595 ;     genCmpEq
   0DAB BA 03 02           1596 	cjne	r2,#0x03,00129$
                           1597 ;	Peephole 112.b	changed ljmp to sjmp
   0DAE 80 61              1598 	sjmp	00113$
   0DB0                    1599 00129$:
                           1600 ;     genCmpEq
   0DB0 BA 06 02           1601 	cjne	r2,#0x06,00130$
                           1602 ;	Peephole 112.b	changed ljmp to sjmp
   0DB3 80 1D              1603 	sjmp	00102$
   0DB5                    1604 00130$:
                           1605 ;     genCmpEq
   0DB5 BA 07 02           1606 	cjne	r2,#0x07,00131$
                           1607 ;	Peephole 112.b	changed ljmp to sjmp
   0DB8 80 42              1608 	sjmp	00110$
   0DBA                    1609 00131$:
   0DBA 02 0E 4C           1610 	ljmp	00117$
   ...
   0DBD                    1612 00101$:
                           ...
                           1614 ;     genCast
   0DBD AA 23              1615 	mov	r2,_current_device_descr
   0DBF AB 24              1616 	mov	r3,(_current_device_descr + 1)
                           1617 ;     genRightShift
                           1618 ;     genRightShiftLiteral
                           1619 ;     genrshTwo
   0DC1 8B 04              1620 	mov	ar4,r3
   0DC3 7D 00              1621 	mov	r5,#0x00
                           1622 ;     genCast
   0DC5 90 E6 B3           1623 	mov	dptr,#_SUDPTRH
   0DC8 EC                 1624 	mov	a,r4
   0DC9 F0                 1625 	movx	@dptr,a
                           1626 ;Initial/src/lib/usb_common.c:260: SUDPTRL = LSB (current_device_descr);
                           1627 ;     genAnd
   0DCA 7B 00              1628 	mov	r3,#0x00
                           1629 ;     genCast
   0DCC 90 E6 B4           1630 	mov	dptr,#_SUDPTRL
   0DCF EA                 1631 	mov	a,r2
   0DD0 F0                 1632 	movx	@dptr,a
   ...
   0DD2                    1637 00102$:
                           ...
                           1639 ;     genCast
   0DD2 AA 25              1640 	mov	r2,_current_devqual_descr
   0DD4 AB 26              1641 	mov	r3,(_current_devqual_descr + 1)
                           1642 ;     genRightShift
                           1643 ;     genRightShiftLiteral
                           1644 ;     genrshTwo
   0DD6 8B 04              1645 	mov	ar4,r3
   0DD8 7D 00              1646 	mov	r5,#0x00
                           1647 ;     genCast
   0DDA 90 E6 B3           1648 	mov	dptr,#_SUDPTRH
   0DDD EC                 1649 	mov	a,r4
   0DDE F0                 1650 	movx	@dptr,a
                           1651 ;Initial/src/lib/usb_common.c:265: SUDPTRL = LSB (current_devqual_descr);
                           1652 ;     genAnd
   0DDF 7B 00              1653 	mov	r3,#0x00
                           1654 ;     genCast
   0DE1 90 E6 B4           1655 	mov	dptr,#_SUDPTRL
   0DE4 EA                 1656 	mov	a,r2
   0DE5 F0                 1657 	movx	@dptr,a
   ...
   0DE7                    1663 00105$:
                           ...
                           1665 ;     genCast
   0DE7 AA 27              1666 	mov	r2,_current_config_descr
   0DE9 AB 28              1667 	mov	r3,(_current_config_descr + 1)
                           1668 ;     genRightShift
                           1669 ;     genRightShiftLiteral
                           1670 ;     genrshTwo
   0DEB 8B 04              1671 	mov	ar4,r3
   0DED 7D 00              1672 	mov	r5,#0x00
                           1673 ;     genCast
   0DEF 90 E6 B3           1674 	mov	dptr,#_SUDPTRH
   0DF2 EC                 1675 	mov	a,r4
   0DF3 F0                 1676 	movx	@dptr,a
                           1677 ;Initial/src/lib/usb_common.c:274: SUDPTRL = LSB (current_config_descr);
                           1678 ;     genAnd
   0DF4 7B 00              1679 	mov	r3,#0x00
                           1680 ;     genCast
   0DF6 90 E6 B4           1681 	mov	dptr,#_SUDPTRL
   0DF9 EA                 1682 	mov	a,r2
   0DFA F0                 1683 	movx	@dptr,a
   ...
   0DFC                    1689 00110$:
                           ...
                           1691 ;     genCast
   0DFC AA 29              1692 	mov	r2,_other_config_descr
   0DFE AB 2A              1693 	mov	r3,(_other_config_descr + 1)
                           1694 ;     genRightShift
                           1695 ;     genRightShiftLiteral
                           1696 ;     genrshTwo
   0E00 8B 04              1697 	mov	ar4,r3
   0E02 7D 00              1698 	mov	r5,#0x00
                           1699 ;     genCast
   0E04 90 E6 B3           1700 	mov	dptr,#_SUDPTRH
   0E07 EC                 1701 	mov	a,r4
   0E08 F0                 1702 	movx	@dptr,a
                           1703 ;Initial/src/lib/usb_common.c:284: SUDPTRL = LSB (other_config_descr);
                           1704 ;     genAnd
   0E09 7B 00              1705 	mov	r3,#0x00
                           1706 ;     genCast
   0E0B 90 E6 B4           1707 	mov	dptr,#_SUDPTRL
   0E0E EA                 1708 	mov	a,r2
   0E0F F0                 1709 	movx	@dptr,a
   ...
   0E11 90 E6 BA           1719 	mov	dptr,#(_SETUPDAT + 0x0002)
   0E14 E0                 1720 	movx	a,@dptr
   0E15 FA                 1721 	mov	r2,a
                           1722 ;     genAssign
   0E16 90 E0 7C           1723 	mov	dptr,#_nstring_descriptors
   0E19 E0                 1724 	movx	a,@dptr
   0E1A FB                 1725 	mov	r3,a
                           1726 ;     genCmpLt
                           1727 ;     genCmp
   0E1B C3                 1728 	clr	c
   0E1C EA                 1729 	mov	a,r2
   0E1D 9B                 1730 	subb	a,r3
                           1731 ;     genIfxJump
                           1732 ;	Peephole 112.b	changed ljmp to sjmp
                           1733 ;	Peephole 160	removed sjmp by inverse jump logic
   0E1E 40 03              1734 	jc	00115$
   0E20                    1735 00132$:
   ...
   0E20 02 05 64           1741 	ljmp	_fx2_stall_ep0
   0E23                    1742 00115$:
                           1743 ;Initial/src/lib/usb_common.c:293: xdata char *p = string_descriptors[wValueL];
                           1744 ;     genPointerGet
                           1745 ;     genFarPointerGet
   0E23 90 E6 BA           1746 	mov	dptr,#(_SETUPDAT + 0x0002)
   0E26 E0                 1747 	movx	a,@dptr
                           1748 ;     genMult
                           1749 ;     genMultOneByte
                           1750 ;	Peephole 105	removed redundant mov
   0E27 FA                 1751 	mov	r2,a
   0E28 75 F0 02           1752 	mov	b,#0x02
   0E2B A4                 1753 	mul	ab
                           1754 ;     genPlus
   0E2C 24 7D              1755 	add	a,#_string_descriptors
   0E2E F5 82              1756 	mov	dpl,a
   0E30 74 E0              1757 	mov	a,#(_string_descriptors >> 8)
   0E32 35 F0              1758 	addc	a,b
   0E34 F5 83              1759 	mov	dph,a
                           1760 ;     genPointerGet
                           1761 ;     genFarPointerGet
   0E36 E0                 1762 	movx	a,@dptr
   0E37 FA                 1763 	mov	r2,a
   0E38 A3                 1764 	inc	dptr
   0E39 E0                 1765 	movx	a,@dptr
   0E3A FB                 1766 	mov	r3,a
                           1767 ;Initial/src/lib/usb_common.c:294: SUDPTRH = MSB (p);
                           1768 ;     genCast
                           1769 ;     genRightShift
                           1770 ;     genRightShiftLiteral
                           1771 ;     genrshTwo
   0E3B 8B 04              1772 	mov	ar4,r3
   0E3D 7D 00              1773 	mov	r5,#0x00
                           1774 ;     genCast
   0E3F 90 E6 B3           1775 	mov	dptr,#_SUDPTRH
   0E42 EC                 1776 	mov	a,r4
   0E43 F0                 1777 	movx	@dptr,a
                           1778 ;Initial/src/lib/usb_common.c:295: SUDPTRL = LSB (p);
                           1779 ;     genAnd
   0E44 7B 00              1780 	mov	r3,#0x00
                           1781 ;     genCast
   0E46 90 E6 B4           1782 	mov	dptr,#_SUDPTRL
   0E49 EA                 1783 	mov	a,r2
   0E4A F0                 1784 	movx	@dptr,a
   ...
   0E4C 02 05 64           1795 	ljmp	_fx2_stall_ep0
                           1796 ;------------------------------------------------------------
                           ...
                           1803 ;	-----------------------------------------
   0E4F                    1804 _usb_handle_IN_std_requests:
                           1805 ;Initial/src/lib/usb_common.c:307: switch (bRequest)
                           1806 ;     genPointerGet
                           1807 ;     genFarPointerGet
   0E4F 90 E6 B9           1808 	mov	dptr,#(_SETUPDAT + 0x0001)
   0E52 E0                 1809 	movx	a,@dptr
                           1810 ;     genCmpEq
                           1811 ;	Peephole 112.b	changed ljmp to sjmp
                           1812 ;	Peephole 115.b	jump optimization
   0E53 FA                 1813 	mov	r2,a
   0E54 60 36              1814 	jz	00104$
   0E56                    1815 00114$:
                           1816 ;     genCmpEq
   0E56 BA 06 02           1817 	cjne	r2,#0x06,00115$
                           1818 ;	Peephole 112.b	changed ljmp to sjmp
   0E59 80 2E              1819 	sjmp	00103$
   0E5B                    1820 00115$:
                           1821 ;     genCmpEq
   0E5B BA 08 02           1822 	cjne	r2,#0x08,00116$
                           1823 ;	Peephole 112.b	changed ljmp to sjmp
   0E5E 80 05              1824 	sjmp	00101$
   0E60                    1825 00116$:
                           1826 ;     genCmpEq
   ...
   0E60 BA 0A 2C           1831 	cjne	r2,#0x0A,00106$
   0E63 80 12              1832 	sjmp	00102$
                           1833 ;00117$:
   0E65                    1834 00101$:
                           1835 ;Initial/src/lib/usb_common.c:311: EP0BUF[0] = _usb_config;	// FIXME app should handle
                           1836 ;     genPointerSet
                           1837 ;     genFarPointerSet
   0E65 90 E7 40           1838 	mov	dptr,#_EP0BUF
   0E68 E5 21              1839 	mov	a,__usb_config
   0E6A F0                 1840 	movx	@dptr,a
                           1841 ;Initial/src/lib/usb_common.c:312: EP0BCH = 0;
                           1842 ;     genAssign
   0E6B 90 E6 8A           1843 	mov	dptr,#_EP0BCH
                           1844 ;	Peephole 181	changed mov to clr
   0E6E E4                 1845 	clr	a
   0E6F F0                 1846 	movx	@dptr,a
                           1847 ;Initial/src/lib/usb_common.c:313: EP0BCL = 1;
                           1848 ;     genAssign
   0E70 90 E6 8B           1849 	mov	dptr,#_EP0BCL
   0E73 74 01              1850 	mov	a,#0x01
   0E75 F0                 1851 	movx	@dptr,a
   ...
   0E77 90 E7 40           1861 	mov	dptr,#_EP0BUF
   0E7A E5 22              1862 	mov	a,__usb_alt_setting
   0E7C F0                 1863 	movx	@dptr,a
                           1864 ;Initial/src/lib/usb_common.c:318: EP0BCH = 0;
                           1865 ;     genAssign
   0E7D 90 E6 8A           1866 	mov	dptr,#_EP0BCH
                           1867 ;	Peephole 181	changed mov to clr
   0E80 E4                 1868 	clr	a
   0E81 F0                 1869 	movx	@dptr,a
                           1870 ;Initial/src/lib/usb_common.c:319: EP0BCL = 1;
                           1871 ;     genAssign
   0E82 90 E6 8B           1872 	mov	dptr,#_EP0BCL
   0E85 74 01              1873 	mov	a,#0x01
   0E87 F0                 1874 	movx	@dptr,a
   ...
   0E89 02 0D 9C           1888 	ljmp	_usb_handle_get_descriptor
   0E8C                    1889 00104$:
   ...
   0E8C 02 0D 22           1897 	ljmp	_usb_handle_get_status
   0E8F                    1898 00106$:
   ...
   0E8F 02 05 64           1903 	ljmp	_fx2_stall_ep0
   0E92                    1904 00108$:
   0E92 22                 1905 	ret
                           1906 ;------------------------------------------------------------
                           ...
                           1913 ;	-----------------------------------------
   0E93                    1914 _usb_handle_OUT_std_requests:
                           1915 ;Initial/src/lib/usb_common.c:339: switch (bRequest)
                           1916 ;     genPointerGet
                           1917 ;     genFarPointerGet
   0E93 90 E6 B9           1918 	mov	dptr,#(_SETUPDAT + 0x0001)
   0E96 E0                 1919 	movx	a,@dptr
   0E97 FA                 1920 	mov	r2,a
                           1921 ;     genCmpEq
   0E98 BA 01 02           1922 	cjne	r2,#0x01,00117$
                           1923 ;	Peephole 112.b	changed ljmp to sjmp
   0E9B 80 27              1924 	sjmp	00103$
   0E9D                    1925 00117$:
                           1926 ;     genCmpEq
   0E9D BA 03 02           1927 	cjne	r2,#0x03,00118$
                           1928 ;	Peephole 112.b	changed ljmp to sjmp
   0EA0 80 25              1929 	sjmp	00104$
   0EA2                    1930 00118$:
                           1931 ;     genCmpEq
   0EA2 BA 05 02           1932 	cjne	r2,#0x05,00119$
                           1933 ;	Peephole 112.b	changed ljmp to sjmp
   0EA5 80 23              1934 	sjmp	00107$
   0EA7                    1935 00119$:
                           1936 ;     genCmpEq
   0EA7 BA 07 02           1937 	cjne	r2,#0x07,00120$
                           1938 ;	Peephole 112.b	changed ljmp to sjmp
   0EAA 80 1E              1939 	sjmp	00107$
   0EAC                    1940 00120$:
                           1941 ;     genCmpEq
   0EAC BA 09 02           1942 	cjne	r2,#0x09,00121$
                           1943 ;	Peephole 112.b	changed ljmp to sjmp
   0EAF 80 05              1944 	sjmp	00101$
   0EB1                    1945 00121$:
                           1946 ;     genCmpEq
   ...
   0EB1 BA 0B 16           1951 	cjne	r2,#0x0B,00107$
   0EB4 80 07              1952 	sjmp	00102$
                           1953 ;00122$:
   0EB6                    1954 00101$:
                           1955 ;Initial/src/lib/usb_common.c:343: _usb_config = wValueL;		// FIXME app should handle
                           1956 ;     genPointerGet
                           1957 ;     genFarPointerGet
   0EB6 90 E6 BA           1958 	mov	dptr,#(_SETUPDAT + 0x0002)
   0EB9 E0                 1959 	movx	a,@dptr
   0EBA F5 21              1960 	mov	__usb_config,a
   ...
   0EBD 90 E6 BA           1970 	mov	dptr,#(_SETUPDAT + 0x0002)
   0EC0 E0                 1971 	movx	a,@dptr
   0EC1 F5 22              1972 	mov	__usb_alt_setting,a
   ...
   0EC4 02 0C B6           1986 	ljmp	_usb_handle_clear_feature
   0EC7                    1987 00104$:
   ...
   0EC7 02 0C 48           1995 	ljmp	_usb_handle_set_feature
   0ECA                    1996 00107$:
   ...
   0ECA 02 05 64           2001 	ljmp	_fx2_stall_ep0
   0ECD                    2002 00109$:
   0ECD 22                 2003 	ret
                           2004 ;------------------------------------------------------------
   ...
   0EDF 22                 2040 	ret
                           ...
                           2048 ;	-----------------------------------------
   0EE0                    2049 _usb_handle_setup_packet:
                           2050 ;Initial/src/lib/usb_common.c:378: _usb_got_SUDAV = 0;
                           2051 ;     genAssign
   0EE0 C2 03              2052 	clr	__usb_got_SUDAV
                           2053 ;Initial/src/lib/usb_common.c:382: switch (bRequestType & bmRT_TYPE_MASK)
                           2054 ;     genPointerGet
                           2055 ;     genFarPointerGet
   0EE2 90 E6 B8           2056 	mov	dptr,#_SETUPDAT
   0EE5 E0                 2057 	movx	a,@dptr
   0EE6 FA                 2058 	mov	r2,a
                           2059 ;     genAnd
   0EE7 53 02 60           2060 	anl	ar2,#0x60
                           2061 ;     genCmpEq
   0EEA BA 00 02           2062 	cjne	r2,#0x00,00115$
                           2063 ;	Peephole 112.b	changed ljmp to sjmp
   0EED 80 1E              2064 	sjmp	00106$
   0EEF                    2065 00115$:
                           2066 ;     genCmpEq
   0EEF BA 20 02           2067 	cjne	r2,#0x20,00116$
                           2068 ;	Peephole 112.b	changed ljmp to sjmp
   0EF2 80 08              2069 	sjmp	00102$
   0EF4                    2070 00116$:
                           2071 ;     genCmpEq
   0EF4 BA 40 02           2072 	cjne	r2,#0x40,00117$
                           2073 ;	Peephole 112.b	changed ljmp to sjmp
   0EF7 80 08              2074 	sjmp	00103$
   0EF9                    2075 00117$:
                           2076 ;     genCmpEq
                           2077 ;	Peephole 112.b	changed ljmp to sjmp
                           2078 ;	Peephole 199	optimized misc jump sequence
   0EF9 BA 60 16           2079 	cjne	r2,#0x60,00107$
                           2080 ;00118$:
   ...
   0EFC                    2084 00102$:
                           ...
                           2086 ;     genCall
   0EFC 12 05 64           2087 	lcall	_fx2_stall_ep0
   ...
   0F0B 80 08              2108 	sjmp	00108$
   0F0D                    2109 00106$:
                           2110 ;Initial/src/lib/usb_common.c:398: usb_handle_std_requests();
                           2111 ;     genCall
   0F0D 12 0E CE           2112 	lcall	_usb_handle_std_requests
   ...
   0F15 90 E6 A0           2127 	mov	dptr,#_EP0CS
   0F18 E0                 2128 	movx	a,@dptr
   0F19 FA                 2129 	mov	r2,a
   0F1A 44 80              2130 	orl	a,#0x80
   0F1C F0                 2131 	movx	@dptr,a
   0F1D                    2132 00109$:
   0F1D 22                 2133 	ret
                           2134 	.area CSEG    (CODE)
