                              ...
                              4 ; This file generated Mon Jul 31 08:57:57 2006
                              5 ;--------------------------------------------------------
                              6 	.module fx2utils
   ...
   0693 90 E6 A0            711 	mov	dptr,#_EP0CS
   0696 E0                  712 	movx	a,@dptr
   0697 FA                  713 	mov	r2,a
   0698 44 01               714 	orl	a,#0x01
   069A F0                  715 	movx	@dptr,a
   069B                     716 00101$:
   069B 22                  717 	ret
                            718 ;------------------------------------------------------------
                            ...
                            726 ;	-----------------------------------------
   069C                     727 _fx2_reset_data_toggle:
                            728 ;     genReceive
   069C AA 82               729 	mov	r2,dpl
                            730 ;Initial/src/lib/fx2utils.c:39: TOGCTL = ((ep & 0x80) >> 3 | (ep & 0x0f));
                            731 ;     genAnd
   069E 74 80               732 	mov	a,#0x80
   06A0 5A                  733 	anl	a,r2
                            734 ;     genRightShift
                            735 ;     genRightShiftLiteral
                            736 ;     genrshOne
                            737 ;	Peephole 105	removed redundant mov
   06A1 FB                  738 	mov	r3,a
   06A2 C4                  739 	swap	a
   06A3 23                  740 	rl	a
   06A4 54 1F               741 	anl	a,#0x1f
   06A6 FB                  742 	mov	r3,a
                            743 ;     genAnd
   06A7 74 0F               744 	mov	a,#0x0F
   06A9 5A                  745 	anl	a,r2
                            746 ;     genOr
   06AA 90 E6 83            747 	mov	dptr,#_TOGCTL
   06AD 4B                  748 	orl	a,r3
   06AE F0                  749 	movx	@dptr,a
                            750 ;Initial/src/lib/fx2utils.c:40: TOGCTL |= bmRESETTOGGLE;
                            751 ;     genAssign
                            752 ;     genOr
                            753 ;	Peephole 248.a	optimized or to xdata
   06AF 90 E6 83            754 	mov	dptr,#_TOGCTL
   06B2 E0                  755 	movx	a,@dptr
   06B3 FA                  756 	mov	r2,a
   06B4 44 20               757 	orl	a,#0x20
   06B6 F0                  758 	movx	@dptr,a
   06B7                     759 00101$:
   06B7 22                  760 	ret
                            761 ;------------------------------------------------------------
                            ...
                            768 ;	-----------------------------------------
   06B8                     769 _fx2_renumerate:
                            770 ;Initial/src/lib/fx2utils.c:46: USBCS |= bmDISCON | bmRENUM;
                            771 ;     genAssign
                            772 ;     genOr
                            773 ;	Peephole 248.a	optimized or to xdata
   06B8 90 E6 80            774 	mov	dptr,#_USBCS
   06BB E0                  775 	movx	a,@dptr
   06BC FA                  776 	mov	r2,a
   06BD 44 0A               777 	orl	a,#0x0A
   06BF F0                  778 	movx	@dptr,a
                            779 ;Initial/src/lib/fx2utils.c:48: mdelay (250);
                            780 ;     genCall
                            781 ;	Peephole 182.b	used 16 bit load of dptr
   06C0 90 00 FA            782 	mov	dptr,#0x00FA
   06C3 12 06 80            783 	lcall	_mdelay
                            784 ;Initial/src/lib/fx2utils.c:50: USBIRQ = 0xff;		// clear any pending USB irqs...
                            785 ;     genAssign
   06C6 90 E6 5D            786 	mov	dptr,#_USBIRQ
   06C9 74 FF               787 	mov	a,#0xFF
   06CB F0                  788 	movx	@dptr,a
                            789 ;Initial/src/lib/fx2utils.c:51: EPIRQ =  0xff;		//   they're from before the renumeration
                            790 ;     genAssign
   06CC 90 E6 5F            791 	mov	dptr,#_EPIRQ
   06CF 74 FF               792 	mov	a,#0xFF
   06D1 F0                  793 	movx	@dptr,a
                            794 ;Initial/src/lib/fx2utils.c:53: EXIF &= ~bmEXIF_USBINT;
                            795 ;     genAnd
   06D2 53 91 EF            796 	anl	_EXIF,#0xEF
                            797 ;Initial/src/lib/fx2utils.c:55: USBCS &= ~bmDISCON;		// reconnect USB
                            798 ;     genAssign
                            799 ;     genAnd
                            800 ;	Peephole 248.b	optimized and to xdata
   06D5 90 E6 80            801 	mov	dptr,#_USBCS
   06D8 E0                  802 	movx	a,@dptr
   06D9 FA                  803 	mov	r2,a
   06DA 54 F7               804 	anl	a,#0xF7
   06DC F0                  805 	movx	@dptr,a
   06DD                     806 00101$:
   06DD 22                  807 	ret
                            808 	.area CSEG    (CODE)
