...
;------------------------------------------------------------
;Initial/src/hpsdr_main.c:210: static unsigned char	count = 1;
;     genAssign
...
00161$:
	mov	dpl,a
;Initial/src/hpsdr_main.c:119: case VRQ_I2C_SPEED_SET:
;	Peephole 112.b	changed ljmp to sjmp
;	Peephole 251.b	replaced sjmp to ret with ret
	ret
00118$:
;Initial/src/hpsdr_main.c:120: if (wValueL == 1)
;     genPointerGet
;     genFarPointerGet
	mov	dptr,#(_SETUPDAT + 0x0002)
	movx	a,@dptr
...
00163$:
;Initial/src/hpsdr_main.c:121: I2CTL |= bm400KHZ;
;     genAssign
;     genOr
...
;	Peephole 112.b	changed ljmp to sjmp
	sjmp	00130$
00120$:
;Initial/src/hpsdr_main.c:123: I2CTL &= ~bm400KHZ;
;     genAssign
;     genAnd
;	Peephole 248.b	optimized and to xdata
	...
	anl	a,#0xFE
	movx	@dptr,a
;Initial/src/hpsdr_main.c:124: break;
;Initial/src/hpsdr_main.c:126: case VRQ_CPU_SPEED_SET:
;	Peephole 112.b	changed ljmp to sjmp
	sjmp	00130$
00122$:
;Initial/src/hpsdr_main.c:127: if (wValueL == 0)
;     genPointerGet
;     genFarPointerGet
	mov	dptr,#(_SETUPDAT + 0x0002)
	movx	a,@dptr
...
;	Peephole 112.b	changed ljmp to sjmp
	sjmp	00127$
00165$:
;Initial/src/hpsdr_main.c:128: CPUCS = bmCLKOE; // 12 MHz
;     genAssign
	mov	dptr,#_CPUCS
	mov	a,#0x02
	movx	@dptr,a
;	Peephole 112.b	changed ljmp to sjmp
	sjmp	00130$
00127$:
;Initial/src/hpsdr_main.c:129: else if (wValueL == 1)
;     genPointerGet
;     genFarPointerGet
	mov	dptr,#(_SETUPDAT + 0x0002)
	movx	a,@dptr
...
;	Peephole 200	removed redundant sjmp
00167$:
;Initial/src/hpsdr_main.c:130: CPUCS = bmCLKSPD0 | bmCLKOE; // 24 MHz
;     genAssign
	mov	dptr,#_CPUCS
	mov	a,#0x0A
	movx	@dptr,a
;	Peephole 112.b	changed ljmp to sjmp
	sjmp	00130$
00124$:
;Initial/src/hpsdr_main.c:132: CPUCS = bmCLKSPD1 | bmCLKOE; // 48 MHz
;     genAssign
	mov	dptr,#_CPUCS
	mov	a,#0x12
	movx	@dptr,a
;Initial/src/hpsdr_main.c:133: break;
;Initial/src/hpsdr_main.c:135: default:
;	Peephole 112.b	changed ljmp to sjmp
	sjmp	00130$
00129$:
;Initial/src/hpsdr_main.c:136: return 0;
;     genRet
	mov	dpl,#0x00
;Initial/src/hpsdr_main.c:137: }
;	Peephole 112.b	changed ljmp to sjmp
;Initial/src/hpsdr_main.c:138: return 1;
;     genRet
...
;------------------------------------------------------------
;------------------------------------------------------------
;Initial/src/hpsdr_main.c:141: unsigned char app_vendor_IN_cmd(void)
;	-----------------------------------------
;	 function app_vendor_IN_cmd
;	-----------------------------------------
_app_vendor_IN_cmd:
;Initial/src/hpsdr_main.c:143: switch (bRequest)
;     genPointerGet
;     genFarPointerGet
	mov	dptr,#(_SETUPDAT + 0x0001)
	movx	a,@dptr
...
00122$:
	ljmp	00109$
;Initial/src/hpsdr_main.c:145: case VRQ_I2C_READ:
00101$:
;Initial/src/hpsdr_main.c:146: if (!i2c_read (wValueL, EP0BUF, wLengthL))
;     genPointerGet
;     genFarPointerGet
	mov	dptr,#(_SETUPDAT + 0x0002)
	movx	a,@dptr
...
;     genIfxJump
;	Peephole 109	removed ljmp by inverse jump logic
;Initial/src/hpsdr_main.c:147: return 0;
;     genRet
;	Peephole 256.c	loading dpl with zero from a
	jnz	00103$
00123$:
...
;	Peephole 251.a	replaced ljmp to ret with ret
	ret
00103$:
;Initial/src/hpsdr_main.c:148: EP0BCH = 0;
;     genAssign
	mov	dptr,#_EP0BCH
;	Peephole 181	changed mov to clr
	clr	a
	movx	@dptr,a
;Initial/src/hpsdr_main.c:149: EP0BCL = wLengthL;
;     genPointerGet
;     genFarPointerGet
	mov	dptr,#(_SETUPDAT + 0x0006)
	movx	a,@dptr
...
;	Peephole 100	removed redundant mov
	...
	mov	dptr,#_EP0BCL
	movx	@dptr,a
;Initial/src/hpsdr_main.c:150: break;
	ljmp	00110$
;Initial/src/hpsdr_main.c:152: case VRQ_SPI_READ:
00104$:
;Initial/src/hpsdr_main.c:153: if (!spi_read (wValueH, wValueL, wIndexH, wIndexL, EP0BUF, wLengthL))
;     genPointerGet
;     genFarPointerGet
	mov	dptr,#(_SETUPDAT + 0x0003)
	movx	a,@dptr
...
;     genIfxJump
;	Peephole 109	removed ljmp by inverse jump logic
;Initial/src/hpsdr_main.c:154: return 0;
;     genRet
;	Peephole 256.c	loading dpl with zero from a
	jnz	00106$
00124$:
...
;	Peephole 251.b	replaced sjmp to ret with ret
	ret
00106$:
;Initial/src/hpsdr_main.c:155: EP0BCH = 0;
;     genAssign
	mov	dptr,#_EP0BCH
;	Peephole 181	changed mov to clr
	clr	a
	movx	@dptr,a
;Initial/src/hpsdr_main.c:156: EP0BCL = wLengthL;
;     genPointerGet
;     genFarPointerGet
	mov	dptr,#(_SETUPDAT + 0x0006)
	movx	a,@dptr
...
;	Peephole 100	removed redundant mov
	...
	mov	dptr,#_EP0BCL
	movx	@dptr,a
;Initial/src/hpsdr_main.c:157: break;
;Initial/src/hpsdr_main.c:159: case VRQ_EEPROM_TYPE_READ:
;	Peephole 112.b	changed ljmp to sjmp
	sjmp	00110$
00107$:
;Initial/src/hpsdr_main.c:160: EP0BUF[0] = I2CS & bmID; // 16 = 2 byte, 8 = 1 byte
;     genAssign
	mov	dptr,#_I2CS
	movx	a,@dptr
	mov	r2,a
...
;     genFarPointerSet
	...
	mov	a,r2
	movx	@dptr,a
;Initial/src/hpsdr_main.c:161: EP0BCH = 0;
;     genAssign
	mov	dptr,#_EP0BCH
;	Peephole 181	changed mov to clr
	clr	a
	movx	@dptr,a
;Initial/src/hpsdr_main.c:162: EP0BCL = 1;
;     genAssign
	mov	dptr,#_EP0BCL
	mov	a,#0x01
	movx	@dptr,a
;Initial/src/hpsdr_main.c:163: break;
;Initial/src/hpsdr_main.c:165: case VRQ_I2C_SPEED_READ:
;	Peephole 112.b	changed ljmp to sjmp
	sjmp	00110$
00108$:
;Initial/src/hpsdr_main.c:166: EP0BUF[0] = I2CTL & bm400KHZ; // 0 = 100 kHz, 1 = 400 kHz
;     genAssign
	mov	dptr,#_I2CTL
	movx	a,@dptr
	mov	r2,a
...
;     genFarPointerSet
	...
	mov	a,r2
	movx	@dptr,a
;Initial/src/hpsdr_main.c:167: EP0BCH = 0;
;     genAssign
	mov	dptr,#_EP0BCH
;	Peephole 181	changed mov to clr
	clr	a
	movx	@dptr,a
;Initial/src/hpsdr_main.c:168: EP0BCL = 1;
;     genAssign
	mov	dptr,#_EP0BCL
	mov	a,#0x01
	movx	@dptr,a
;Initial/src/hpsdr_main.c:169: break;
;Initial/src/hpsdr_main.c:171: default:
;	Peephole 112.b	changed ljmp to sjmp
	sjmp	00110$
00109$:
;Initial/src/hpsdr_main.c:172: return 0;
;     genRet
	mov	dpl,#0x00
;Initial/src/hpsdr_main.c:173: }
;	Peephole 112.b	changed ljmp to sjmp
;Initial/src/hpsdr_main.c:174: return 1;
;     genRet
;	Peephole 237.a	removed sjmp to ret
	ret
00110$:
...
;------------------------------------------------------------
;------------------------------------------------------------
;Initial/src/hpsdr_main.c:178: app_vendor_cmd (void)
;	-----------------------------------------
;	 function app_vendor_cmd
;	-----------------------------------------
_app_vendor_cmd:
;Initial/src/hpsdr_main.c:180: if (bRequestType == VRT_VENDOR_IN)
;     genPointerGet
;     genFarPointerGet
	mov	dptr,#_SETUPDAT
	movx	a,@dptr
...
;	Peephole 200	removed redundant sjmp
00112$:
;Initial/src/hpsdr_main.c:181: return app_vendor_IN_cmd();
;     genCall
;     genRet
;	Peephole 112.b	changed ljmp to sjmp
;	Peephole 251.b	replaced sjmp to ret with ret
...
00105$:
;Initial/src/hpsdr_main.c:182: else if (bRequestType == VRT_VENDOR_OUT)
;     genPointerGet
;     genFarPointerGet
	mov	dptr,#_SETUPDAT
	movx	a,@dptr
...
;	Peephole 200	removed redundant sjmp
00114$:
;Initial/src/hpsdr_main.c:183: return app_vendor_OUT_cmd();
;     genCall
;     genRet
;	Peephole 112.b	changed ljmp to sjmp
;Initial/src/hpsdr_main.c:185: return 0;    // invalid bRequestType
;     genRet
;	Peephole 237.a	removed sjmp to ret
;	Peephole 253.a	replaced lcall/ret with ljmp
...
;------------------------------------------------------------
;------------------------------------------------------------
;Initial/src/hpsdr_main.c:189: main_loop (void)
;	-----------------------------------------
;	 function main_loop
;	-----------------------------------------
_main_loop:
;Initial/src/hpsdr_main.c:192: while (1)
00105$:
;Initial/src/hpsdr_main.c:194: if (usb_setup_packet_avail ())
;     genIfx
;     genIfxJump
;	Peephole 111	removed ljmp by inverse jump logic
	jnb	__usb_got_SUDAV,00102$
00111$:
;Initial/src/hpsdr_main.c:195: usb_handle_setup_packet ();
;     genCall
	lcall	_usb_handle_setup_packet
;	Peephole 112.b	changed ljmp to sjmp
	sjmp	00105$
00102$:
;Initial/src/hpsdr_main.c:197: putchar(32);
;     genCall
	mov	dpl,#0x20
	lcall	_putchar
;	Peephole 112.b	changed ljmp to sjmp
...
;count                     Allocated with name '_isr_tick_count_1_1'
;------------------------------------------------------------
;Initial/src/hpsdr_main.c:208: isr_tick (void) interrupt
;	-----------------------------------------
;	 function isr_tick
;	-----------------------------------------
_isr_tick:
	push	acc
;Initial/src/hpsdr_main.c:211: if (--count == 0)
;     genMinus
;     genMinusDec
...
;	Peephole 112.b	changed ljmp to sjmp
	sjmp	00102$
00107$:
;Initial/src/hpsdr_main.c:213: count = 50;
;     genAssign
	mov	_isr_tick_count_1_1,#0x32
;Initial/src/hpsdr_main.c:214: HPSDR_LED_REG ^= bmLED0;
;     genXor
	xrl	_IOC,#0x40
00102$:
;Initial/src/hpsdr_main.c:216: clear_timer_irq ();
;     genAssign
	clr	_TF2
00103$:
	pop	acc
...
;------------------------------------------------------------
;Initial/src/hpsdr_main.c:224: patch_usb_descriptors(void)
;	-----------------------------------------
;	 function patch_usb_descriptors
;	-----------------------------------------
_patch_usb_descriptors:
;Initial/src/hpsdr_main.c:229: eeprom_read(I2C_ADDR_BOOT, HW_REV_OFFSET, &hw_rev, 1);	// LSB of device id
;     genAddrOf
...
;     genCall
	mov	dpl,#0x51
	lcall	_eeprom_read
;Initial/src/hpsdr_main.c:231: usb_desc_hw_rev_binary_patch_location_0[0] = hw_rev;
;     genAssign
...
;	Peephole 100	removed redundant mov
	...
	movx	@dptr,a
;Initial/src/hpsdr_main.c:232: usb_desc_hw_rev_binary_patch_location_1[0] = hw_rev;
;     genPointerSet
;     genFarPointerSet
	mov	dptr,#_usb_desc_hw_rev_binary_patch_location_1
	mov	a,r2
	movx	@dptr,a
;Initial/src/hpsdr_main.c:233: usb_desc_hw_rev_ascii_patch_location_0[0] = hw_rev + '0';     // FIXME if we get > 9
;     genPlus
	mov	a,#0x30
...
;------------------------------------------------------------
;------------------------------------------------------------
;Initial/src/hpsdr_main.c:244: main (void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
;Initial/src/hpsdr_main.c:246: init_hpsdr();
;     genCall
	lcall	_init_hpsdr
;Initial/src/hpsdr_main.c:248: set_led_0 (1);
;     genCall
	mov	dpl,#0x01
	lcall	_set_led_0
;Initial/src/hpsdr_main.c:249: set_led_1 (0);
;     genCall
	mov	dpl,#0x00
	lcall	_set_led_1
;Initial/src/hpsdr_main.c:251: EA = 0;		// disable all interrupts
;     genAssign
	clr	_EA
;Initial/src/hpsdr_main.c:253: patch_usb_descriptors();
;     genCall
	lcall	_patch_usb_descriptors
;Initial/src/hpsdr_main.c:255: setup_autovectors ();
;     genCall
	lcall	_setup_autovectors
;Initial/src/hpsdr_main.c:256: usb_install_handlers ();
;     genCall
	lcall	_usb_install_handlers
;Initial/src/hpsdr_main.c:257: hook_timer_tick ((unsigned short) isr_tick);
;     genCast
	mov	r2,#_isr_tick
	mov	r3,#(_isr_tick >> 8)
;     genCall
...
;Initial/src/hpsdr_main.c:259: EIEX4 = 1;	// disable INT4 FIXME
;     genAssign
	setb	_EIEX4
;Initial/src/hpsdr_main.c:260: EA = 1;			// global interrupt enable
;     genAssign
	setb	_EA
;Initial/src/hpsdr_main.c:262: fx2_renumerate ();	// simulates disconnect / reconnect
;     genCall
	lcall	_fx2_renumerate
;Initial/src/hpsdr_main.c:264: main_loop ();
;     genCall
