...
;------------------------------------------------------------
;------------------------------------------------------------
;src/lib/delay.c:30: udelay1 (void) _naked
;	-----------------------------------------
;	 function udelay1
;	-----------------------------------------
_udelay1:
;	naked function: no prologue.
;src/lib/delay.c:34: _endasm;
;     genInline
...
;------------------------------------------------------------
;src/lib/delay.c:41: udelay (unsigned char usecs)
;	-----------------------------------------
;	 function udelay
;	-----------------------------------------
_udelay:
...
;     genReceive
	mov	r2,dpl
;src/lib/delay.c:43: do {
;     genAssign
00101$:
;src/lib/delay.c:44: udelay1 ();
;     genCall
	lcall	_udelay1
;src/lib/delay.c:45: } while (--usecs != 0);
;     genMinus
;     genMinusDec
;     genCmpEq
...
;------------------------------------------------------------
;------------------------------------------------------------
;src/lib/delay.c:57: mdelay1 (void) _naked
;	-----------------------------------------
;	 function mdelay1
;	-----------------------------------------
_mdelay1:
;	naked function: no prologue.
;src/lib/delay.c:68: _endasm;
;     genInline
...
;------------------------------------------------------------
;src/lib/delay.c:72: mdelay (unsigned int msecs)
;	-----------------------------------------
;	 function mdelay
;	-----------------------------------------
_mdelay:
;     genReceive
	mov	r2,dpl
	mov	r3,dph
;src/lib/delay.c:74: do {
;     genAssign
00101$:
;src/lib/delay.c:75: mdelay1 ();
;     genCall
	lcall	_mdelay1
;src/lib/delay.c:76: } while (--msecs != 0);
;     genMinus
;     genMinusDec
	dec	r2
	cjne	r2,#0xff,00107$
