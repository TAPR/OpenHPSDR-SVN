   ...
   0000                     461 	.ds 8
                    ...
                    FC00    661 _EP8FIFOBUF	=	0xfc00
                            ...
                            692 ;------------------------------------------------------------
                            693 ;src/lib/timer.c:42: hook_timer_tick (unsigned short isr_tick_handler)
                            694 ;	-----------------------------------------
                            695 ;	 function hook_timer_tick
                            696 ;	-----------------------------------------
   085D                     697 _hook_timer_tick:
                    0002    698 	ar2 = 0x02
                    0003    699 	ar3 = 0x03
                    0004    700 	ar4 = 0x04
                    0005    701 	ar5 = 0x05
                    ...
                    0001    705 	ar1 = 0x01
                            706 ;     genReceive
   085D AA 82               707 	mov	r2,dpl
   085F AB 83               708 	mov	r3,dph
                            709 ;src/lib/timer.c:44: ET2 = 0;			// disable timer 2 interrupts
                            710 ;     genAssign
   0861 C2 AD               711 	clr	_ET2
                            712 ;src/lib/timer.c:45: hook_sv (SV_TIMER_2, isr_tick_handler);
                            713 ;     genAssign
   0863 8A 2B               714 	mov	_hook_sv_PARM_2,r2
   0865 8B 2C               715 	mov	(_hook_sv_PARM_2 + 1),r3
                            716 ;     genCall
   0867 75 82 2B            717 	mov	dpl,#0x2B
   086A 12 04 AD            718 	lcall	_hook_sv
                            719 ;src/lib/timer.c:47: RCAP2H = RELOAD_VALUE >> 8;	// setup the auto reload value
                            720 ;     genAssign
   086D 75 CB 63            721 	mov	_RCAP2H,#0x63
                            722 ;src/lib/timer.c:48: RCAP2L = RELOAD_VALUE;
                            723 ;     genAssign
   0870 75 CA C0            724 	mov	_RCAP2L,#0xC0
                            725 ;src/lib/timer.c:50: T2CON = 0x04;			// interrupt on overflow; reload; run
                            726 ;     genAssign
   0873 75 C8 04            727 	mov	_T2CON,#0x04
                            728 ;src/lib/timer.c:51: ET2 = 1;			// enable timer 2 interrupts
                            729 ;     genAssign
   0876 D2 AD               730 	setb	_ET2
   0878                     731 00101$:
   0878 22                  732 	ret
                            733 	.area CSEG    (CODE)
