...
namespace SharpDSP
{
	...
	public class Transmitter
	{
		...
		public void ProcessAudioStreamTX(ref double[] input_l,
		                                 ref double[] input_r,
		                                 ref double[] output_l,
		                                 ref double[] output_r,
		                                 int numsamples)
...
//
//			double[] buffer_l = new double[DSPstate.FFTSize];
//			double[] buffer_r = new double[DSPstate.FFTSize];
//		
//
//			//TX CODE GOES HERE
		...
		//public int ChangeTXOsc(double freq)
			//        {
			//            DSPstate.TXFreqOscValue = (double)(freq);
			//            return 0;
			//        }
...
//		{
//			filter.MakeFilter((double)low, (double)high, DSPState.SampleRate, Filter.FilterType.BandPass, (FilterDesigner.WindowType)DSPState.WindowType);
//			DSPState.LowFilter = (double)low;
//			DSPState.HighFilter = (double)high;
//		}
