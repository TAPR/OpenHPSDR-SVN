...
//
// Generated on: 2007-02-09 13:00:05
//
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
  ...
  wire signed [42:0] sum_1; // sfix43_E12
  wire signed [40:0] add_signext; // sfix41_E12
  wire signed [40:0] add_signext_1; // sfix41_E12
  wire signed [41:0] add_temp; // sfix42_E12
  wire signed [42:0] sum_2; // sfix43_E12
  wire signed [42:0] add_signext_2; // sfix43_E12
  wire signed [42:0] add_signext_3; // sfix43_E12
  wire signed [43:0] add_temp_1; // sfix44_E12
  wire signed [42:0] sum_3; // sfix43_E12
  wire signed [42:0] add_signext_4; // sfix43_E12
  wire signed [42:0] add_signext_5; // sfix43_E12
  wire signed [43:0] add_temp_2; // sfix44_E12
  wire signed [42:0] sum_4; // sfix43_E12
  wire signed [42:0] add_signext_6; // sfix43_E12
  wire signed [42:0] add_signext_7; // sfix43_E12
  wire signed [43:0] add_temp_3; // sfix44_E12
  wire signed [42:0] sum_5; // sfix43_E12
  wire signed [42:0] add_signext_8; // sfix43_E12
  wire signed [42:0] add_signext_9; // sfix43_E12
  wire signed [43:0] add_temp_4; // sfix44_E12
  wire signed [42:0] sum_6; // sfix43_E12
  wire signed [42:0] add_signext_10; // sfix43_E12
  wire signed [42:0] add_signext_11; // sfix43_E12
  wire signed [43:0] add_temp_5; // sfix44_E12
  wire signed [42:0] sum_7; // sfix43_E12
  ...
  wire signed [42:0] sum_8; // sfix43_E12
  ...
  wire signed [42:0] sum_9; // sfix43_E12
  ...
  wire signed [42:0] sum_10; // sfix43_E12
  ...
  wire signed [42:0] sum_11; // sfix43_E12
  ...
  wire signed [42:0] sum_12; // sfix43_E12
  ...
  assign sum_1 = $signed({{1{add_temp[41]}}, add_temp});

  assign add_signext_2 = sum_1;
  assign add_signext_3 = $signed({{2{product_phase1_3[40]}}, product_phase1_3});
  assign add_temp_1 = add_signext_2 + add_signext_3;
  assign sum_2 = add_temp_1[42:0];

  assign add_signext_4 = sum_2;
  assign add_signext_5 = $signed({{2{product_phase1_4[40]}}, product_phase1_4});
  assign add_temp_2 = add_signext_4 + add_signext_5;
  assign sum_3 = add_temp_2[42:0];

  assign add_signext_6 = sum_3;
  assign add_signext_7 = $signed({{2{product_phase1_5[40]}}, product_phase1_5});
  assign add_temp_3 = add_signext_6 + add_signext_7;
  assign sum_4 = add_temp_3[42:0];

  assign add_signext_8 = sum_4;
  assign add_signext_9 = $signed({{2{product_phase1_6[40]}}, product_phase1_6});
  assign add_temp_4 = add_signext_8 + add_signext_9;
  assign sum_5 = add_temp_4[42:0];

  assign add_signext_10 = sum_5;
  assign add_signext_11 = $signed({{2{product_phase1_7[40]}}, product_phase1_7});
  assign add_temp_5 = add_signext_10 + add_signext_11;
  assign sum_6 = add_temp_5[42:0];

  assign add_signext_12 = sum_6;
  assign add_signext_13 = $signed({{2{product_phase1_8[40]}}, product_phase1_8});
  assign add_temp_6 = add_signext_12 + add_signext_13;
  assign sum_7 = add_temp_6[42:0];

  assign add_signext_14 = sum_7;
  assign add_signext_15 = $signed({{2{product_phase1_9[40]}}, product_phase1_9});
  assign add_temp_7 = add_signext_14 + add_signext_15;
  assign sum_8 = add_temp_7[42:0];

  assign add_signext_16 = sum_8;
  assign add_signext_17 = $signed({{2{product_phase1_10[40]}}, product_phase1_10});
  assign add_temp_8 = add_signext_16 + add_signext_17;
  assign sum_9 = add_temp_8[42:0];

  assign add_signext_18 = sum_9;
  assign add_signext_19 = $signed({{2{product_phase1_11[40]}}, product_phase1_11});
  assign add_temp_9 = add_signext_18 + add_signext_19;
  assign sum_10 = add_temp_9[42:0];

  assign add_signext_20 = sum_10;
  assign add_signext_21 = $signed({{2{product_phase1_12[40]}}, product_phase1_12});
  assign add_temp_10 = add_signext_20 + add_signext_21;
  assign sum_11 = add_temp_10[42:0];

  assign add_signext_22 = sum_11;
  assign add_signext_23 = $signed({{2{product_phase0_7[40]}}, product_phase0_7});
  assign add_temp_11 = add_signext_22 + add_signext_23;
  assign sum_12 = add_temp_11[42:0];
