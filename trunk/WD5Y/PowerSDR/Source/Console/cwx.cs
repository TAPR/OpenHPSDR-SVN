...
//			Debug.WriteLine("push " + data);
	...
	// making a total of 7 elements in a word space
		...
		private void load_alpha()
		{
			...
			if (!File.Exists(Application.StartupPath+"\\"+sfile))	// create default morsedef.txt
			{
#if(CWX_DEBUG)
				MessageBox.Show(sfile+" not found, creating ...");
#endif
				using (StreamWriter sw = new StreamWriter(Application.StartupPath+"\\"+sfile)) 
				{
			...
			using (StreamReader sr = new StreamReader(Application.StartupPath+"\\"+sfile)) 
			{
				String line;
				String t;
				int nl = 0;
...
//			ttdel = 50;
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(CWX));
			...
			// txt1
			// 
			this.txt1.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			// txt2
			// 
			this.txt2.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			// txt3
			// 
			this.txt3.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			// txt4
			// 
			this.txt4.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			// txt5
			// 
			this.txt5.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			// txt6
			// 
			this.txt6.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			this.cbMorse.Font = new System.Drawing.Font("Courier New", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			// udDelay
			// 
			this.udDelay.Increment = new System.Decimal(new int[] {
																	  1,
																	  0,
																	  0,
																	  0});
			this.udDelay.Location = new System.Drawing.Point(312, 8);
			this.udDelay.Maximum = new System.Decimal(new int[] {
																	3600,
																	0,
																	0,
																	0});
			this.udDelay.Minimum = new System.Decimal(new int[] {
																	0,
																	0,
																	0,
																	0});
			...
			this.udDelay.Value = new System.Decimal(new int[] {
																  3,
																  0,
																  0,
																  0});
			...
			// udDrop
			// 
			this.udDrop.Increment = new System.Decimal(new int[] {
																	 1,
																	 0,
																	 0,
																	 0});
			this.udDrop.Location = new System.Drawing.Point(384, 8);
			this.udDrop.Maximum = new System.Decimal(new int[] {
																   5000,
																   0,
																   0,
																   0});
			this.udDrop.Minimum = new System.Decimal(new int[] {
																   0,
																   0,
																   0,
																   0});
			...
			this.udDrop.Value = new System.Decimal(new int[] {
																 500,
																 0,
																 0,
																 0});
			...
			// expandButton
			// 
			this.expandButton.BackColor = System.Drawing.SystemColors.Highlight;
			...
			// udPtt
			// 
			this.udPtt.Increment = new System.Decimal(new int[] {
																	1,
																	0,
																	0,
																	0});
			this.udPtt.Location = new System.Drawing.Point(456, 8);
			this.udPtt.Maximum = new System.Decimal(new int[] {
																  2000,
																  0,
																  0,
																  0});
			this.udPtt.Minimum = new System.Decimal(new int[] {
																  50,
																  0,
																  0,
																  0});
			...
			this.udPtt.Value = new System.Decimal(new int[] {
																500,
																0,
																0,
																0});
			...
			this.udWPM.Increment = new System.Decimal(new int[] {
																	1,
																	0,
																	0,
																	0});
		...
		{
			if (File.Exists(Application.StartupPath+"\\"+sfile)) File.Delete(Application.StartupPath+"\\"+sfile);			// out withe the old
			using (StreamWriter sw = new StreamWriter(Application.StartupPath+"\\"+sfile))	// and in with the new
			{
				for (int i = 0; i < 64; i++)
				{
					sw.WriteLine(a2m2[i]);
