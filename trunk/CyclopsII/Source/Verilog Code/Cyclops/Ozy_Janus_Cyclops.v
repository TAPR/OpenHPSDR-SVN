...
//
// Change log: 
// 26 Aug 2009 - start coding based on Ozy_Janus V1.6
//
//
//
//
...
localparam Ozy_serialno = 8'd16;	// Serial number of this version
...
parameter P2	= 1'b1;		
parameter P1 	= 1'b1;		// prescaler 64/65
parameter PD2	= 1'b0;
parameter CP16 	= 1'b0;
//
parameter CP15 	= 1'b1;
...
//
parameter F2 	= 1'b1;		// Phase Detector = positive
parameter M3 	= 1'b0;
parameter M2 	= 1'b0;
...
parameter Second_LO_INL = {P2,P1,PD2,CP16,CP15,CP14,CP13,CP12,CP11,TC4,TC3,TC2,TC1,F5,F4,F3,F2,M3,M2,M1,PD1,F1,C2,C1}; // 24'hCDC093
// Note:  F2 is 0 for first local oscillator since loop amplifier inverts 
parameter First_LO_INL  = {P2,P1,PD2,CP16,CP15,CP14,CP13,CP12,CP11,TC4,TC3,TC2,TC1,F5,F4,F3,1'b0,M3,M2,M1,PD1,F1,C2,C1};  // 24'hCDC013 
...
parameter [13:0]LO2_R = 14'b00_0000_0000_1010;  // divide by 10
 
parameter Second_LO_RCL = {LO2_DB23,LO2_DLY,LO2_SYNC,LO2_LDP,LO2_T1,LO2_T2,LO2_ABP2,LO2_ABP1,LO2_R,2'b00}; 	//24'h100028;
...
Internal divider range ( N = B*P+A )
        ...
        N = 1126 
If P = 64 and B and A are adjacent registers,
then B concatenated with A can be considered a single binary 19 bit register

where 
B13 B12 B11 | B10 B09 B08 B07 | B06 B05 B04 B03 | B02 B01 A6 A5 | A4 A3 A2 A1

N = 1126 = 19'h00466 = 000 0000 0100 0110 0110
...
parameter [18:0]LO2_BA = 19'b000_0000_0100_0110_0110;  // 1126

parameter Second_LO_NCL = {LO2_DB23, LO2_DB22, LO2_G1, LO2_BA, 2'b01};  // 24'h001199 For fixed frequency of 1126.0 MHz 
...
wire [17:0]PLL_frequency = {2'b00, PLL_freq};
