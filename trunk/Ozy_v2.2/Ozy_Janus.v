...
localparam Ozy_serialno = 8'd22;	// Serial number of this version, v2.1 derived from v2.0, multiple Mercs added
...
begin 
  ...
  Decode_IF_f = (IF_Rx_ctrl_0[7:1] >= 2'd2) && (IF_Rx_ctrl_0[7:1] <= 4'd9) ? 1'b1 : 1'b0;
