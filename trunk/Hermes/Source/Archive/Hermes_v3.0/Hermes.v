...
parameter  Hermes_serialno = 8'd30;		// Serial number of this version
...
Attenuator Attenuator_inst (.clk(IF_clk), .data(attenuator/*atten_data*/), .ATTN_CLK(ATTN_CLK), .ATTN_DATA(ATTN_DATA), .ATTN_LE(ATTN_LE));
