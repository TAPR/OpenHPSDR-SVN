...
extern float *CallbackInRbufp;  // right buffer for samples headerd to powersdr 
extern float *CallbackOutLbufp; // left buffer for samples headed to the audio device 
extern float *CallbackOutRbufp; // right buffer for samples header to the audio device 
