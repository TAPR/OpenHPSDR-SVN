	...
	public class HW
	{
		...
		public bool RFEPresent
		{
			...
			set	
			{
				...
				if(!rfe_present)
				{
					rfe_ic7.UpdateHardware = false;
					rfe_ic9.UpdateHardware = false;
					rfe_ic10.UpdateHardware = false;
					rfe_ic11.UpdateHardware = false;
					pio_ic1.ClearBit(5);
				}
				else if(update_hardware)
				{
					rfe_ic7.UpdateHardware = true;
					rfe_ic9.UpdateHardware = true;
					rfe_ic10.UpdateHardware = true;
					rfe_ic11.UpdateHardware = true;
					pio_ic1.SetBit(5);
				}
			}
		}
