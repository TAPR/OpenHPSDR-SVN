...
#if AllowMetis
//		Temporarily exclude all metis code to allow testing of usb interface
...
void metis_discover(char* eInterface) {
    ...
    if(get_addr(discovery_socket,eInterface)<0) {
        exit(1);
    }
...
#endif		// end if temporary exclusion of all metis code