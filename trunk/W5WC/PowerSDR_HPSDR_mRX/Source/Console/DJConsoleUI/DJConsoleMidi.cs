...
namespace PowerSDR
{
    public partial class DJConsole
    {
        ...
        public void SendSetMessage(FWC.Opcode opcode, uint data1, uint data2)
        {
            ushort id = msgID++;
        ...
        public void SendSetMessage(FWC.Opcode opcode, float data1, uint data2)
        {
            ushort id = msgID++;
            byte[] msg = new byte[37];
            msg[0] = 0xF0; // start byte
        ...
        public void SendSetMessage(FWC.Opcode opcode, uint data1, float data2)
        {
            ushort id = msgID++;
            byte[] msg = new byte[37];
            msg[0] = 0xF0; // start byte
        ...
        public uint SendGetMessage(FWC.Opcode opcode, uint data1, uint data2)
        {
            ushort id = msgID++;
            byte[] msg = new byte[37];
            msg[0] = 0xF0; // start byte
        ...
        public float SendGetMessageFloat(FWC.Opcode opcode, uint data1, uint data2)
        {
            ushort id = msgID++;
            byte[] msg = new byte[37];
            msg[0] = 0xF0; // start byte
