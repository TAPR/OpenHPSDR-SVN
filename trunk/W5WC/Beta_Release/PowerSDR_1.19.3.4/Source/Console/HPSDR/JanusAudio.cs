...
//			}
		...
		{ 
            ...
            string fx2_version_string = null; //= getFX2FirmwareVersionString();
            int merc_ver = 0; // = getMercuryFWVersion();
			int penny_ver = 0; // = getPenelopeFWVersion();
            int ozy_ver = 0; // = getOzyFWVersion();
           ...
           if (c.MercuryPresent)
           {
            ...
            fx2_version_string = getFX2FirmwareVersionString();
        ...
        private static bool InitOzyMic()
        {
            Console c = Console.getConsole();
            bool rc = c.SetMicGain();
            return rc;
        }
