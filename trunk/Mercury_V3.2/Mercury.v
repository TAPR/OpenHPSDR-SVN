...
localparam SERIAL = 8'd32;  // software version serial number - v3.2; multi-Rx-on-a-single-Merc or multiple-Mercs modes implemented
...
assign common_select = ((common_Merc_freq & (fn == 4'b0)) | (!common_Merc_freq & (MULTIPLE_MERC & (fn == Mercury_Addr)))) ? 1'b1 : 1'b0;
...
//      else if (C122_rcv_rdy && (fn == (j+1)))
      else if (C122_rcv_rdy && (common_select  | (!MULTIPLE_MERC & (fn == j+1)))) //...if common-Merc_freq set, all boards update with Merc1      
