...
begin 
  ...
  begin // set up default values - 0 for now
    ...
    IF_merc            <= 3'b001;  // max number of channels to send to PC, 3'b001 => two channels
  ...
  begin 								// Need to ensure that C&C data is stable 
    ...
    begin
      ...
      IF_merc             <= IF_Rx_ctrl_4[5:3]; // decode number of receivers
...
begin
  ...
  multiRx_mode <= #IF_TPD IF_last_chan; //number of receivers requested by the PC
