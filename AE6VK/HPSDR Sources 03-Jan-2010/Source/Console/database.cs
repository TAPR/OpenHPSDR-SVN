...
//					(string)datarow["Mode"] == mode)
		...
		public static void SaveVars(string tableName, ref ArrayList list)
		{
			...
			foreach(string s in list)
			{
				...
				// make sure we don't try to write more to the db table 
				if ( vals[0].Equals("Version") ) 
				{
					if ( vals[1].Length > 120 )  
					{
						vals[1] = vals[1].Substring(0, 120);
						// System.Console.WriteLine("version truncated: >" + vals[1] + "<"); 
					} 
				}
