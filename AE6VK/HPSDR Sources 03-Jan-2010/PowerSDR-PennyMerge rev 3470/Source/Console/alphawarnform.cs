...
namespace PowerSDR
{
	public class AlphaWarnForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.picWarning.Size = new System.Drawing.Size(245, 268);
			this.picWarning.TabIndex = 0;
			this.picWarning.TabStop = false;
			this.picWarning.MouseEnter += new System.EventHandler(this.picWarning_MouseEnter);
			this.picWarning.MouseLeave += new System.EventHandler(this.picWarning_MouseLeave);
			// 
			// rtxtWarning
			// 
			...
			this.chkShowThisOnStartup.Location = new System.Drawing.Point(248, 240);
			...
			this.chkShowThisOnStartup.CheckedChanged += new System.EventHandler(this.chkShowThisOnStartup_CheckedChanged);
			// 
			// btnContinue
			// 
			this.btnContinue.BackColor = System.Drawing.SystemColors.Control;
			this.btnContinue.Location = new System.Drawing.Point(488, 240);
		...
		private void picWarning_MouseEnter(object sender, System.EventArgs e)
		{
			picWarning.Image = new Bitmap(GetResource("PowerSDR.images.warning2.gif"));
		}

		private void picWarning_MouseLeave(object sender, System.EventArgs e)
		{
			picWarning.Image = new Bitmap(GetResource("PowerSDR.images.warning1.gif"));
		}

		private void chkShowThisOnStartup_CheckedChanged(object sender, System.EventArgs e)
		{
			ArrayList a = new ArrayList();
			a.Add("show_alpha_warning/"+chkShowThisOnStartup.Checked.ToString());
