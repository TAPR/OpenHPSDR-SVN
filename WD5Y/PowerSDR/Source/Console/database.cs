...
namespace PowerSDR
{
	class DB
	{
		...
		private static OleDbDataAdapter txProfileDefAdapter;
		...
		private static OleDbCommandBuilder txProfileDefCB;
		...
		public static DataSet dsTxProfileDef;
...
// ======================================================
		...
		private static void VerifyTables()
		{
			...
			if(a.BinarySearch("TxProfileDef") < 0)
			{
				AddTxProfileDefTable(ref cat);
				...
				FillTxProfileDef(ref connection);
			...
			if(a.BinarySearch("FLEX3000MixerForm") < 0)
				AddFormTable(ref cat, "FLEX3000MixerForm");

			if(a.BinarySearch("FLEX5000LLHWForm") < 0)
				AddFormTable(ref cat, "FLEX5000LLHWForm");

			if(a.BinarySearch("FLEX5000DebugForm") < 0)
				AddFormTable(ref cat, "FLEX5000DebugForm");

			if(a.BinarySearch("FLEX5000ProdTestForm") < 0)
				AddFormTable(ref cat, "FLEX5000ProdTestForm");

			if(a.BinarySearch("FLEX5000FinalTestForm") < 0)
				AddFormTable(ref cat, "FLEX5000FinalTestForm");

			if(a.BinarySearch("FLEX5000RX2CalForm") < 0)
				AddFormTable(ref cat, "FLEX5000RX2CalForm");
		...
		private static void AddTxProfileTable(ref Catalog c)
		{
			...
			txProfileTable.Columns.Append("DXOn", DataTypeEnum.adBoolean, 8);
			txProfileTable.Columns.Append("DXLevel", DataTypeEnum.adInteger, 5);
			...
			txProfileTable.Columns.Append("Lev_On", DataTypeEnum.adBoolean, 8);
		...
		private static void AddTxProfileDefTable(ref Catalog c)
		{
			Table txProfileDefTable = new Table();
			txProfileDefTable.Name = "TxProfileDef";
			txProfileDefTable.Columns.Append("Name", DataTypeEnum.adVarWChar, 50);
			txProfileDefTable.Columns.Append("FilterLow", DataTypeEnum.adInteger, 10);
			txProfileDefTable.Columns.Append("FilterHigh", DataTypeEnum.adInteger, 10);
			txProfileDefTable.Columns.Append("TXEQNumBands", DataTypeEnum.adInteger, 5);
			txProfileDefTable.Columns.Append("TXEQEnabled", DataTypeEnum.adBoolean, 8);
			txProfileDefTable.Columns.Append("TXEQPreamp", DataTypeEnum.adInteger, 5);
			txProfileDefTable.Columns.Append("TXEQ1", DataTypeEnum.adInteger, 5);
			txProfileDefTable.Columns.Append("TXEQ2", DataTypeEnum.adInteger, 5);
			txProfileDefTable.Columns.Append("TXEQ3", DataTypeEnum.adInteger, 5);
			txProfileDefTable.Columns.Append("TXEQ4", DataTypeEnum.adInteger, 5);
			txProfileDefTable.Columns.Append("TXEQ5", DataTypeEnum.adInteger, 5);
			txProfileDefTable.Columns.Append("TXEQ6", DataTypeEnum.adInteger, 5);
			txProfileDefTable.Columns.Append("TXEQ7", DataTypeEnum.adInteger, 5);
			txProfileDefTable.Columns.Append("TXEQ8", DataTypeEnum.adInteger, 5);
			txProfileDefTable.Columns.Append("TXEQ9", DataTypeEnum.adInteger, 5);
			txProfileDefTable.Columns.Append("TXEQ10", DataTypeEnum.adInteger, 5);
			txProfileDefTable.Columns.Append("DXOn", DataTypeEnum.adBoolean, 8);
			txProfileDefTable.Columns.Append("DXLevel", DataTypeEnum.adInteger, 5);
			txProfileDefTable.Columns.Append("CompanderOn", DataTypeEnum.adBoolean, 8);
			txProfileDefTable.Columns.Append("CompanderLevel", DataTypeEnum.adInteger, 5);
			txProfileDefTable.Columns.Append("MicGain", DataTypeEnum.adInteger, 5);
			txProfileDefTable.Columns.Append("Lev_On", DataTypeEnum.adBoolean, 8);
			txProfileDefTable.Columns.Append("Lev_Slope", DataTypeEnum.adInteger, 5);
			txProfileDefTable.Columns.Append("Lev_MaxGain", DataTypeEnum.adInteger, 5);
			txProfileDefTable.Columns.Append("Lev_Attack", DataTypeEnum.adInteger, 5);
			txProfileDefTable.Columns.Append("Lev_Decay", DataTypeEnum.adInteger, 5);
			txProfileDefTable.Columns.Append("Lev_Hang", DataTypeEnum.adInteger, 5);
			txProfileDefTable.Columns.Append("Lev_HangThreshold", DataTypeEnum.adInteger, 5);
			txProfileDefTable.Columns.Append("ALC_Slope", DataTypeEnum.adInteger, 5);
			txProfileDefTable.Columns.Append("ALC_MaxGain", DataTypeEnum.adInteger, 5);
			txProfileDefTable.Columns.Append("ALC_Attack", DataTypeEnum.adInteger, 5);
			txProfileDefTable.Columns.Append("ALC_Decay", DataTypeEnum.adInteger, 5);
			txProfileDefTable.Columns.Append("ALC_Hang", DataTypeEnum.adInteger, 5);
			txProfileDefTable.Columns.Append("ALC_HangThreshold", DataTypeEnum.adInteger, 5);
			txProfileDefTable.Columns.Append("Power", DataTypeEnum.adInteger, 5);

			txProfileDefTable.Keys.Append("PrimaryKey", KeyTypeEnum.adKeyPrimary, "Name", null, null);

			c.Tables.Append(txProfileDefTable);
		}
		...
		private static void AddFormTable(ref Catalog c, string name)
		{
			...
			table.Columns.Append("SaveValue", DataTypeEnum.adVarWChar, 120);
			table.Keys.Append("PrimaryKey", KeyTypeEnum.adKeyPrimary, "ID", null, null);
		...
		private static void FillTxProfileDef(ref OleDbConnection conn)
		{
			OleDbDataAdapter myDataAdapter = new OleDbDataAdapter();
			myDataAdapter.SelectCommand = new OleDbCommand("SELECT * FROM TxProfileDef", conn);
			OleDbCommandBuilder cb = new OleDbCommandBuilder(myDataAdapter);
			DataSet ds = new DataSet();
			myDataAdapter.Fill(ds, "TxProfileDef");

			#region Default

			DataRow dr = ds.Tables["TxProfileDef"].NewRow();
			dr["Name"] = "Default";
			dr["FilterLow"] = 200;
			dr["FilterHigh"] = 3100;
			dr["TXEQNumBands"] = 3;
			...
			dr["ALC_HangThreshold"] = 0;
			dr["Power"] = 50;
			ds.Tables["TxProfileDef"].Rows.Add(dr);

			#endregion
			
			#region Default DX

			dr = ds.Tables["TxProfileDef"].NewRow();
			dr["Name"] = "Default DX";
			dr["FilterLow"] = 200;
			dr["FilterHigh"] = 3100;
			dr["TXEQNumBands"] = 3;
			...
			// save the updates
			myDataAdapter.Update(ds, "txProfileDef");	
		}
...
// ======================================================
		...
		public static void Init()
		{
			...
			txProfileDefAdapter = new OleDbDataAdapter();
			txProfileDefAdapter.SelectCommand = new OleDbCommand("SELECT * FROM TxProfileDef", conn);
			txProfileDefCB = new OleDbCommandBuilder(txProfileDefAdapter);
			dsTxProfileDef = new DataSet();
			txProfileDefAdapter.Fill(dsTxProfileDef, "TxProfileDef");
...
*/
		...
		public static void CopyFormTable(string table_name, OleDbConnection c)
		{
			OleDbDataAdapter adapter = new OleDbDataAdapter("SELECT * FROM "+table_name, c);
			DataSet ds = new DataSet();
			adapter.Fill(ds, table_name);

			OleDbDataAdapter old_adapter = new OleDbDataAdapter("SELECT * FROM "+table_name, conn);
			DataSet old_ds = new DataSet();
			old_adapter.Fill(old_ds, table_name);

			OleDbCommandBuilder cmdBuilder = new OleDbCommandBuilder(old_adapter);

			foreach(DataRow dr in ds.Tables[table_name].Rows)
			{
				DataRow[] found = old_ds.Tables[table_name].Select("ID = '"+dr["ID"]+"'");
			
				if(found.Length > 0)
					found[0]["SaveValue"] = dr["SaveValue"];
				else
				{
					DataRow new_dr = old_ds.Tables[table_name].NewRow();
					new_dr["ID"] = dr["ID"];
					new_dr["SaveValue"] = dr["SaveValue"];
					old_ds.Tables[table_name].Rows.Add(new_dr);
				}
			}

			old_adapter.Update(old_ds, table_name);
		}
