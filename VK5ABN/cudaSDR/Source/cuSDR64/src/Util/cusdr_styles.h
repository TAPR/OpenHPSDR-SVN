...
QString displayToolbarStyle = QString::fromUtf8(
		"QToolBar {"
...
QString	dSpinBoxStyle = QString::fromUtf8(
		...
		"	width: 8px; "
		"	height: 8px; } "
		"QDoubleSpinBox::up-arrow:on { "
		"	top: 0px; "
		"	left: 0px; } "
		"QDoubleSpinBox::down-arrow:on { "
		"	top: 0px; "
		"	left: 0px; } "
		"QDoubleSpinBox { "
		"	color: rgba(166, 196, 208, 255); "
