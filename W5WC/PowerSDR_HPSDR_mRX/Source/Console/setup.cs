...
namespace PowerSDR
{
    ...
    public partial class Setup : Form
    {
        ...
        {
            console.radio.GetDSPRX(0, 0).NBThreshold = 0.165 * (double)(udDSPNB2.Value);
            console.radio.GetDSPRX(0, 1).NBThreshold = 0.165 * (double)(udDSPNB2.Value);
            console.radio.GetDSPRX(1, 0).NBThreshold = 0.165 * (double)(udDSPNB2.Value);
            console.radio.GetDSPRX(1, 1).NBThreshold = 0.165 * (double)(udDSPNB2.Value);
        }

        private void udDSPNB2b_ValueChanged(object sender, EventArgs e)
        {
            console.radio.GetDSPRX(0, 0).SDROMThreshold = 0.165 * (double)(udDSPNB2b.Value);
            console.radio.GetDSPRX(0, 1).SDROMThreshold = 0.165 * (double)(udDSPNB2b.Value);
            console.radio.GetDSPRX(1, 0).SDROMThreshold = 0.165 * (double)(udDSPNB2b.Value);
            console.radio.GetDSPRX(1, 1).SDROMThreshold = 0.165 * (double)(udDSPNB2b.Value);
        }
        ...
        private void radOrionPTTOn_CheckedChanged(object sender, EventArgs e)
        {
        }
