...
/*  1 March 2011 - Metis code V1.2 - copyright 2010, 2011 Phil Harman VK6APH 
...
localparam Metis_serialno = 8'd12;	// Serial number of this version
...
SP_fifo  SPF (.aclr(IF_rst || sp_fifo_wrfull), .wrclk (IF_clk), .rdclk(Tx_clock_2), 
