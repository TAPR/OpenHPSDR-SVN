...
module Mercury(clock, ADC,IFCLK, FX2_FD,FIFO_ADR, SLRD, SLWR, SLOE, FLAGA, FLAGC, PKEND, DEBUG_LED0,DEBUG_LED1, DEBUG_LED2, DEBUG_LED3 );
...
/*
	...
	read into the Rx_register. On the next clock it  checks if syncd_write_used is set
	 - if so it sends the data in the Tx FIFO to the FX2. After the Tx data has been sent 
