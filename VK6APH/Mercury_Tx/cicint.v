...
//
// Generated on: 2007-01-13 16:57:23
//
// -------------------------------------------------------------
...
// Name: cicint
// TargetDirectory: c:\HPDSDR\trunk\VK6APH\Mercury_Tx\Matlab-files
// FIRAdderStyle: tree
...
//   Comb Section 2        : s30,0
//   Comb Section 3        : s40,0
//   Comb Section 4        : s50,0
//   Comb Section 5        : s60,0
//
// Implementation Cost
...
module cicint 
  ...
  output  signed [15:0] filter_out; //sfix16_E44
  output  ce_out; 
...
////////////////////////////////////////////////////////////////
  ...
  reg  signed [16:0] cic_pipeline1; // sfix17
  //   -- Section 2 Signals 
  ...
  reg  signed [17:0] cic_pipeline2; // sfix18
  //   -- Section 3 Signals 
  ...
  reg  signed [18:0] cic_pipeline3; // sfix19
  //   -- Section 4 Signals 
  ...
  reg  signed [19:0] cic_pipeline4; // sfix20
  //   -- Section 5 Signals 
  ...
  reg  signed [19:0] cic_pipeline5; // sfix20
  ...
  wire signed [29:0] section_cast7; // sfix30
  wire signed [29:0] sum2; // sfix30
  reg  signed [29:0] section_out7; // sfix30
  wire signed [29:0] add_cast_2; // sfix30
  wire signed [29:0] add_cast_3; // sfix30
  wire signed [30:0] add_temp_1; // sfix31
  //   -- Section 8 Signals 
  wire signed [29:0] section_in8; // sfix30
  wire signed [39:0] section_cast8; // sfix40
  wire signed [39:0] sum3; // sfix40
  reg  signed [39:0] section_out8; // sfix40
  wire signed [39:0] add_cast_4; // sfix40
  wire signed [39:0] add_cast_5; // sfix40
  wire signed [40:0] add_temp_2; // sfix41
  //   -- Section 9 Signals 
  wire signed [39:0] section_in9; // sfix40
  wire signed [49:0] section_cast9; // sfix50
  wire signed [49:0] sum4; // sfix50
  reg  signed [49:0] section_out9; // sfix50
  wire signed [49:0] add_cast_6; // sfix50
  wire signed [49:0] add_cast_7; // sfix50
  wire signed [50:0] add_temp_3; // sfix51
  //   -- Section 10 Signals 
  wire signed [49:0] section_in10; // sfix50
  wire signed [59:0] section_cast10; // sfix60
  wire signed [59:0] sum5; // sfix60
  reg  signed [59:0] section_out10; // sfix60
  wire signed [59:0] add_cast_8; // sfix60
  wire signed [59:0] add_cast_9; // sfix60
  wire signed [60:0] add_temp_4; // sfix61
  wire signed [15:0] output_typeconvert; // sfix16_E44
  //   
  reg  signed [15:0] output_register; // sfix16_E44
  ...
  assign upsampling = (phase_0 == 1'b1) ? cic_pipeline5 : zeroconst;
  ...
  assign section_cast7 = $signed({{10{section_in7[19]}}, section_in7});
  ...
  assign section_cast8 = $signed({{10{section_in8[29]}}, section_in8});
  ...
  assign section_cast9 = $signed({{10{section_in9[39]}}, section_in9});
  ...
  assign output_typeconvert = section_out10[59:44];
