   ...
   0000                     463 	.ds 8
                    ...
                    FC00    663 _EP8FIFOBUF	=	0xfc00
                            ...
                            690 	.area CSEG    (CODE)
                            691 ;------------------------------------------------------------
                            692 ;Allocation info for local variables in function 'fx2_stall_ep0'
                            693 ;------------------------------------------------------------
                            694 ;------------------------------------------------------------
                            695 ;Initial/src/lib/fx2utils.c:31: fx2_stall_ep0 (void)
                            696 ;	-----------------------------------------
                            697 ;	 function fx2_stall_ep0
                            698 ;	-----------------------------------------
   0547                     699 _fx2_stall_ep0:
                    0002    700 	ar2 = 0x02
                    0003    701 	ar3 = 0x03
                    0004    702 	ar4 = 0x04
                    0005    703 	ar5 = 0x05
                    ...
                    0000    706 	ar0 = 0x00
                    0001    707 	ar1 = 0x01
                            708 ;Initial/src/lib/fx2utils.c:33: EP0CS |= bmEPSTALL;
                            709 ;     genAssign
                            710 ;     genOr
                            711 ;	Peephole 248.a	optimized or to xdata
   0547 90 E6 A0            712 	mov	dptr,#_EP0CS
   054A E0                  713 	movx	a,@dptr
   054B FA                  714 	mov	r2,a
   054C 44 01               715 	orl	a,#0x01
   054E F0                  716 	movx	@dptr,a
   054F                     717 00101$:
   054F 22                  718 	ret
                            719 ;------------------------------------------------------------
                            720 ;Allocation info for local variables in function 'fx2_reset_data_toggle'
                            721 ;------------------------------------------------------------
                            722 ;ep                        Allocated to registers r2 
                            723 ;------------------------------------------------------------
                            724 ;Initial/src/lib/fx2utils.c:37: fx2_reset_data_toggle (unsigned char ep)
                            725 ;	-----------------------------------------
                            726 ;	 function fx2_reset_data_toggle
                            727 ;	-----------------------------------------
   0550                     728 _fx2_reset_data_toggle:
                            729 ;     genReceive
   0550 AA 82               730 	mov	r2,dpl
                            731 ;Initial/src/lib/fx2utils.c:39: TOGCTL = ((ep & 0x80) >> 3 | (ep & 0x0f));
                            732 ;     genAnd
   0552 74 80               733 	mov	a,#0x80
   0554 5A                  734 	anl	a,r2
                            735 ;     genRightShift
                            736 ;     genRightShiftLiteral
                            737 ;     genrshOne
                            738 ;	Peephole 105	removed redundant mov
   0555 FB                  739 	mov	r3,a
   0556 C4                  740 	swap	a
   0557 23                  741 	rl	a
   0558 54 1F               742 	anl	a,#0x1f
   055A FB                  743 	mov	r3,a
                            744 ;     genAnd
   055B 74 0F               745 	mov	a,#0x0F
   055D 5A                  746 	anl	a,r2
                            747 ;     genOr
   055E 90 E6 83            748 	mov	dptr,#_TOGCTL
   0561 4B                  749 	orl	a,r3
   0562 F0                  750 	movx	@dptr,a
                            751 ;Initial/src/lib/fx2utils.c:40: TOGCTL |= bmRESETTOGGLE;
                            752 ;     genAssign
                            753 ;     genOr
                            754 ;	Peephole 248.a	optimized or to xdata
   0563 90 E6 83            755 	mov	dptr,#_TOGCTL
   0566 E0                  756 	movx	a,@dptr
   0567 FA                  757 	mov	r2,a
   0568 44 20               758 	orl	a,#0x20
   056A F0                  759 	movx	@dptr,a
   056B                     760 00101$:
   056B 22                  761 	ret
                            762 ;------------------------------------------------------------
                            763 ;Allocation info for local variables in function 'fx2_renumerate'
                            764 ;------------------------------------------------------------
                            765 ;------------------------------------------------------------
                            766 ;Initial/src/lib/fx2utils.c:44: fx2_renumerate (void)
                            767 ;	-----------------------------------------
                            768 ;	 function fx2_renumerate
                            769 ;	-----------------------------------------
   056C                     770 _fx2_renumerate:
                            771 ;Initial/src/lib/fx2utils.c:46: USBCS |= bmDISCON | bmRENUM;
                            772 ;     genAssign
                            773 ;     genOr
                            774 ;	Peephole 248.a	optimized or to xdata
   056C 90 E6 80            775 	mov	dptr,#_USBCS
   056F E0                  776 	movx	a,@dptr
   0570 FA                  777 	mov	r2,a
   0571 44 0A               778 	orl	a,#0x0A
   0573 F0                  779 	movx	@dptr,a
                            780 ;Initial/src/lib/fx2utils.c:48: mdelay (250);
                            781 ;     genCall
                            782 ;	Peephole 182.b	used 16 bit load of dptr
   0574 90 00 FA            783 	mov	dptr,#0x00FA
   0577 12 05 34            784 	lcall	_mdelay
                            785 ;Initial/src/lib/fx2utils.c:50: USBIRQ = 0xff;		// clear any pending USB irqs...
                            786 ;     genAssign
   057A 90 E6 5D            787 	mov	dptr,#_USBIRQ
   057D 74 FF               788 	mov	a,#0xFF
   057F F0                  789 	movx	@dptr,a
                            790 ;Initial/src/lib/fx2utils.c:51: EPIRQ =  0xff;		//   they're from before the renumeration
                            791 ;     genAssign
   0580 90 E6 5F            792 	mov	dptr,#_EPIRQ
   0583 74 FF               793 	mov	a,#0xFF
   0585 F0                  794 	movx	@dptr,a
                            795 ;Initial/src/lib/fx2utils.c:53: EXIF &= ~bmEXIF_USBINT;
                            796 ;     genAnd
   0586 53 91 EF            797 	anl	_EXIF,#0xEF
                            798 ;Initial/src/lib/fx2utils.c:55: USBCS &= ~bmDISCON;		// reconnect USB
                            799 ;     genAssign
                            800 ;     genAnd
                            801 ;	Peephole 248.b	optimized and to xdata
   0589 90 E6 80            802 	mov	dptr,#_USBCS
   058C E0                  803 	movx	a,@dptr
   058D FA                  804 	mov	r2,a
   058E 54 F7               805 	anl	a,#0xF7
   0590 F0                  806 	movx	@dptr,a
   0591                     807 00101$:
   0591 22                  808 	ret
                            809 	.area CSEG    (CODE)
                            810 	.area XINIT   (CODE)
