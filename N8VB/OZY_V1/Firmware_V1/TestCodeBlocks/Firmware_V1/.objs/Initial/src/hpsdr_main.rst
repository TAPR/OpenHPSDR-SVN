   ...
   0000 02 0F 01            706 	ljmp	__sdcc_gsinit_startup
                            707 ;--------------------------------------------------------
                            ...
                            726 ;     genAssign
   0F5A 75 08 01            727 	mov	_isr_tick_count_1_1,#0x01
                            728 	.area GSFINAL (CODE)
   0F63 02 00 03            729 	ljmp	__sdcc_program_startup
                            730 ;--------------------------------------------------------
                            731 ; Home
                            732 ;--------------------------------------------------------
                            733 	.area HOME    (CODE)
   ...
   0028 02 00 88            807 	ljmp	00112$
   002B                     808 00135$:
                            809 ;     genCmpEq
   002B BA 09 03            810 	cjne	r2,#0x09,00136$
   002E 02 00 A8            811 	ljmp	00115$
   0031                     812 00136$:
   0031 02 00 DA            813 	ljmp	00118$
   ...
   0047 12 03 75            845 	lcall	_set_led_0
                            846 ;Initial/src/hpsdr_main.c:75: break;
   004A 02 00 DE            847 	ljmp	00119$
   ...
   0054 12 03 82            859 	lcall	_set_led_1
                            860 ;Initial/src/hpsdr_main.c:79: break;
   0057 02 00 DE            861 	ljmp	00119$
   ...
   0079 F5 0F               911 	mov	_fpga_load_xfer_PARM_2,a
                            912 ;     genCall
   ...
   007E 02 04 3C            920 	ljmp	_fpga_load_xfer
   0081                     921 00109$:
   ...
   0081 02 04 4C            929 	ljmp	_fpga_load_end
   0084                     930 00110$:
   ...
   0088                     938 00112$:
                            ...
                            940 ;     genCall
   0088 12 00 08            941 	lcall	_get_ep0_data
   ...
   008F FA                  947 	mov	r2,a
                            948 ;     genAddrOf
   0090 75 2B 40            949 	mov	_i2c_write_PARM_2,#_EP0BUF
   0093 75 2C E7            950 	mov	(_i2c_write_PARM_2 + 1),#(_EP0BUF >> 8)
                            951 ;     genAssign
   0096 90 E6 8B            952 	mov	dptr,#_EP0BCL
   0099 E0                  953 	movx	a,@dptr
   009A F5 2D               954 	mov	_i2c_write_PARM_3,a
                            955 ;     genCall
   009C 8A 82               956 	mov	dpl,r2
   009E 12 06 69            957 	lcall	_i2c_write
   ...
   00A8                     972 00115$:
                            ...
                            974 ;     genCall
   00A8 12 00 08            975 	lcall	_get_ep0_data
   ...
   00B4 F5 16               986 	mov	_spi_write_PARM_2,a
                            987 ;     genPointerGet
                            988 ;     genFarPointerGet
   00B6 90 E6 BD            989 	mov	dptr,#(_SETUPDAT + 0x0005)
   00B9 E0                  990 	movx	a,@dptr
   00BA F5 17               991 	mov	_spi_write_PARM_3,a
                            992 ;     genPointerGet
                            993 ;     genFarPointerGet
   00BC 90 E6 BC            994 	mov	dptr,#(_SETUPDAT + 0x0004)
   00BF E0                  995 	movx	a,@dptr
   00C0 F5 18               996 	mov	_spi_write_PARM_4,a
                            997 ;     genAddrOf
   00C2 75 19 40            998 	mov	_spi_write_PARM_5,#_EP0BUF
   00C5 75 1A E7            999 	mov	(_spi_write_PARM_5 + 1),#(_EP0BUF >> 8)
                           1000 ;     genAssign
   00C8 90 E6 8B           1001 	mov	dptr,#_EP0BCL
   00CB E0                 1002 	movx	a,@dptr
   00CC F5 1B              1003 	mov	_spi_write_PARM_6,a
                           1004 ;     genCall
   00CE 8A 82              1005 	mov	dpl,r2
   00D0 12 09 80           1006 	lcall	_spi_write
   ...
   00F5 FA                 1069 	mov	r2,a
                           1070 ;     genAddrOf
   00F6 75 2B 40           1071 	mov	_i2c_read_PARM_2,#_EP0BUF
   00F9 75 2C E7           1072 	mov	(_i2c_read_PARM_2 + 1),#(_EP0BUF >> 8)
                           1073 ;     genPointerGet
                           1074 ;     genFarPointerGet
   00FC 90 E6 BE           1075 	mov	dptr,#(_SETUPDAT + 0x0006)
   00FF E0                 1076 	movx	a,@dptr
   0100 F5 2D              1077 	mov	_i2c_read_PARM_3,a
                           1078 ;     genCall
   0102 8A 82              1079 	mov	dpl,r2
   0104 12 05 92           1080 	lcall	_i2c_read
   ...
   016D 02 00 E2           1224 	ljmp	_app_vendor_IN_cmd
   0170                    1225 00105$:
   ...
   0178 02 00 16           1247 	ljmp	_app_vendor_OUT_cmd
   017B                    1248 00102$:
   ...
   017F 30 03 FD           1267 	jnb	__usb_got_SUDAV,00104$
   0182                    1268 00110$:
                           1269 ;Initial/src/hpsdr_main.c:167: usb_handle_setup_packet ();
                           1270 ;     genCall
   0182 12 0E C3           1271 	lcall	_usb_handle_setup_packet
   ...
   0188 C0 E0              1286 	push	acc
                           ...
                           1288 ;     genMinus
                           1289 ;     genMinusDec
   018A 15 08              1290 	dec	_isr_tick_count_1_1
                           1291 ;     genCmpEq
   018C E5 08              1292 	mov	a,_isr_tick_count_1_1
   ...
   0192                    1298 00107$:
                           ...
                           1300 ;     genAssign
   0192 75 08 32           1301 	mov	_isr_tick_count_1_1,#0x32
   ...
   019D                    1326 _patch_usb_descriptors:
                           ...
                           1328 ;     genAddrOf
   019D 75 0A 00           1329 	mov	_eeprom_read_PARM_3,#_patch_usb_descriptors_hw_rev_1_1
   01A0 75 0B 20           1330 	mov	(_eeprom_read_PARM_3 + 1),#(_patch_usb_descriptors_hw_rev_1_1 >> 8)
                           1331 ;     genAssign
   01A3 75 09 05           1332 	mov	_eeprom_read_PARM_2,#0x05
                           1333 ;     genAssign
   01A6 75 0C 01           1334 	mov	_eeprom_read_PARM_4,#0x01
                           1335 ;     genCall
   01A9 75 82 51           1336 	mov	dpl,#0x51
   01AC 12 03 9A           1337 	lcall	_eeprom_read
                           1338 ;Initial/src/hpsdr_main.c:201: usb_desc_hw_rev_binary_patch_location_0[0] = hw_rev;
                           1339 ;     genAssign
   01AF 90 20 00           1340 	mov	dptr,#_patch_usb_descriptors_hw_rev_1_1
   01B2 E0                 1341 	movx	a,@dptr
                           1342 ;     genPointerSet
                           1343 ;     genFarPointerSet
                           1344 ;	Peephole 100	removed redundant mov
   01B3 FA                 1345 	mov	r2,a
   01B4 90 20 16           1346 	mov	dptr,#_usb_desc_hw_rev_binary_patch_location_0
   ...
   01B8 90 20 64           1351 	mov	dptr,#_usb_desc_hw_rev_binary_patch_location_1
   ...
   01C1 90 20 DA           1363 	mov	dptr,#_usb_desc_hw_rev_ascii_patch_location_0
   ...
   01D5 C2 AF              1389 	clr	_EA
                           ...
                           1391 ;     genCall
   01D7 12 01 9D           1392 	lcall	_patch_usb_descriptors
                           1393 ;Initial/src/hpsdr_main.c:218: setup_autovectors ();
                           1394 ;     genCall
   01DA 12 08 15           1395 	lcall	_setup_autovectors
                           1396 ;Initial/src/hpsdr_main.c:219: usb_install_handlers ();
                           1397 ;     genCall
   01DD 12 0B 95           1398 	lcall	_usb_install_handlers
                           1399 ;Initial/src/hpsdr_main.c:220: hook_timer_tick ((unsigned short) isr_tick);
                           1400 ;     genCast
   01E0 7A 88              1401 	mov	r2,#_isr_tick
   01E2 7B 01              1402 	mov	r3,#(_isr_tick >> 8)
                           1403 ;     genCall
   01E4 8A 82              1404 	mov	dpl,r2
   01E6 8B 83              1405 	mov	dph,r3
   01E8 12 0A B4           1406 	lcall	_hook_timer_tick
