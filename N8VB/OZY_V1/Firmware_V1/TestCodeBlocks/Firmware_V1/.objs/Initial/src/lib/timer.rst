   ...
   0000                     461 	.ds 8
                    ...
                    FC00    661 _EP8FIFOBUF	=	0xfc00
                            ...
                            688 	.area CSEG    (CODE)
                            689 ;------------------------------------------------------------
                            690 ;Allocation info for local variables in function 'hook_timer_tick'
                            691 ;------------------------------------------------------------
                            692 ;isr_tick_handler          Allocated to registers r2 r3 
                            693 ;------------------------------------------------------------
                            694 ;Initial/src/lib/timer.c:42: hook_timer_tick (unsigned short isr_tick_handler)
                            695 ;	-----------------------------------------
                            696 ;	 function hook_timer_tick
                            697 ;	-----------------------------------------
   0AB4                     698 _hook_timer_tick:
                    0002    699 	ar2 = 0x02
                    0003    700 	ar3 = 0x03
                    0004    701 	ar4 = 0x04
                    0005    702 	ar5 = 0x05
                    ...
                    0001    706 	ar1 = 0x01
                            707 ;     genReceive
   0AB4 AA 82               708 	mov	r2,dpl
   0AB6 AB 83               709 	mov	r3,dph
                            710 ;Initial/src/lib/timer.c:44: ET2 = 0;			// disable timer 2 interrupts
                            711 ;     genAssign
   0AB8 C2 AD               712 	clr	_ET2
                            713 ;Initial/src/lib/timer.c:45: hook_sv (SV_TIMER_2, isr_tick_handler);
                            714 ;     genAssign
   0ABA 8A 2B               715 	mov	_hook_sv_PARM_2,r2
   0ABC 8B 2C               716 	mov	(_hook_sv_PARM_2 + 1),r3
                            717 ;     genCall
   0ABE 75 82 2B            718 	mov	dpl,#0x2B
   0AC1 12 06 F8            719 	lcall	_hook_sv
                            720 ;Initial/src/lib/timer.c:47: RCAP2H = RELOAD_VALUE >> 8;	// setup the auto reload value
                            721 ;     genAssign
   0AC4 75 CB 63            722 	mov	_RCAP2H,#0x63
                            723 ;Initial/src/lib/timer.c:48: RCAP2L = RELOAD_VALUE;
                            724 ;     genAssign
   0AC7 75 CA C0            725 	mov	_RCAP2L,#0xC0
                            726 ;Initial/src/lib/timer.c:50: T2CON = 0x04;			// interrupt on overflow; reload; run
                            727 ;     genAssign
   0ACA 75 C8 04            728 	mov	_T2CON,#0x04
                            729 ;Initial/src/lib/timer.c:51: ET2 = 1;			// enable timer 2 interrupts
                            730 ;     genAssign
   0ACD D2 AD               731 	setb	_ET2
   0ACF                     732 00101$:
   0ACF 22                  733 	ret
                            734 	.area CSEG    (CODE)
                            735 	.area XINIT   (CODE)
