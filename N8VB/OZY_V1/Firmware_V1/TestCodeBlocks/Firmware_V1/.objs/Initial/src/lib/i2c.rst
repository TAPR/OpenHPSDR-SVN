   ...
   05AC EA                  764 	mov	a,r2
   05AD 2A                  765 	add	a,r2
   05AE FA                  766 	mov	r2,a
                            767 ;     genOr
   05AF 90 E6 79            768 	mov	dptr,#_I2DAT
   05B2 74 01               769 	mov	a,#0x01
   05B4 4A                  770 	orl	a,r2
   05B5 F0                  771 	movx	@dptr,a
                            772 ;Initial/src/lib/i2c.c:49: while ((I2CS & bmDONE) == 0)
   05B6                     773 00106$:
                            774 ;     genAssign
   05B6 90 E6 78            775 	mov	dptr,#_I2CS
   05B9 E0                  776 	movx	a,@dptr
   05BA FA                  777 	mov	r2,a
                            778 ;     genAnd
   05BB 53 02 01            779 	anl	ar2,#0x01
                            780 ;     genCmpEq
   05BE BA 00 02            781 	cjne	r2,#0x00,00151$
                            782 ;	Peephole 112.b	changed ljmp to sjmp
   05C1 80 F3               783 	sjmp	00106$
   05C3                     784 00151$:
                            785 ;Initial/src/lib/i2c.c:52: if ((I2CS & bmBERR) || (I2CS & bmACK) == 0)	// no device answered...
                            786 ;     genAssign
   05C3 90 E6 78            787 	mov	dptr,#_I2CS
   05C6 E0                  788 	movx	a,@dptr
                            789 ;     genAnd
                            790 ;	Peephole 105	removed redundant mov
   05C7 FA                  791 	mov	r2,a
                            792 ;     genIfxJump
   05C8 30 E2 03            793 	jnb	acc.2,00152$
   05CB 02 06 5D            794 	ljmp	00129$
   05CE                     795 00152$:
                            796 ;     genAssign
   05CE 90 E6 78            797 	mov	dptr,#_I2CS
   05D1 E0                  798 	movx	a,@dptr
   05D2 FA                  799 	mov	r2,a
                            800 ;     genAnd
   05D3 53 02 02            801 	anl	ar2,#0x02
                            802 ;     genCmpEq
   05D6 BA 00 03            803 	cjne	r2,#0x00,00153$
   05D9 02 06 5D            804 	ljmp	00129$
   05DC                     805 00153$:
                            806 ;Initial/src/lib/i2c.c:55: if (len == 1)
                            807 ;     genCmpEq
   05DC E5 2D               808 	mov	a,_i2c_read_PARM_3
                            809 ;	Peephole 112.b	changed ljmp to sjmp
                            810 ;	Peephole 199	optimized misc jump sequence
   05DE B4 01 08            811 	cjne	a,#0x01,00113$
                            812 ;00154$:
   ...
   05E1 90 E6 78            819 	mov	dptr,#_I2CS
   05E4 E0                  820 	movx	a,@dptr
   05E5 FA                  821 	mov	r2,a
   05E6 44 20               822 	orl	a,#0x20
   05E8 F0                  823 	movx	@dptr,a
   05E9                     824 00113$:
                            825 ;Initial/src/lib/i2c.c:58: junk = I2DAT;			// trigger the first read cycle
                            826 ;     genAssign
   05E9 90 E6 79            827 	mov	dptr,#_I2DAT
   05EC E0                  828 	movx	a,@dptr
   05ED F5 2E               829 	mov	_i2c_read_junk_1_1,a
                            830 ;Initial/src/lib/i2c.c:60: while (--len != 0){
                            831 ;     genAssign
   05EF AA 2B               832 	mov	r2,_i2c_read_PARM_2
   05F1 AB 2C               833 	mov	r3,(_i2c_read_PARM_2 + 1)
                            834 ;     genAssign
   05F3 AC 2D               835 	mov	r4,_i2c_read_PARM_3
   05F5                     836 00121$:
                            837 ;     genMinus
                            838 ;     genMinusDec
                            839 ;     genCmpEq
                            840 ;	Peephole 257	optimized decrement with compare
   05F5 DC 02               841 	djnz	r4,00156$
                            842 ;	Peephole 112.b	changed ljmp to sjmp
   05F7 80 35               843 	sjmp	00124$
   05F9                     844 00156$:
                            845 ;Initial/src/lib/i2c.c:61: while ((I2CS & bmDONE) == 0)
   05F9                     846 00114$:
                            847 ;     genAssign
   05F9 90 E6 78            848 	mov	dptr,#_I2CS
   05FC E0                  849 	movx	a,@dptr
   05FD FD                  850 	mov	r5,a
                            851 ;     genAnd
   05FE 53 05 01            852 	anl	ar5,#0x01
                            853 ;     genCmpEq
   0601 BD 00 02            854 	cjne	r5,#0x00,00157$
                            855 ;	Peephole 112.b	changed ljmp to sjmp
   0604 80 F3               856 	sjmp	00114$
   0606                     857 00157$:
                            858 ;Initial/src/lib/i2c.c:64: if (I2CS & bmBERR)
                            859 ;     genAssign
   0606 90 E6 78            860 	mov	dptr,#_I2CS
   0609 E0                  861 	movx	a,@dptr
                            862 ;     genAnd
                            863 ;	Peephole 105	removed redundant mov
   060A FD                  864 	mov	r5,a
                            865 ;     genIfxJump
                            866 ;	Peephole 112.a	removed ljmp by inverse jump logic
   060B 20 E2 4F            867 	jb	acc.2,00129$
   060E                     868 00158$:
   ...
   060E BC 01 08            873 	cjne	r4,#0x01,00120$
                            874 ;00159$:
   ...
   0611 90 E6 78            881 	mov	dptr,#_I2CS
   0614 E0                  882 	movx	a,@dptr
   0615 FD                  883 	mov	r5,a
   0616 44 20               884 	orl	a,#0x20
   0618 F0                  885 	movx	@dptr,a
   0619                     886 00120$:
                            887 ;Initial/src/lib/i2c.c:70: *buf++ = I2DAT;		// get data, trigger another read
                            888 ;     genAssign
   0619 90 E6 79            889 	mov	dptr,#_I2DAT
   061C E0                  890 	movx	a,@dptr
                            891 ;     genPointerSet
                            892 ;     genFarPointerSet
                            893 ;	Peephole 136	removed redundant moves
   061D FD                  894 	mov	r5,a
   061E 8A 82               895 	mov	dpl,r2
   0620 8B 83               896 	mov	dph,r3
   0622 F0                  897 	movx	@dptr,a
   0623 A3                  898 	inc	dptr
   0624 AA 82               899 	mov	r2,dpl
   0626 AB 83               900 	mov	r3,dph
                            901 ;     genAssign
   0628 8A 2B               902 	mov	_i2c_read_PARM_2,r2
   062A 8B 2C               903 	mov	(_i2c_read_PARM_2 + 1),r3
                            904 ;Initial/src/lib/i2c.c:75: while ((I2CS & bmDONE) == 0)
                            905 ;	Peephole 112.b	changed ljmp to sjmp
   062C 80 C7               906 	sjmp	00121$
   062E                     907 00124$:
                            908 ;     genAssign
   062E 90 E6 78            909 	mov	dptr,#_I2CS
   0631 E0                  910 	movx	a,@dptr
   0632 FA                  911 	mov	r2,a
                            912 ;     genAnd
   0633 53 02 01            913 	anl	ar2,#0x01
                            914 ;     genCmpEq
   0636 BA 00 02            915 	cjne	r2,#0x00,00161$
                            916 ;	Peephole 112.b	changed ljmp to sjmp
   0639 80 F3               917 	sjmp	00124$
   063B                     918 00161$:
                            919 ;Initial/src/lib/i2c.c:78: if (I2CS & bmBERR)
                            920 ;     genAssign
   063B 90 E6 78            921 	mov	dptr,#_I2CS
   063E E0                  922 	movx	a,@dptr
                            923 ;     genAnd
                            924 ;	Peephole 105	removed redundant mov
   063F FA                  925 	mov	r2,a
                            926 ;     genIfxJump
                            927 ;	Peephole 112.a	removed ljmp by inverse jump logic
   0640 20 E2 1A            928 	jb	acc.2,00129$
   0643                     929 00162$:
                            930 ;Initial/src/lib/i2c.c:81: I2CS |= bmSTOP;
                            931 ;     genAssign
                            932 ;     genOr
                            933 ;	Peephole 248.a	optimized or to xdata
   0643 90 E6 78            934 	mov	dptr,#_I2CS
   0646 E0                  935 	movx	a,@dptr
   0647 FA                  936 	mov	r2,a
   0648 44 40               937 	orl	a,#0x40
   064A F0                  938 	movx	@dptr,a
                            939 ;Initial/src/lib/i2c.c:82: *buf = I2DAT;
                            940 ;     genAssign
   064B AA 2B               941 	mov	r2,_i2c_read_PARM_2
   064D AB 2C               942 	mov	r3,(_i2c_read_PARM_2 + 1)
                            943 ;     genAssign
   064F 90 E6 79            944 	mov	dptr,#_I2DAT
   0652 E0                  945 	movx	a,@dptr
                            946 ;     genPointerSet
                            947 ;     genFarPointerSet
                            948 ;	Peephole 136	removed redundant moves
   0653 FC                  949 	mov	r4,a
   0654 8A 82               950 	mov	dpl,r2
   0656 8B 83               951 	mov	dph,r3
   0658 F0                  952 	movx	@dptr,a
                            953 ;Initial/src/lib/i2c.c:84: return 1;
                            954 ;     genRet
   0659 75 82 01            955 	mov	dpl,#0x01
   ...
   065D 90 E6 78            965 	mov	dptr,#_I2CS
   0660 E0                  966 	movx	a,@dptr
   0661 FA                  967 	mov	r2,a
   0662 44 40               968 	orl	a,#0x40
   0664 F0                  969 	movx	@dptr,a
                            970 ;Initial/src/lib/i2c.c:88: return 0;
                            971 ;     genRet
   0665 75 82 00            972 	mov	dpl,#0x00
   0668                     973 00130$:
   0668 22                  974 	ret
                            975 ;------------------------------------------------------------
   ...
   0669                     986 _i2c_write:
                            987 ;     genReceive
   0669 AA 82               988 	mov	r2,dpl
                            989 ;Initial/src/lib/i2c.c:97: while (I2CS & bmSTOP)		// wait for stop to clear
   066B                     990 00101$:
                            991 ;     genAssign
   066B 90 E6 78            992 	mov	dptr,#_I2CS
   066E E0                  993 	movx	a,@dptr
                            994 ;     genAnd
                            995 ;	Peephole 105	removed redundant mov
   066F FB                  996 	mov	r3,a
                            997 ;     genIfxJump
                            998 ;	Peephole 112.a	removed ljmp by inverse jump logic
   0670 20 E6 F8            999 	jb	acc.6,00101$
   0673                    1000 00133$:
                           1001 ;Initial/src/lib/i2c.c:100: I2CS = bmSTART;
                           1002 ;     genAssign
   0673 90 E6 78           1003 	mov	dptr,#_I2CS
   0676 74 80              1004 	mov	a,#0x80
   0678 F0                 1005 	movx	@dptr,a
   ...
   0679 EA                 1011 	mov	a,r2
   067A 2A                 1012 	add	a,r2
                           1013 ;     genAssign
                           1014 ;	Peephole 100	removed redundant mov
   067B FA                 1015 	mov	r2,a
   067C 90 E6 79           1016 	mov	dptr,#_I2DAT
   067F F0                 1017 	movx	@dptr,a
                           1018 ;Initial/src/lib/i2c.c:103: while ((I2CS & bmDONE) == 0)
   0680                    1019 00104$:
                           1020 ;     genAssign
   0680 90 E6 78           1021 	mov	dptr,#_I2CS
   0683 E0                 1022 	movx	a,@dptr
   0684 FA                 1023 	mov	r2,a
                           1024 ;     genAnd
   0685 53 02 01           1025 	anl	ar2,#0x01
                           1026 ;     genCmpEq
   0688 BA 00 02           1027 	cjne	r2,#0x00,00134$
                           1028 ;	Peephole 112.b	changed ljmp to sjmp
   068B 80 F3              1029 	sjmp	00104$
   068D                    1030 00134$:
                           1031 ;Initial/src/lib/i2c.c:106: if ((I2CS & bmBERR) || (I2CS & bmACK) == 0)	// no device answered...
                           1032 ;     genAssign
   068D 90 E6 78           1033 	mov	dptr,#_I2CS
   0690 E0                 1034 	movx	a,@dptr
                           1035 ;     genAnd
                           1036 ;	Peephole 105	removed redundant mov
   0691 FA                 1037 	mov	r2,a
                           1038 ;     genIfxJump
                           1039 ;	Peephole 112.a	removed ljmp by inverse jump logic
   0692 20 E2 57           1040 	jb	acc.2,00119$
   0695                    1041 00135$:
                           1042 ;     genAssign
   0695 90 E6 78           1043 	mov	dptr,#_I2CS
   0698 E0                 1044 	movx	a,@dptr
   0699 FA                 1045 	mov	r2,a
                           1046 ;     genAnd
   069A 53 02 02           1047 	anl	ar2,#0x02
                           1048 ;     genCmpEq
   069D BA 00 02           1049 	cjne	r2,#0x00,00136$
                           1050 ;	Peephole 112.b	changed ljmp to sjmp
   06A0 80 4A              1051 	sjmp	00119$
   06A2                    1052 00136$:
                           1053 ;Initial/src/lib/i2c.c:109: while (len > 0){
                           1054 ;     genAssign
   06A2 AA 2B              1055 	mov	r2,_i2c_write_PARM_2
   06A4 AB 2C              1056 	mov	r3,(_i2c_write_PARM_2 + 1)
                           1057 ;     genAssign
   06A6 AC 2D              1058 	mov	r4,_i2c_write_PARM_3
   06A8                    1059 00116$:
                           1060 ;     genCmpGt
                           1061 ;     genCmp
                           1062 ;     genIfxJump
   ...
   06A8 EC                 1065 	mov	a,r4
   06A9 24 FF              1066 	add	a,#0xff - 0x00
   06AB 50 33              1067 	jnc	00118$
   06AD                    1068 00137$:
                           1069 ;Initial/src/lib/i2c.c:110: I2DAT = *buf++;
                           1070 ;     genPointerGet
                           1071 ;     genFarPointerGet
   06AD 8A 82              1072 	mov	dpl,r2
   06AF 8B 83              1073 	mov	dph,r3
   06B1 E0                 1074 	movx	a,@dptr
   06B2 FD                 1075 	mov	r5,a
   06B3 A3                 1076 	inc	dptr
   06B4 AA 82              1077 	mov	r2,dpl
   06B6 AB 83              1078 	mov	r3,dph
                           1079 ;     genAssign
   06B8 90 E6 79           1080 	mov	dptr,#_I2DAT
   06BB ED                 1081 	mov	a,r5
   06BC F0                 1082 	movx	@dptr,a
   ...
   06BE                    1088 00110$:
                           1089 ;     genAssign
   06BE 90 E6 78           1090 	mov	dptr,#_I2CS
   06C1 E0                 1091 	movx	a,@dptr
   06C2 FD                 1092 	mov	r5,a
                           1093 ;     genAnd
   06C3 53 05 01           1094 	anl	ar5,#0x01
                           1095 ;     genCmpEq
   06C6 BD 00 02           1096 	cjne	r5,#0x00,00138$
                           1097 ;	Peephole 112.b	changed ljmp to sjmp
   06C9 80 F3              1098 	sjmp	00110$
   06CB                    1099 00138$:
                           1100 ;Initial/src/lib/i2c.c:116: if ((I2CS & bmBERR) || (I2CS & bmACK) == 0)	// no device answered...
                           1101 ;     genAssign
   06CB 90 E6 78           1102 	mov	dptr,#_I2CS
   06CE E0                 1103 	movx	a,@dptr
                           1104 ;     genAnd
                           1105 ;	Peephole 105	removed redundant mov
   06CF FD                 1106 	mov	r5,a
                           1107 ;     genIfxJump
                           1108 ;	Peephole 112.a	removed ljmp by inverse jump logic
   06D0 20 E2 19           1109 	jb	acc.2,00119$
   06D3                    1110 00139$:
                           1111 ;     genAssign
   06D3 90 E6 78           1112 	mov	dptr,#_I2CS
   06D6 E0                 1113 	movx	a,@dptr
   06D7 FD                 1114 	mov	r5,a
                           1115 ;     genAnd
   06D8 53 05 02           1116 	anl	ar5,#0x02
                           1117 ;     genCmpEq
                           1118 ;	Peephole 112.b	changed ljmp to sjmp
                           1119 ;	Peephole 199	optimized misc jump sequence
   06DB BD 00 CA           1120 	cjne	r5,#0x00,00116$
                           1121 ;00140$:
                           1122 ;	Peephole 200	removed redundant sjmp
   06DE                    1123 00141$:
                           1124 ;Initial/src/lib/i2c.c:117: goto fail;
                           1125 ;	Peephole 112.b	changed ljmp to sjmp
   06DE 80 0C              1126 	sjmp	00119$
   06E0                    1127 00118$:
                           1128 ;Initial/src/lib/i2c.c:120: I2CS |= bmSTOP;
                           1129 ;     genAssign
                           1130 ;     genOr
                           1131 ;	Peephole 248.a	optimized or to xdata
   06E0 90 E6 78           1132 	mov	dptr,#_I2CS
   06E3 E0                 1133 	movx	a,@dptr
   06E4 FA                 1134 	mov	r2,a
   06E5 44 40              1135 	orl	a,#0x40
   06E7 F0                 1136 	movx	@dptr,a
                           1137 ;Initial/src/lib/i2c.c:121: return 1;
                           1138 ;     genRet
   06E8 75 82 01           1139 	mov	dpl,#0x01
   ...
   06EC 90 E6 78           1149 	mov	dptr,#_I2CS
   06EF E0                 1150 	movx	a,@dptr
   06F0 FA                 1151 	mov	r2,a
   06F1 44 40              1152 	orl	a,#0x40
   06F3 F0                 1153 	movx	@dptr,a
                           1154 ;Initial/src/lib/i2c.c:125: return 0;
                           1155 ;     genRet
   06F4 75 82 00           1156 	mov	dpl,#0x00
   06F7                    1157 00120$:
   06F7 22                 1158 	ret
                           1159 	.area CSEG    (CODE)
