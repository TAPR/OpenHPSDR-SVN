                              ...
                              4 ; This file generated Tue Jul 25 10:05:48 2006
                              5 ;--------------------------------------------------------
                              6 	.module spi
   ...
   09FC                     767 _init_spi:
                            ...
                            769 ;     genCall
   09FC 75 82 00            770 	mov	dpl,#0x00
   09FF 12 09 FB            771 	lcall	_setup_enables
                            772 ;Initial/src/lib/spi.c:54: bitS_OUT = 0;			/* idle state has CLK = 0 */
                            773 ;     genAssign
   0A02 C2 81               774 	clr	_bitS_OUT
   0A04                     775 00101$:
   0A04 22                  776 	ret
                            777 ;------------------------------------------------------------
   ...
   0A14                     813 00104$:
                            ...
                            815 ;     genAnd
   0A14 EA                  816 	mov	a,r2
                            817 ;     genIfxJump
                            818 ;	Peephole 111	removed ljmp by inverse jump logic
   0A15 30 E2 01            819 	jnb	acc.2,00106$
   0A18                     820 00129$:
                            821 ;     genPlus
                            822 ;     genPlusIncr
   0A18 0B                  823 	inc	r3
   0A19                     824 00106$:
                            ...
                            826 ;     genAnd
   0A19 EA                  827 	mov	a,r2
                            828 ;     genIfxJump
                            829 ;	Peephole 111	removed ljmp by inverse jump logic
   0A1A 30 E3 01            830 	jnb	acc.3,00108$
   0A1D                     831 00130$:
                            832 ;     genPlus
                            833 ;     genPlusIncr
   0A1D 0B                  834 	inc	r3
   0A1E                     835 00108$:
                            ...
                            837 ;     genAnd
   0A1E EA                  838 	mov	a,r2
                            839 ;     genIfxJump
                            840 ;	Peephole 111	removed ljmp by inverse jump logic
   0A1F 30 E4 01            841 	jnb	acc.4,00110$
   0A22                     842 00131$:
                            843 ;     genPlus
                            844 ;     genPlusIncr
   0A22 0B                  845 	inc	r3
   0A23                     846 00110$:
                            ...
                            848 ;     genAnd
   0A23 EA                  849 	mov	a,r2
                            850 ;     genIfxJump
                            851 ;	Peephole 111	removed ljmp by inverse jump logic
   0A24 30 E5 01            852 	jnb	acc.5,00112$
   0A27                     853 00132$:
                            854 ;     genPlus
                            855 ;     genPlusIncr
   0A27 0B                  856 	inc	r3
   0A28                     857 00112$:
                            ...
                            859 ;     genAnd
   0A28 EA                  860 	mov	a,r2
                            861 ;     genIfxJump
                            862 ;	Peephole 111	removed ljmp by inverse jump logic
   0A29 30 E6 01            863 	jnb	acc.6,00114$
   0A2C                     864 00133$:
                            865 ;     genPlus
                            866 ;     genPlusIncr
   0A2C 0B                  867 	inc	r3
   0A2D                     868 00114$:
                            ...
                            870 ;     genAnd
   0A2D EA                  871 	mov	a,r2
                            872 ;     genIfxJump
                            873 ;	Peephole 111	removed ljmp by inverse jump logic
   0A2E 30 E7 01            874 	jnb	acc.7,00116$
   0A31                     875 00134$:
                            876 ;     genPlus
                            877 ;     genPlusIncr
   0A31 0B                  878 	inc	r3
   ...
   0A35                     899 _spi_read:
                            900 ;     genReceive
   0A35 AA 82               901 	mov	r2,dpl
                            902 ;Initial/src/lib/spi.c:116: if (count_bits8 (enables) > 1)
                            903 ;     genCall
   0A37 85 11 82            904 	mov	dpl,_spi_read_PARM_3
   0A3A C0 02               905 	push	ar2
   0A3C 12 0A 05            906 	lcall	_count_bits8
   0A3F AB 82               907 	mov	r3,dpl
   0A41 D0 02               908 	pop	ar2
                            909 ;     genCmpGt
                            910 ;     genCmp
                            911 ;     genIfxJump
                            912 ;	Peephole 108	removed ljmp by inverse jump logic
                            913 ;	Peephole 132.b	optimized genCmpGt by inverse logic (acc differs)
   0A43 EB                  914 	mov	a,r3
   0A44 24 FE               915 	add	a,#0xff - 0x01
   0A46 50 04               916 	jnc	00102$
   0A48                     917 00121$:
                            918 ;Initial/src/lib/spi.c:117: return 0;		// error, too many enables set
                            919 ;     genRet
   0A48 75 82 00            920 	mov	dpl,#0x00
   ...
   0A4C                     924 00102$:
                            ...
                            926 ;     genCall
   0A4C 85 11 82            927 	mov	dpl,_spi_read_PARM_3
   0A4F C0 02               928 	push	ar2
   0A51 12 09 FB            929 	lcall	_setup_enables
   0A54 D0 02               930 	pop	ar2
                            931 ;Initial/src/lib/spi.c:121: if (format & SPI_FMT_LSB){		// order: LSB
                            932 ;     genAnd
   0A56 E5 12               933 	mov	a,_spi_read_PARM_4
                            934 ;     genIfxJump
                            935 ;	Peephole 111	removed ljmp by inverse jump logic
   0A58 30 E7 04            936 	jnb	acc.7,00111$
   0A5B                     937 00122$:
                            938 ;Initial/src/lib/spi.c:123: return 0;		// error, not implemented
                            939 ;     genRet
   0A5B 75 82 00            940 	mov	dpl,#0x00
   ...
   0A5F                     944 00111$:
                            ...
                            946 ;     genAnd
   0A5F 74 60               947 	mov	a,#0x60
   0A61 55 12               948 	anl	a,_spi_read_PARM_4
                            949 ;     genCmpEq
                            950 ;	Peephole 112.b	changed ljmp to sjmp
                            951 ;	Peephole 115.b	jump optimization
   0A63 FB                  952 	mov	r3,a
   0A64 60 23               953 	jz	00107$
   0A66                     954 00123$:
                            955 ;     genCmpEq
   0A66 BB 20 02            956 	cjne	r3,#0x20,00124$
                            957 ;	Peephole 112.b	changed ljmp to sjmp
   0A69 80 05               958 	sjmp	00104$
   0A6B                     959 00124$:
                            960 ;     genCmpEq
   ...
   0A6B BB 40 17            965 	cjne	r3,#0x40,00106$
   0A6E 80 08               966 	sjmp	00105$
                            967 ;00125$:
   0A70                     968 00104$:
                            969 ;Initial/src/lib/spi.c:149: write_byte_msb (header_lo);
                            970 ;     genCall
   0A70 85 10 82            971 	mov	dpl,_spi_read_PARM_2
   0A73 12 0A FC            972 	lcall	_write_byte_msb
   ...
   0A89                     998 00107$:
                           ...
                           1000 ;     genCmpEq
   0A89 E5 15              1001 	mov	a,_spi_read_PARM_6
                           1002 ;	Peephole 110	removed ljmp by inverse jump logic
   0A8B 60 0C              1003 	jz	00112$
   0A8D                    1004 00126$:
                           1005 ;Initial/src/lib/spi.c:159: read_bytes_msb (buf, len);
                           1006 ;     genAssign
   0A8D 85 15 1D           1007 	mov	_read_bytes_msb_PARM_2,_spi_read_PARM_6
                           1008 ;     genCall
   0A90 85 13 82           1009 	mov	dpl,_spi_read_PARM_5
   0A93 85 14 83           1010 	mov	dph,(_spi_read_PARM_5 + 1)
   0A96 12 0B B7           1011 	lcall	_read_bytes_msb
   0A99                    1012 00112$:
                           1013 ;Initial/src/lib/spi.c:162: disable_all ();
                           1014 ;     genCall
   0A99 75 82 00           1015 	mov	dpl,#0x00
   0A9C 12 09 FB           1016 	lcall	_setup_enables
                           1017 ;Initial/src/lib/spi.c:163: return 1;		// success
                           1018 ;     genRet
   0A9F 75 82 01           1019 	mov	dpl,#0x01
   0AA2                    1020 00113$:
   0AA2 22                 1021 	ret
                           1022 ;------------------------------------------------------------
                           ...
                           1035 ;	-----------------------------------------
   0AA3                    1036 _spi_write:
                           1037 ;     genReceive
   0AA3 AA 82              1038 	mov	r2,dpl
                           1039 ;Initial/src/lib/spi.c:173: setup_enables (enables);
                           1040 ;     genCall
   0AA5 85 17 82           1041 	mov	dpl,_spi_write_PARM_3
   0AA8 C0 02              1042 	push	ar2
   0AAA 12 09 FB           1043 	lcall	_setup_enables
   0AAD D0 02              1044 	pop	ar2
                           1045 ;Initial/src/lib/spi.c:175: if (format & SPI_FMT_LSB){		// order: LSB
                           1046 ;     genAnd
   0AAF E5 18              1047 	mov	a,_spi_write_PARM_4
                           1048 ;     genIfxJump
                           1049 ;	Peephole 111	removed ljmp by inverse jump logic
   0AB1 30 E7 04           1050 	jnb	acc.7,00109$
   0AB4                    1051 00118$:
                           1052 ;Initial/src/lib/spi.c:177: return 0;		// error, not implemented
                           1053 ;     genRet
   0AB4 75 82 00           1054 	mov	dpl,#0x00
   ...
   0AB8                    1058 00109$:
                           ...
                           1060 ;     genAnd
   0AB8 74 60              1061 	mov	a,#0x60
   0ABA 55 18              1062 	anl	a,_spi_write_PARM_4
                           1063 ;     genCmpEq
                           1064 ;	Peephole 112.b	changed ljmp to sjmp
                           1065 ;	Peephole 115.b	jump optimization
   0ABC FB                 1066 	mov	r3,a
   0ABD 60 23              1067 	jz	00105$
   0ABF                    1068 00119$:
                           1069 ;     genCmpEq
   0ABF BB 20 02           1070 	cjne	r3,#0x20,00120$
                           1071 ;	Peephole 112.b	changed ljmp to sjmp
   0AC2 80 05              1072 	sjmp	00102$
   0AC4                    1073 00120$:
                           1074 ;     genCmpEq
   ...
   0AC4 BB 40 17           1079 	cjne	r3,#0x40,00104$
   0AC7 80 08              1080 	sjmp	00103$
                           1081 ;00121$:
   0AC9                    1082 00102$:
                           1083 ;Initial/src/lib/spi.c:203: write_byte_msb (header_lo);
                           1084 ;     genCall
   0AC9 85 16 82           1085 	mov	dpl,_spi_write_PARM_2
   0ACC 12 0A FC           1086 	lcall	_write_byte_msb
   ...
   0AE2                    1112 00105$:
                           ...
                           1114 ;     genCmpEq
   0AE2 E5 1B              1115 	mov	a,_spi_write_PARM_6
                           1116 ;	Peephole 110	removed ljmp by inverse jump logic
   0AE4 60 0C              1117 	jz	00110$
   0AE6                    1118 00122$:
                           1119 ;Initial/src/lib/spi.c:213: write_bytes_msb (buf, len);
                           1120 ;     genAssign
   0AE6 85 1B 1C           1121 	mov	_write_bytes_msb_PARM_2,_spi_write_PARM_6
                           1122 ;     genCall
   0AE9 85 19 82           1123 	mov	dpl,_spi_write_PARM_5
   0AEC 85 1A 83           1124 	mov	dph,(_spi_write_PARM_5 + 1)
   0AEF 12 0B 4F           1125 	lcall	_write_bytes_msb
   0AF2                    1126 00110$:
                           1127 ;Initial/src/lib/spi.c:216: disable_all ();
                           1128 ;     genCall
   0AF2 75 82 00           1129 	mov	dpl,#0x00
   0AF5 12 09 FB           1130 	lcall	_setup_enables
                           1131 ;Initial/src/lib/spi.c:217: return 1;		// success
                           1132 ;     genRet
   0AF8 75 82 01           1133 	mov	dpl,#0x01
   0AFB                    1134 00111$:
   0AFB 22                 1135 	ret
                           1136 ;------------------------------------------------------------
   ...
   0B4E 22                 1278 	ret
                           ...
                           1288 ;	-----------------------------------------
   0B4F                    1289 _write_bytes_msb:
                           1290 ;     genReceive
   0B4F AA 82              1291 	mov	r2,dpl
   0B51 AB 83              1292 	mov	r3,dph
                           1293 ;Initial/src/lib/spi.c:269: while (len-- != 0){
                           1294 ;     genAssign
                           1295 ;     genAssign
   0B53 AC 1C              1296 	mov	r4,_write_bytes_msb_PARM_2
   0B55                    1297 00101$:
                           1298 ;     genAssign
   0B55 8C 05              1299 	mov	ar5,r4
                           1300 ;     genMinus
                           1301 ;     genMinusDec
   0B57 1C                 1302 	dec	r4
                           1303 ;     genCmpEq
   0B58 BD 00 01           1304 	cjne	r5,#0x00,00108$
   ...
   0B5C 8A 82              1312 	mov	dpl,r2
   0B5E 8B 83              1313 	mov	dph,r3
   0B60 E0                 1314 	movx	a,@dptr
   0B61 FD                 1315 	mov	r5,a
   0B62 A3                 1316 	inc	dptr
   0B63 AA 82              1317 	mov	r2,dpl
   0B65 AB 83              1318 	mov	r3,dph
                           1319 ;     genCall
   0B67 8D 82              1320 	mov	dpl,r5
   0B69 C0 02              1321 	push	ar2
   0B6B C0 03              1322 	push	ar3
   0B6D C0 04              1323 	push	ar4
   0B6F 12 0A FC           1324 	lcall	_write_byte_msb
   0B72 D0 04              1325 	pop	ar4
   0B74 D0 03              1326 	pop	ar3
   0B76 D0 02              1327 	pop	ar2
                           1328 ;	Peephole 112.b	changed ljmp to sjmp
   0B78 80 DB              1329 	sjmp	00101$
   0B7A                    1330 00104$:
   0B7A 22                 1331 	ret
                           1332 ;------------------------------------------------------------
                           ...
                           1339 ;	-----------------------------------------
   0B7B                    1340 _read_byte_msb:
                           1341 ;	naked function: no prologue.
                           1342 ;Initial/src/lib/spi.c:373: _endasm;
                           1343 ;     genInline
   0B7B E4                 1344 	        clr a
   0B7C D2 80              1345 	        setb _bitS_CLK
   0B7E A2 83              1346 	        mov c, _bitS_IN
   0B80 33                 1347 	        rlc a
   0B81 C2 80              1348 	        clr _bitS_CLK
   0B83 D2 80              1349 	        setb _bitS_CLK
   0B85 A2 83              1350 	        mov c, _bitS_IN
   0B87 33                 1351 	        rlc a
   0B88 C2 80              1352 	        clr _bitS_CLK
   0B8A D2 80              1353 	        setb _bitS_CLK
   0B8C A2 83              1354 	        mov c, _bitS_IN
   0B8E 33                 1355 	        rlc a
   0B8F C2 80              1356 	        clr _bitS_CLK
   0B91 D2 80              1357 	        setb _bitS_CLK
   0B93 A2 83              1358 	        mov c, _bitS_IN
   0B95 33                 1359 	        rlc a
   0B96 C2 80              1360 	        clr _bitS_CLK
   0B98 D2 80              1361 	        setb _bitS_CLK
   0B9A A2 83              1362 	        mov c, _bitS_IN
   0B9C 33                 1363 	        rlc a
   0B9D C2 80              1364 	        clr _bitS_CLK
   0B9F D2 80              1365 	        setb _bitS_CLK
   0BA1 A2 83              1366 	        mov c, _bitS_IN
   0BA3 33                 1367 	        rlc a
   0BA4 C2 80              1368 	        clr _bitS_CLK
   0BA6 D2 80              1369 	        setb _bitS_CLK
   0BA8 A2 83              1370 	        mov c, _bitS_IN
   0BAA 33                 1371 	        rlc a
   0BAB C2 80              1372 	        clr _bitS_CLK
   0BAD D2 80              1373 	        setb _bitS_CLK
   0BAF A2 83              1374 	        mov c, _bitS_IN
   0BB1 33                 1375 	        rlc a
   0BB2 C2 80              1376 	        clr _bitS_CLK
   0BB4 F5 82              1377 	        mov dpl,a
   0BB6 22                 1378 	        ret
   0BB7                    1379 00101$:
                           ...
                           1390 ;	-----------------------------------------
   0BB7                    1391 _read_bytes_msb:
                           1392 ;     genReceive
   0BB7 AA 82              1393 	mov	r2,dpl
   0BB9 AB 83              1394 	mov	r3,dph
                           1395 ;Initial/src/lib/spi.c:380: while (len-- != 0){
                           1396 ;     genAssign
                           1397 ;     genAssign
   0BBB AC 1D              1398 	mov	r4,_read_bytes_msb_PARM_2
   0BBD                    1399 00101$:
                           1400 ;     genAssign
   0BBD 8C 05              1401 	mov	ar5,r4
                           1402 ;     genMinus
                           1403 ;     genMinusDec
   0BBF 1C                 1404 	dec	r4
                           1405 ;     genCmpEq
   0BC0 BD 00 01           1406 	cjne	r5,#0x00,00108$
   ...
   0BC4                    1410 00108$:
                           ...
                           1412 ;     genCall
   0BC4 12 0B 7B           1413 	lcall	_read_byte_msb
   0BC7 AD 82              1414 	mov	r5,dpl
                           1415 ;     genPointerSet
                           1416 ;     genFarPointerSet
   0BC9 8A 82              1417 	mov	dpl,r2
   0BCB 8B 83              1418 	mov	dph,r3
   0BCD ED                 1419 	mov	a,r5
   0BCE F0                 1420 	movx	@dptr,a
   0BCF A3                 1421 	inc	dptr
   0BD0 AA 82              1422 	mov	r2,dpl
   0BD2 AB 83              1423 	mov	r3,dph
                           1424 ;	Peephole 112.b	changed ljmp to sjmp
   0BD4 80 E7              1425 	sjmp	00101$
   0BD6                    1426 00104$:
   0BD6 22                 1427 	ret
                           1428 	.area CSEG    (CODE)
