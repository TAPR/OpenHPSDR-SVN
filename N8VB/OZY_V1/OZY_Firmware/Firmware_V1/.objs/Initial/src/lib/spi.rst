                              ...
                              4 ; This file generated Mon Jul 31 08:58:03 2006
                              5 ;--------------------------------------------------------
                              6 	.module spi
   ...
   0A0A                     767 _init_spi:
                            ...
                            769 ;     genCall
   0A0A 75 82 00            770 	mov	dpl,#0x00
   0A0D 12 0A 09            771 	lcall	_setup_enables
                            772 ;Initial/src/lib/spi.c:54: bitS_OUT = 0;			/* idle state has CLK = 0 */
                            773 ;     genAssign
   0A10 C2 81               774 	clr	_bitS_OUT
   0A12                     775 00101$:
   0A12 22                  776 	ret
                            777 ;------------------------------------------------------------
   ...
   0A22                     813 00104$:
                            ...
                            815 ;     genAnd
   0A22 EA                  816 	mov	a,r2
                            817 ;     genIfxJump
                            818 ;	Peephole 111	removed ljmp by inverse jump logic
   0A23 30 E2 01            819 	jnb	acc.2,00106$
   0A26                     820 00129$:
                            821 ;     genPlus
                            822 ;     genPlusIncr
   0A26 0B                  823 	inc	r3
   0A27                     824 00106$:
                            ...
                            826 ;     genAnd
   0A27 EA                  827 	mov	a,r2
                            828 ;     genIfxJump
                            829 ;	Peephole 111	removed ljmp by inverse jump logic
   0A28 30 E3 01            830 	jnb	acc.3,00108$
   0A2B                     831 00130$:
                            832 ;     genPlus
                            833 ;     genPlusIncr
   0A2B 0B                  834 	inc	r3
   0A2C                     835 00108$:
                            ...
                            837 ;     genAnd
   0A2C EA                  838 	mov	a,r2
                            839 ;     genIfxJump
                            840 ;	Peephole 111	removed ljmp by inverse jump logic
   0A2D 30 E4 01            841 	jnb	acc.4,00110$
   0A30                     842 00131$:
                            843 ;     genPlus
                            844 ;     genPlusIncr
   0A30 0B                  845 	inc	r3
   0A31                     846 00110$:
                            ...
                            848 ;     genAnd
   0A31 EA                  849 	mov	a,r2
                            850 ;     genIfxJump
                            851 ;	Peephole 111	removed ljmp by inverse jump logic
   0A32 30 E5 01            852 	jnb	acc.5,00112$
   0A35                     853 00132$:
                            854 ;     genPlus
                            855 ;     genPlusIncr
   0A35 0B                  856 	inc	r3
   0A36                     857 00112$:
                            ...
                            859 ;     genAnd
   0A36 EA                  860 	mov	a,r2
                            861 ;     genIfxJump
                            862 ;	Peephole 111	removed ljmp by inverse jump logic
   0A37 30 E6 01            863 	jnb	acc.6,00114$
   0A3A                     864 00133$:
                            865 ;     genPlus
                            866 ;     genPlusIncr
   0A3A 0B                  867 	inc	r3
   0A3B                     868 00114$:
                            ...
                            870 ;     genAnd
   0A3B EA                  871 	mov	a,r2
                            872 ;     genIfxJump
                            873 ;	Peephole 111	removed ljmp by inverse jump logic
   0A3C 30 E7 01            874 	jnb	acc.7,00116$
   0A3F                     875 00134$:
                            876 ;     genPlus
                            877 ;     genPlusIncr
   0A3F 0B                  878 	inc	r3
   ...
   0A43                     899 _spi_read:
                            900 ;     genReceive
   0A43 AA 82               901 	mov	r2,dpl
                            902 ;Initial/src/lib/spi.c:116: if (count_bits8 (enables) > 1)
                            903 ;     genCall
   0A45 85 11 82            904 	mov	dpl,_spi_read_PARM_3
   0A48 C0 02               905 	push	ar2
   0A4A 12 0A 13            906 	lcall	_count_bits8
   0A4D AB 82               907 	mov	r3,dpl
   0A4F D0 02               908 	pop	ar2
                            909 ;     genCmpGt
                            910 ;     genCmp
                            911 ;     genIfxJump
                            912 ;	Peephole 108	removed ljmp by inverse jump logic
                            913 ;	Peephole 132.b	optimized genCmpGt by inverse logic (acc differs)
   0A51 EB                  914 	mov	a,r3
   0A52 24 FE               915 	add	a,#0xff - 0x01
   0A54 50 04               916 	jnc	00102$
   0A56                     917 00121$:
                            918 ;Initial/src/lib/spi.c:117: return 0;		// error, too many enables set
                            919 ;     genRet
   0A56 75 82 00            920 	mov	dpl,#0x00
   ...
   0A5A                     924 00102$:
                            ...
                            926 ;     genCall
   0A5A 85 11 82            927 	mov	dpl,_spi_read_PARM_3
   0A5D C0 02               928 	push	ar2
   0A5F 12 0A 09            929 	lcall	_setup_enables
   0A62 D0 02               930 	pop	ar2
                            931 ;Initial/src/lib/spi.c:121: if (format & SPI_FMT_LSB){		// order: LSB
                            932 ;     genAnd
   0A64 E5 12               933 	mov	a,_spi_read_PARM_4
                            934 ;     genIfxJump
                            935 ;	Peephole 111	removed ljmp by inverse jump logic
   0A66 30 E7 04            936 	jnb	acc.7,00111$
   0A69                     937 00122$:
                            938 ;Initial/src/lib/spi.c:123: return 0;		// error, not implemented
                            939 ;     genRet
   0A69 75 82 00            940 	mov	dpl,#0x00
   ...
   0A6D                     944 00111$:
                            ...
                            946 ;     genAnd
   0A6D 74 60               947 	mov	a,#0x60
   0A6F 55 12               948 	anl	a,_spi_read_PARM_4
                            949 ;     genCmpEq
                            950 ;	Peephole 112.b	changed ljmp to sjmp
                            951 ;	Peephole 115.b	jump optimization
   0A71 FB                  952 	mov	r3,a
   0A72 60 23               953 	jz	00107$
   0A74                     954 00123$:
                            955 ;     genCmpEq
   0A74 BB 20 02            956 	cjne	r3,#0x20,00124$
                            957 ;	Peephole 112.b	changed ljmp to sjmp
   0A77 80 05               958 	sjmp	00104$
   0A79                     959 00124$:
                            960 ;     genCmpEq
   ...
   0A79 BB 40 17            965 	cjne	r3,#0x40,00106$
   0A7C 80 08               966 	sjmp	00105$
                            967 ;00125$:
   0A7E                     968 00104$:
                            969 ;Initial/src/lib/spi.c:149: write_byte_msb (header_lo);
                            970 ;     genCall
   0A7E 85 10 82            971 	mov	dpl,_spi_read_PARM_2
   0A81 12 0B 0A            972 	lcall	_write_byte_msb
   ...
   0A97                     998 00107$:
                           ...
                           1000 ;     genCmpEq
   0A97 E5 15              1001 	mov	a,_spi_read_PARM_6
                           1002 ;	Peephole 110	removed ljmp by inverse jump logic
   0A99 60 0C              1003 	jz	00112$
   0A9B                    1004 00126$:
                           1005 ;Initial/src/lib/spi.c:159: read_bytes_msb (buf, len);
                           1006 ;     genAssign
   0A9B 85 15 1D           1007 	mov	_read_bytes_msb_PARM_2,_spi_read_PARM_6
                           1008 ;     genCall
   0A9E 85 13 82           1009 	mov	dpl,_spi_read_PARM_5
   0AA1 85 14 83           1010 	mov	dph,(_spi_read_PARM_5 + 1)
   0AA4 12 0B C5           1011 	lcall	_read_bytes_msb
   0AA7                    1012 00112$:
                           1013 ;Initial/src/lib/spi.c:162: disable_all ();
                           1014 ;     genCall
   0AA7 75 82 00           1015 	mov	dpl,#0x00
   0AAA 12 0A 09           1016 	lcall	_setup_enables
                           1017 ;Initial/src/lib/spi.c:163: return 1;		// success
                           1018 ;     genRet
   0AAD 75 82 01           1019 	mov	dpl,#0x01
   0AB0                    1020 00113$:
   0AB0 22                 1021 	ret
                           1022 ;------------------------------------------------------------
                           ...
                           1035 ;	-----------------------------------------
   0AB1                    1036 _spi_write:
                           1037 ;     genReceive
   0AB1 AA 82              1038 	mov	r2,dpl
                           1039 ;Initial/src/lib/spi.c:173: setup_enables (enables);
                           1040 ;     genCall
   0AB3 85 17 82           1041 	mov	dpl,_spi_write_PARM_3
   0AB6 C0 02              1042 	push	ar2
   0AB8 12 0A 09           1043 	lcall	_setup_enables
   0ABB D0 02              1044 	pop	ar2
                           1045 ;Initial/src/lib/spi.c:175: if (format & SPI_FMT_LSB){		// order: LSB
                           1046 ;     genAnd
   0ABD E5 18              1047 	mov	a,_spi_write_PARM_4
                           1048 ;     genIfxJump
                           1049 ;	Peephole 111	removed ljmp by inverse jump logic
   0ABF 30 E7 04           1050 	jnb	acc.7,00109$
   0AC2                    1051 00118$:
                           1052 ;Initial/src/lib/spi.c:177: return 0;		// error, not implemented
                           1053 ;     genRet
   0AC2 75 82 00           1054 	mov	dpl,#0x00
   ...
   0AC6                    1058 00109$:
                           ...
                           1060 ;     genAnd
   0AC6 74 60              1061 	mov	a,#0x60
   0AC8 55 18              1062 	anl	a,_spi_write_PARM_4
                           1063 ;     genCmpEq
                           1064 ;	Peephole 112.b	changed ljmp to sjmp
                           1065 ;	Peephole 115.b	jump optimization
   0ACA FB                 1066 	mov	r3,a
   0ACB 60 23              1067 	jz	00105$
   0ACD                    1068 00119$:
                           1069 ;     genCmpEq
   0ACD BB 20 02           1070 	cjne	r3,#0x20,00120$
                           1071 ;	Peephole 112.b	changed ljmp to sjmp
   0AD0 80 05              1072 	sjmp	00102$
   0AD2                    1073 00120$:
                           1074 ;     genCmpEq
   ...
   0AD2 BB 40 17           1079 	cjne	r3,#0x40,00104$
   0AD5 80 08              1080 	sjmp	00103$
                           1081 ;00121$:
   0AD7                    1082 00102$:
                           1083 ;Initial/src/lib/spi.c:203: write_byte_msb (header_lo);
                           1084 ;     genCall
   0AD7 85 16 82           1085 	mov	dpl,_spi_write_PARM_2
   0ADA 12 0B 0A           1086 	lcall	_write_byte_msb
   ...
   0AF0                    1112 00105$:
                           ...
                           1114 ;     genCmpEq
   0AF0 E5 1B              1115 	mov	a,_spi_write_PARM_6
                           1116 ;	Peephole 110	removed ljmp by inverse jump logic
   0AF2 60 0C              1117 	jz	00110$
   0AF4                    1118 00122$:
                           1119 ;Initial/src/lib/spi.c:213: write_bytes_msb (buf, len);
                           1120 ;     genAssign
   0AF4 85 1B 1C           1121 	mov	_write_bytes_msb_PARM_2,_spi_write_PARM_6
                           1122 ;     genCall
   0AF7 85 19 82           1123 	mov	dpl,_spi_write_PARM_5
   0AFA 85 1A 83           1124 	mov	dph,(_spi_write_PARM_5 + 1)
   0AFD 12 0B 5D           1125 	lcall	_write_bytes_msb
   0B00                    1126 00110$:
                           1127 ;Initial/src/lib/spi.c:216: disable_all ();
                           1128 ;     genCall
   0B00 75 82 00           1129 	mov	dpl,#0x00
   0B03 12 0A 09           1130 	lcall	_setup_enables
                           1131 ;Initial/src/lib/spi.c:217: return 1;		// success
                           1132 ;     genRet
   0B06 75 82 01           1133 	mov	dpl,#0x01
   0B09                    1134 00111$:
   0B09 22                 1135 	ret
                           1136 ;------------------------------------------------------------
   ...
   0B5C 22                 1278 	ret
                           ...
                           1288 ;	-----------------------------------------
   0B5D                    1289 _write_bytes_msb:
                           1290 ;     genReceive
   0B5D AA 82              1291 	mov	r2,dpl
   0B5F AB 83              1292 	mov	r3,dph
                           1293 ;Initial/src/lib/spi.c:269: while (len-- != 0){
                           1294 ;     genAssign
                           1295 ;     genAssign
   0B61 AC 1C              1296 	mov	r4,_write_bytes_msb_PARM_2
   0B63                    1297 00101$:
                           1298 ;     genAssign
   0B63 8C 05              1299 	mov	ar5,r4
                           1300 ;     genMinus
                           1301 ;     genMinusDec
   0B65 1C                 1302 	dec	r4
                           1303 ;     genCmpEq
   0B66 BD 00 01           1304 	cjne	r5,#0x00,00108$
   ...
   0B6A 8A 82              1312 	mov	dpl,r2
   0B6C 8B 83              1313 	mov	dph,r3
   0B6E E0                 1314 	movx	a,@dptr
   0B6F FD                 1315 	mov	r5,a
   0B70 A3                 1316 	inc	dptr
   0B71 AA 82              1317 	mov	r2,dpl
   0B73 AB 83              1318 	mov	r3,dph
                           1319 ;     genCall
   0B75 8D 82              1320 	mov	dpl,r5
   0B77 C0 02              1321 	push	ar2
   0B79 C0 03              1322 	push	ar3
   0B7B C0 04              1323 	push	ar4
   0B7D 12 0B 0A           1324 	lcall	_write_byte_msb
   0B80 D0 04              1325 	pop	ar4
   0B82 D0 03              1326 	pop	ar3
   0B84 D0 02              1327 	pop	ar2
                           1328 ;	Peephole 112.b	changed ljmp to sjmp
   0B86 80 DB              1329 	sjmp	00101$
   0B88                    1330 00104$:
   0B88 22                 1331 	ret
                           1332 ;------------------------------------------------------------
                           ...
                           1339 ;	-----------------------------------------
   0B89                    1340 _read_byte_msb:
                           1341 ;	naked function: no prologue.
                           1342 ;Initial/src/lib/spi.c:373: _endasm;
                           1343 ;     genInline
   0B89 E4                 1344 	        clr a
   0B8A D2 80              1345 	        setb _bitS_CLK
   0B8C A2 83              1346 	        mov c, _bitS_IN
   0B8E 33                 1347 	        rlc a
   0B8F C2 80              1348 	        clr _bitS_CLK
   0B91 D2 80              1349 	        setb _bitS_CLK
   0B93 A2 83              1350 	        mov c, _bitS_IN
   0B95 33                 1351 	        rlc a
   0B96 C2 80              1352 	        clr _bitS_CLK
   0B98 D2 80              1353 	        setb _bitS_CLK
   0B9A A2 83              1354 	        mov c, _bitS_IN
   0B9C 33                 1355 	        rlc a
   0B9D C2 80              1356 	        clr _bitS_CLK
   0B9F D2 80              1357 	        setb _bitS_CLK
   0BA1 A2 83              1358 	        mov c, _bitS_IN
   0BA3 33                 1359 	        rlc a
   0BA4 C2 80              1360 	        clr _bitS_CLK
   0BA6 D2 80              1361 	        setb _bitS_CLK
   0BA8 A2 83              1362 	        mov c, _bitS_IN
   0BAA 33                 1363 	        rlc a
   0BAB C2 80              1364 	        clr _bitS_CLK
   0BAD D2 80              1365 	        setb _bitS_CLK
   0BAF A2 83              1366 	        mov c, _bitS_IN
   0BB1 33                 1367 	        rlc a
   0BB2 C2 80              1368 	        clr _bitS_CLK
   0BB4 D2 80              1369 	        setb _bitS_CLK
   0BB6 A2 83              1370 	        mov c, _bitS_IN
   0BB8 33                 1371 	        rlc a
   0BB9 C2 80              1372 	        clr _bitS_CLK
   0BBB D2 80              1373 	        setb _bitS_CLK
   0BBD A2 83              1374 	        mov c, _bitS_IN
   0BBF 33                 1375 	        rlc a
   0BC0 C2 80              1376 	        clr _bitS_CLK
   0BC2 F5 82              1377 	        mov dpl,a
   0BC4 22                 1378 	        ret
   0BC5                    1379 00101$:
                           ...
                           1390 ;	-----------------------------------------
   0BC5                    1391 _read_bytes_msb:
                           1392 ;     genReceive
   0BC5 AA 82              1393 	mov	r2,dpl
   0BC7 AB 83              1394 	mov	r3,dph
                           1395 ;Initial/src/lib/spi.c:380: while (len-- != 0){
                           1396 ;     genAssign
                           1397 ;     genAssign
   0BC9 AC 1D              1398 	mov	r4,_read_bytes_msb_PARM_2
   0BCB                    1399 00101$:
                           1400 ;     genAssign
   0BCB 8C 05              1401 	mov	ar5,r4
                           1402 ;     genMinus
                           1403 ;     genMinusDec
   0BCD 1C                 1404 	dec	r4
                           1405 ;     genCmpEq
   0BCE BD 00 01           1406 	cjne	r5,#0x00,00108$
   ...
   0BD2                    1410 00108$:
                           ...
                           1412 ;     genCall
   0BD2 12 0B 89           1413 	lcall	_read_byte_msb
   0BD5 AD 82              1414 	mov	r5,dpl
                           1415 ;     genPointerSet
                           1416 ;     genFarPointerSet
   0BD7 8A 82              1417 	mov	dpl,r2
   0BD9 8B 83              1418 	mov	dph,r3
   0BDB ED                 1419 	mov	a,r5
   0BDC F0                 1420 	movx	@dptr,a
   0BDD A3                 1421 	inc	dptr
   0BDE AA 82              1422 	mov	r2,dpl
   0BE0 AB 83              1423 	mov	r3,dph
                           1424 ;	Peephole 112.b	changed ljmp to sjmp
   0BE2 80 E7              1425 	sjmp	00101$
   0BE4                    1426 00104$:
   0BE4 22                 1427 	ret
                           1428 	.area CSEG    (CODE)
