   ...
   0670 90 E6 A0            711 	mov	dptr,#_EP0CS
   0673 E0                  712 	movx	a,@dptr
   0674 FA                  713 	mov	r2,a
   0675 44 01               714 	orl	a,#0x01
   0677 F0                  715 	movx	@dptr,a
   0678                     716 00101$:
   0678 22                  717 	ret
                            718 ;------------------------------------------------------------
                            ...
                            726 ;	-----------------------------------------
   0679                     727 _fx2_reset_data_toggle:
                            728 ;     genReceive
   0679 AA 82               729 	mov	r2,dpl
                            730 ;Initial/src/lib/fx2utils.c:39: TOGCTL = ((ep & 0x80) >> 3 | (ep & 0x0f));
                            731 ;     genAnd
   067B 74 80               732 	mov	a,#0x80
   067D 5A                  733 	anl	a,r2
                            734 ;     genRightShift
                            735 ;     genRightShiftLiteral
                            736 ;     genrshOne
                            737 ;	Peephole 105	removed redundant mov
   067E FB                  738 	mov	r3,a
   067F C4                  739 	swap	a
   0680 23                  740 	rl	a
   0681 54 1F               741 	anl	a,#0x1f
   0683 FB                  742 	mov	r3,a
                            743 ;     genAnd
   0684 74 0F               744 	mov	a,#0x0F
   0686 5A                  745 	anl	a,r2
                            746 ;     genOr
   0687 90 E6 83            747 	mov	dptr,#_TOGCTL
   068A 4B                  748 	orl	a,r3
   068B F0                  749 	movx	@dptr,a
                            750 ;Initial/src/lib/fx2utils.c:40: TOGCTL |= bmRESETTOGGLE;
                            751 ;     genAssign
                            752 ;     genOr
                            753 ;	Peephole 248.a	optimized or to xdata
   068C 90 E6 83            754 	mov	dptr,#_TOGCTL
   068F E0                  755 	movx	a,@dptr
   0690 FA                  756 	mov	r2,a
   0691 44 20               757 	orl	a,#0x20
   0693 F0                  758 	movx	@dptr,a
   0694                     759 00101$:
   0694 22                  760 	ret
                            761 ;------------------------------------------------------------
                            ...
                            768 ;	-----------------------------------------
   0695                     769 _fx2_renumerate:
                            770 ;Initial/src/lib/fx2utils.c:46: USBCS |= bmDISCON | bmRENUM;
                            771 ;     genAssign
                            772 ;     genOr
                            773 ;	Peephole 248.a	optimized or to xdata
   0695 90 E6 80            774 	mov	dptr,#_USBCS
   0698 E0                  775 	movx	a,@dptr
   0699 FA                  776 	mov	r2,a
   069A 44 0A               777 	orl	a,#0x0A
   069C F0                  778 	movx	@dptr,a
                            779 ;Initial/src/lib/fx2utils.c:48: mdelay (250);
                            780 ;     genCall
                            781 ;	Peephole 182.b	used 16 bit load of dptr
   069D 90 00 FA            782 	mov	dptr,#0x00FA
   06A0 12 06 5D            783 	lcall	_mdelay
                            784 ;Initial/src/lib/fx2utils.c:50: USBIRQ = 0xff;		// clear any pending USB irqs...
                            785 ;     genAssign
   06A3 90 E6 5D            786 	mov	dptr,#_USBIRQ
   06A6 74 FF               787 	mov	a,#0xFF
   06A8 F0                  788 	movx	@dptr,a
                            789 ;Initial/src/lib/fx2utils.c:51: EPIRQ =  0xff;		//   they're from before the renumeration
                            790 ;     genAssign
   06A9 90 E6 5F            791 	mov	dptr,#_EPIRQ
   06AC 74 FF               792 	mov	a,#0xFF
   06AE F0                  793 	movx	@dptr,a
                            794 ;Initial/src/lib/fx2utils.c:53: EXIF &= ~bmEXIF_USBINT;
                            795 ;     genAnd
   06AF 53 91 EF            796 	anl	_EXIF,#0xEF
                            797 ;Initial/src/lib/fx2utils.c:55: USBCS &= ~bmDISCON;		// reconnect USB
                            798 ;     genAssign
                            799 ;     genAnd
                            800 ;	Peephole 248.b	optimized and to xdata
   06B2 90 E6 80            801 	mov	dptr,#_USBCS
   06B5 E0                  802 	movx	a,@dptr
   06B6 FA                  803 	mov	r2,a
   06B7 54 F7               804 	anl	a,#0xF7
   06B9 F0                  805 	movx	@dptr,a
   06BA                     806 00101$:
   06BA 22                  807 	ret
                            808 	.area CSEG    (CODE)
