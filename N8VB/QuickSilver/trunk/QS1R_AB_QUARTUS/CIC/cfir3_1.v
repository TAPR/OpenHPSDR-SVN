...
//
// Generated on: 2007-01-30 11:13:44
//
// -------------------------------------------------------------
...
//   Product         : s48,30 -> [-131072 131072)  (auto determined)
...
module cfir3_1 
  ...
  wire signed [47:0] product2; // sfix48_En30
  wire signed [48:0] mul_temp; // sfix49_En30
  wire signed [47:0] product1; // sfix48_En30
  wire signed [48:0] mul_temp_1; // sfix49_En30
  wire signed [47:0] sum1; // sfix48_En30
  ...
  assign mul_temp = tapsum_mcand_1 * coeff2;
  assign product2 = mul_temp[47:0];

  assign mul_temp_1 = tapsum_mcand * coeff1;
  assign product1 = mul_temp_1[47:0];
