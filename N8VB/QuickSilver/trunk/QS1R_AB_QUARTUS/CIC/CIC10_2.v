...
//
// Generated on: 2007-02-02 10:22:57
//
// -------------------------------------------------------------
...
//   Integrator Section 7   : s42,15
//   Integrator Section 8   : s42,15
//   Integrator Section 9   : s42,15
//   Integrator Section 10  : s42,15
...
//   Comb Section 7         : s42,15
//   Comb Section 8         : s42,15
//   Comb Section 9         : s42,15
//   Comb Section 10        : s42,15
//
// Implementation Cost
...
////////////////////////////////////////////////////////////////
  ...
  wire signed [41:0] sum7; // sfix42_En15
  reg  signed [41:0] section_out7; // sfix42_En15
  wire signed [41:0] add_cast_12; // sfix42_En15
  wire signed [41:0] add_cast_13; // sfix42_En15
  wire signed [42:0] add_temp_6; // sfix43_En15
  //   -- Section 8 Signals 
  wire signed [41:0] section_in8; // sfix42_En15
  wire signed [41:0] sum8; // sfix42_En15
  reg  signed [41:0] section_out8; // sfix42_En15
  wire signed [41:0] add_cast_14; // sfix42_En15
  wire signed [41:0] add_cast_15; // sfix42_En15
  wire signed [42:0] add_temp_7; // sfix43_En15
  //   -- Section 9 Signals 
  wire signed [41:0] section_in9; // sfix42_En15
  wire signed [41:0] sum9; // sfix42_En15
  reg  signed [41:0] section_out9; // sfix42_En15
  wire signed [41:0] add_cast_16; // sfix42_En15
  wire signed [41:0] add_cast_17; // sfix42_En15
  wire signed [42:0] add_temp_8; // sfix43_En15
  //   -- Section 10 Signals 
  wire signed [41:0] section_in10; // sfix42_En15
  wire signed [41:0] sum10; // sfix42_En15
  reg  signed [41:0] section_out10; // sfix42_En15
  wire signed [41:0] add_cast_18; // sfix42_En15
  wire signed [41:0] add_cast_19; // sfix42_En15
  wire signed [42:0] add_temp_9; // sfix43_En15
  //   -- Section 11 Signals 
  ...
  //   -- Section 13 Signals 
  wire signed [41:0] section_in13; // sfix42_En15
  reg  signed [41:0] diff3; // sfix42_En15
  wire signed [41:0] section_out13; // sfix42_En15
  wire signed [41:0] sub_cast_4; // sfix42_En15
  wire signed [41:0] sub_cast_5; // sfix42_En15
  wire signed [42:0] sub_temp_2; // sfix43_En15
  //   -- Section 14 Signals 
  wire signed [41:0] section_in14; // sfix42_En15
  reg  signed [41:0] diff4; // sfix42_En15
  wire signed [41:0] section_out14; // sfix42_En15
  wire signed [41:0] sub_cast_6; // sfix42_En15
  wire signed [41:0] sub_cast_7; // sfix42_En15
  wire signed [42:0] sub_temp_3; // sfix43_En15
  //   -- Section 15 Signals 
  wire signed [41:0] section_in15; // sfix42_En15
  reg  signed [41:0] diff5; // sfix42_En15
  wire signed [41:0] section_out15; // sfix42_En15
  wire signed [41:0] sub_cast_8; // sfix42_En15
  wire signed [41:0] sub_cast_9; // sfix42_En15
  wire signed [42:0] sub_temp_4; // sfix43_En15
  //   -- Section 16 Signals 
  wire signed [41:0] section_in16; // sfix42_En15
  reg  signed [41:0] diff6; // sfix42_En15
  wire signed [41:0] section_out16; // sfix42_En15
  wire signed [41:0] sub_cast_10; // sfix42_En15
  wire signed [41:0] sub_cast_11; // sfix42_En15
  wire signed [42:0] sub_temp_5; // sfix43_En15
  //   -- Section 17 Signals 
  wire signed [41:0] section_in17; // sfix42_En15
  reg  signed [41:0] diff7; // sfix42_En15
  wire signed [41:0] section_out17; // sfix42_En15
  wire signed [41:0] sub_cast_12; // sfix42_En15
  wire signed [41:0] sub_cast_13; // sfix42_En15
  wire signed [42:0] sub_temp_6; // sfix43_En15
  //   -- Section 18 Signals 
  wire signed [41:0] section_in18; // sfix42_En15
  reg  signed [41:0] diff8; // sfix42_En15
  wire signed [41:0] section_out18; // sfix42_En15
  wire signed [41:0] sub_cast_14; // sfix42_En15
  wire signed [41:0] sub_cast_15; // sfix42_En15
  wire signed [42:0] sub_temp_7; // sfix43_En15
  //   -- Section 19 Signals 
  wire signed [41:0] section_in19; // sfix42_En15
  reg  signed [41:0] diff9; // sfix42_En15
  wire signed [41:0] section_out19; // sfix42_En15
  wire signed [41:0] sub_cast_16; // sfix42_En15
  wire signed [41:0] sub_cast_17; // sfix42_En15
  wire signed [42:0] sub_temp_8; // sfix43_En15
  //   -- Section 20 Signals 
  wire signed [41:0] section_in20; // sfix42_En15
  reg  signed [41:0] diff10; // sfix42_En15
  wire signed [41:0] section_out20; // sfix42_En15
  wire signed [41:0] sub_cast_18; // sfix42_En15
  wire signed [41:0] sub_cast_19; // sfix42_En15
  wire signed [42:0] sub_temp_9; // sfix43_En15
  //   
  ...
  assign section_cast1 = $signed({{10{section_in1[31]}}, section_in1});
  ...
  assign section_out11 = sub_temp[41:0];
  ...
  assign section_out12 = sub_temp_1[41:0];
  ...
  assign section_out13 = sub_temp_2[41:0];
  ...
  assign section_out14 = sub_temp_3[41:0];
  ...
  assign section_out15 = sub_temp_4[41:0];
  ...
  assign section_out16 = sub_temp_5[41:0];
  ...
  assign section_out17 = sub_temp_6[41:0];
  ...
  assign section_out18 = sub_temp_7[41:0];
  ...
  assign section_out19 = sub_temp_8[41:0];
  ...
  assign section_out20 = sub_temp_9[41:0];
