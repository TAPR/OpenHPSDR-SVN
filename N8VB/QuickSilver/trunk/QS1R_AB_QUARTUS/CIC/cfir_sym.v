...
//
// Generated on: 2007-01-30 12:42:44
//
// -------------------------------------------------------------
...
module cfir_sym 
  ...
  wire signed [42:0] mul_temp; // sfix43_En24
  wire signed [41:0] product1; // sfix42_En24
  wire signed [42:0] mul_temp_1; // sfix43_En24
  wire signed [41:0] sum1; // sfix42_En24
  ...
  assign product2 = mul_temp[41:0];

  assign mul_temp_1 = tapsum_mcand * coeff1;
  assign product1 = mul_temp_1[41:0];
