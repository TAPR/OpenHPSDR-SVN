...
namespace SharpDSP
{
    ...
    public struct Meter
    {
        ...
        private int size;
        private double meter_average_value;
        ...
        public void DoMeter(ref double[] real, ref double[] imag, MeterPosition position)
        {
                ...
                case MeterType.SIGNAL_STRENGTH:
                    {
                        ...
                        double temp_metervalue = 0F;
                        for (int i = 0; i < this.size; i++)
                        {
                            temp_metervalue += (real[i] * real[i] + imag[i] * imag[i]);
                        }
                        this.meter_value = (double)(10.0 * Math.Log10(temp_metervalue + 1e-20));
                    }
                    break;
                case MeterType.AVG_SIGNAL_STRENGTH:
                    {
                        ...
                        temp_metervalue = (double)(Math.Log10(temp_metervalue + 1e-20));
                ...
                case MeterType.ADC_REAL:
                    {
                        ...
                        this.meter_value = (double)(20.0 * Math.Log10(temp_metervalue + 1e-10));
                    }
                    break;
