...
; This file generated Thu Dec 07 15:40:52 2006
;--------------------------------------------------------
	.module fpga_rev1
...
;--------------------------------------------------------
	...
	.area GSFINAL (CODE)
	.area GSINIT  (CODE)
;src/fpga_rev1.c:32: unsigned char g_tx_reset = 0;
;     genAssign
	mov	_g_tx_reset,#0x00
;src/fpga_rev1.c:33: unsigned char g_rx_reset = 0;
;     genAssign
...
;------------------------------------------------------------
;src/fpga_rev1.c:36: fpga_write_reg (unsigned char regno, const xdata unsigned char *regval)
;	-----------------------------------------
...
;     genReceive
	mov	r2,dpl
;src/fpga_rev1.c:38: spi_write (0, 0x00 | (regno & 0x7f),
;     genAnd
	mov	a,#0x7F
	anl	a,r2
	mov	_spi_write_PARM_2,a
;src/fpga_rev1.c:41: regval, 4);
;     genAssign
