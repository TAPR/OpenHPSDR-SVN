...
;------------------------------------------------------------
;src/board_specific.c:31: putchar(char c)
;	-----------------------------------------
;	 function putchar
;	-----------------------------------------
_putchar:
...
;     genReceive
	mov	r2,dpl
;src/board_specific.c:33: while(!TI);
00101$:
;     genIfx
;     genIfxJump
;	Peephole 111	removed ljmp by inverse jump logic
;src/board_specific.c:34: TI=0;
;     genAssign
;	Peephole 250.a	using atomic test and clear
	jbc	_TI,00108$
	sjmp	00101$
00108$:
;src/board_specific.c:35: SBUF0 = c;
;     genAssign
	mov	_SBUF0,r2
00104$:
	ret
...
;------------------------------------------------------------
;src/board_specific.c:38: void putstr(char *s)
;	-----------------------------------------
;	 function putstr
;	-----------------------------------------
_putstr:
;     genReceive
	...
	mov	r3,dph
	mov	r4,b
;src/board_specific.c:42: while ((c=*(s+(i++)))!=0) putchar(c);
;     genAssign
	mov	r5,#0x00
00101$:
;     genAssign
...
;------------------------------------------------------------
;------------------------------------------------------------
;src/board_specific.c:46: init_board (void)
;	-----------------------------------------
;	 function init_board
;	-----------------------------------------
_init_board:
;src/board_specific.c:48: init_spi();
;     genCall
