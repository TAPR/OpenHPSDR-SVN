...
; This file generated Fri Jan 05 10:13:14 2007
;--------------------------------------------------------
	.module eeprom_io
...
;------------------------------------------------------------
;src/eeprom_io.c:32: eeprom_read (unsigned char i2c_addr, unsigned char eeprom_offset,
;	-----------------------------------------
...
;     genReceive
	mov	r2,dpl
;src/eeprom_io.c:41: cmd[0] = 0; // <-- address high byte, set to 0 since we are going to always
;     genPointerSet
;     genFarPointerSet
...
;	Peephole 181	changed mov to clr
	clr	a
	movx	@dptr,a
;src/eeprom_io.c:43: cmd[1] = eeprom_offset; // <-- address low byte
;     genPointerSet
;     genFarPointerSet
	mov	dptr,#(_eeprom_read_cmd_1_1 + 0x0001)
	mov	a,_eeprom_read_PARM_2
	movx	@dptr,a
;src/eeprom_io.c:44: if (!i2c_write(i2c_addr, cmd, 2))
;     genAssign
...
;	Peephole 251.b	replaced sjmp to ret with ret
	ret
00102$:
;src/eeprom_io.c:47: return i2c_read(i2c_addr, buf, len);
;     genAssign
