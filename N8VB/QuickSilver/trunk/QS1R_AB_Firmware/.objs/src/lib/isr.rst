   ...
   0002                     497 	.ds 1
                    ...
                    FC00    681 _EP8FIFOBUF	=	0xfc00
                            ...
                            713 ;------------------------------------------------------------
                            714 ;src/lib/isr.c:43: hook_sv (unsigned char vector_number, unsigned short addr)
                            715 ;	-----------------------------------------
   ...
   04AD                     718 _hook_sv:
                    ...
                    0001    726 	ar1 = 0x01
                            727 ;     genReceive
   04AD AA 82               728 	mov	r2,dpl
                            729 ;src/lib/isr.c:49: if (vector_number < SV_MIN || vector_number > SV_MAX)
                            730 ;     genCmpLt
                            731 ;     genCmp
   04AF BA 03 00            732 	cjne	r2,#0x03,00112$
   04B2                     733 00112$:
                            734 ;     genIfxJump
                            735 ;	Peephole 112.b	changed ljmp to sjmp
                            736 ;	Peephole 160	removed sjmp by inverse jump logic
   04B2 40 05               737 	jc	00101$
   04B4                     738 00113$:
                            739 ;     genCmpGt
                            740 ;     genCmp
                            741 ;     genIfxJump
   ...
   04B4 EA                  744 	mov	a,r2
   04B5 24 9C               745 	add	a,#0xff - 0x63
   04B7 50 01               746 	jnc	00102$
   04B9                     747 00114$:
   04B9                     748 00101$:
                            749 ;src/lib/isr.c:50: return;
                            750 ;     genRet
                            751 ;	Peephole 112.b	changed ljmp to sjmp
                            752 ;	Peephole 251.b	replaced sjmp to ret with ret
   04B9 22                  753 	ret
   04BA                     754 00102$:
                            755 ;src/lib/isr.c:52: if ((vector_number & 0x0f) != 0x03 && (vector_number & 0x0f) != 0x0b)
                            756 ;     genAnd
   04BA 74 0F               757 	mov	a,#0x0F
   04BC 5A                  758 	anl	a,r2
   04BD FB                  759 	mov	r3,a
                            760 ;     genCmpEq
   04BE BB 03 02            761 	cjne	r3,#0x03,00115$
                            762 ;	Peephole 112.b	changed ljmp to sjmp
   04C1 80 07               763 	sjmp	00105$
   04C3                     764 00115$:
                            765 ;     genAnd
   04C3 74 0F               766 	mov	a,#0x0F
   04C5 5A                  767 	anl	a,r2
   04C6 FB                  768 	mov	r3,a
                            769 ;     genCmpEq
                            770 ;	Peephole 112.b	changed ljmp to sjmp
                            771 ;src/lib/isr.c:53: return;
                            772 ;     genRet
                            773 ;	Peephole 112.b	changed ljmp to sjmp
                            774 ;	Peephole 199	optimized misc jump sequence
   04C7 BB 0B 47            775 	cjne	r3,#0x0B,00107$
                            776 ;00116$:
                            777 ;	Peephole 200	removed redundant sjmp
   04CA                     778 00105$:
                            779 ;src/lib/isr.c:55: t = EA;
                            780 ;     genAssign
   04CA A2 AF               781 	mov	c,_EA
   04CC 92 00               782 	mov	_hook_sv_t_1_1,c
                            783 ;src/lib/isr.c:56: EA = 0;
                            784 ;     genAssign
   04CE C2 AF               785 	clr	_EA
                            786 ;src/lib/isr.c:57: _standard_interrupt_vector[vector_number] = LJMP_OPCODE;
                            787 ;     genPlus
                            788 ;	Peephole 236.g	used r2 instead of ar2
   04D0 EA                  789 	mov	a,r2
   04D1 24 00               790 	add	a,#__standard_interrupt_vector
   04D3 F5 82               791 	mov	dpl,a
                            792 ;	Peephole 181	changed mov to clr
   04D5 E4                  793 	clr	a
   04D6 34 00               794 	addc	a,#(__standard_interrupt_vector >> 8)
   04D8 F5 83               795 	mov	dph,a
                            796 ;     genPointerSet
                            797 ;     genFarPointerSet
   04DA 74 02               798 	mov	a,#0x02
   04DC F0                  799 	movx	@dptr,a
                            800 ;src/lib/isr.c:58: _standard_interrupt_vector[vector_number + 1] = addr >> 8;
                            801 ;     genCast
   04DD 7B 00               802 	mov	r3,#0x00
                            803 ;     genPlus
                            804 ;     genPlusIncr
   04DF 74 01               805 	mov	a,#0x01
                            806 ;	Peephole 236.a	used r2 instead of ar2
   04E1 2A                  807 	add	a,r2
   04E2 FC                  808 	mov	r4,a
                            809 ;	Peephole 181	changed mov to clr
   04E3 E4                  810 	clr	a
                            811 ;	Peephole 236.b	used r3 instead of ar3
   04E4 3B                  812 	addc	a,r3
   04E5 FD                  813 	mov	r5,a
                            814 ;     genPlus
                            815 ;	Peephole 236.g	used r4 instead of ar4
   04E6 EC                  816 	mov	a,r4
   04E7 24 00               817 	add	a,#__standard_interrupt_vector
   04E9 F5 82               818 	mov	dpl,a
                            819 ;	Peephole 236.g	used r5 instead of ar5
   04EB ED                  820 	mov	a,r5
   04EC 34 00               821 	addc	a,#(__standard_interrupt_vector >> 8)
   04EE F5 83               822 	mov	dph,a
                            823 ;     genRightShift
                            824 ;     genRightShiftLiteral
                            825 ;     genrshTwo
   04F0 AC 2C               826 	mov	r4,(_hook_sv_PARM_2 + 1)
   04F2 7D 00               827 	mov	r5,#0x00
                            828 ;     genCast
                            829 ;     genPointerSet
                            830 ;     genFarPointerSet
   04F4 EC                  831 	mov	a,r4
   04F5 F0                  832 	movx	@dptr,a
                            833 ;src/lib/isr.c:59: _standard_interrupt_vector[vector_number + 2] = addr & 0xff;
                            834 ;     genPlus
                            835 ;     genPlusIncr
   04F6 74 02               836 	mov	a,#0x02
                            837 ;	Peephole 236.a	used r2 instead of ar2
   04F8 2A                  838 	add	a,r2
   04F9 FA                  839 	mov	r2,a
                            840 ;	Peephole 181	changed mov to clr
   04FA E4                  841 	clr	a
                            842 ;	Peephole 236.b	used r3 instead of ar3
   04FB 3B                  843 	addc	a,r3
   04FC FB                  844 	mov	r3,a
                            845 ;     genPlus
                            846 ;	Peephole 236.g	used r2 instead of ar2
   04FD EA                  847 	mov	a,r2
   04FE 24 00               848 	add	a,#__standard_interrupt_vector
   0500 F5 82               849 	mov	dpl,a
                            850 ;	Peephole 236.g	used r3 instead of ar3
   0502 EB                  851 	mov	a,r3
   0503 34 00               852 	addc	a,#(__standard_interrupt_vector >> 8)
   0505 F5 83               853 	mov	dph,a
                            854 ;     genAnd
   0507 AA 2B               855 	mov	r2,_hook_sv_PARM_2
   0509 7B 00               856 	mov	r3,#0x00
                            857 ;     genCast
                            858 ;     genPointerSet
                            859 ;     genFarPointerSet
   050B EA                  860 	mov	a,r2
   050C F0                  861 	movx	@dptr,a
                            862 ;src/lib/isr.c:60: EA = t;
                            863 ;     genAssign
   050D A2 00               864 	mov	c,_hook_sv_t_1_1
   050F 92 AF               865 	mov	_EA,c
   0511                     866 00107$:
   0511 22                  867 	ret
                            868 ;------------------------------------------------------------
                            ...
                            873 ;------------------------------------------------------------
                            874 ;src/lib/isr.c:70: hook_uv (unsigned char vector_number, unsigned short addr)
                            875 ;	-----------------------------------------
                            876 ;	 function hook_uv
                            877 ;	-----------------------------------------
   0512                     878 _hook_uv:
                            879 ;     genReceive
   0512 AA 82               880 	mov	r2,dpl
                            881 ;src/lib/isr.c:76: if (vector_number < UV_MIN || vector_number > UV_MAX)
                            882 ;     genCmpLt
                            883 ;     genCmp
   0514 BA 00 00            884 	cjne	r2,#0x00,00110$
   0517                     885 00110$:
                            886 ;     genIfxJump
                            887 ;	Peephole 112.b	changed ljmp to sjmp
                            888 ;	Peephole 160	removed sjmp by inverse jump logic
   0517 40 05               889 	jc	00101$
   0519                     890 00111$:
                            891 ;     genCmpGt
                            892 ;     genCmp
                            893 ;     genIfxJump
   ...
   0519 EA                  896 	mov	a,r2
   051A 24 83               897 	add	a,#0xff - 0x7C
   051C 50 01               898 	jnc	00102$
   051E                     899 00112$:
   051E                     900 00101$:
                            901 ;src/lib/isr.c:77: return;
                            902 ;     genRet
                            903 ;	Peephole 112.b	changed ljmp to sjmp
                            904 ;	Peephole 251.b	replaced sjmp to ret with ret
   051E 22                  905 	ret
   051F                     906 00102$:
                            907 ;src/lib/isr.c:79: if ((vector_number & 0x3) != 0)
                            908 ;     genAnd
   051F 74 03               909 	mov	a,#0x03
   0521 5A                  910 	anl	a,r2
                            911 ;     genCmpEq
                            912 ;	Peephole 112.b	changed ljmp to sjmp
                            913 ;	Peephole 115.b	jump optimization
   0522 FB                  914 	mov	r3,a
   0523 60 01               915 	jz	00105$
   0525                     916 00113$:
                            917 ;src/lib/isr.c:80: return;
                            918 ;     genRet
                            919 ;	Peephole 112.b	changed ljmp to sjmp
                            920 ;	Peephole 251.b	replaced sjmp to ret with ret
   0525 22                  921 	ret
   0526                     922 00105$:
                            923 ;src/lib/isr.c:82: t = EA;
                            924 ;     genAssign
   0526 A2 AF               925 	mov	c,_EA
   0528 92 01               926 	mov	_hook_uv_t_1_1,c
                            927 ;src/lib/isr.c:83: EA = 0;
                            928 ;     genAssign
   052A C2 AF               929 	clr	_EA
                            930 ;src/lib/isr.c:84: _usb_autovector[vector_number] = LJMP_OPCODE;
                            931 ;     genPlus
                            932 ;	Peephole 236.g	used r2 instead of ar2
   052C EA                  933 	mov	a,r2
   052D 24 00               934 	add	a,#__usb_autovector
   052F F5 82               935 	mov	dpl,a
                            936 ;	Peephole 181	changed mov to clr
   0531 E4                  937 	clr	a
   0532 34 01               938 	addc	a,#(__usb_autovector >> 8)
   0534 F5 83               939 	mov	dph,a
                            940 ;     genPointerSet
                            941 ;     genFarPointerSet
   0536 74 02               942 	mov	a,#0x02
   0538 F0                  943 	movx	@dptr,a
                            944 ;src/lib/isr.c:85: _usb_autovector[vector_number + 1] = addr >> 8;
                            945 ;     genCast
   0539 7B 00               946 	mov	r3,#0x00
                            947 ;     genPlus
                            948 ;     genPlusIncr
   053B 74 01               949 	mov	a,#0x01
                            950 ;	Peephole 236.a	used r2 instead of ar2
   053D 2A                  951 	add	a,r2
   053E FC                  952 	mov	r4,a
                            953 ;	Peephole 181	changed mov to clr
   053F E4                  954 	clr	a
                            955 ;	Peephole 236.b	used r3 instead of ar3
   0540 3B                  956 	addc	a,r3
   0541 FD                  957 	mov	r5,a
                            958 ;     genPlus
                            959 ;	Peephole 236.g	used r4 instead of ar4
   0542 EC                  960 	mov	a,r4
   0543 24 00               961 	add	a,#__usb_autovector
   0545 F5 82               962 	mov	dpl,a
                            963 ;	Peephole 236.g	used r5 instead of ar5
   0547 ED                  964 	mov	a,r5
   0548 34 01               965 	addc	a,#(__usb_autovector >> 8)
   054A F5 83               966 	mov	dph,a
                            967 ;     genRightShift
                            968 ;     genRightShiftLiteral
                            969 ;     genrshTwo
   054C AC 2C               970 	mov	r4,(_hook_uv_PARM_2 + 1)
   054E 7D 00               971 	mov	r5,#0x00
                            972 ;     genCast
                            973 ;     genPointerSet
                            974 ;     genFarPointerSet
   0550 EC                  975 	mov	a,r4
   0551 F0                  976 	movx	@dptr,a
                            977 ;src/lib/isr.c:86: _usb_autovector[vector_number + 2] = addr & 0xff;
                            978 ;     genPlus
                            979 ;     genPlusIncr
   0552 74 02               980 	mov	a,#0x02
                            981 ;	Peephole 236.a	used r2 instead of ar2
   0554 2A                  982 	add	a,r2
   0555 FA                  983 	mov	r2,a
                            984 ;	Peephole 181	changed mov to clr
   0556 E4                  985 	clr	a
                            986 ;	Peephole 236.b	used r3 instead of ar3
   0557 3B                  987 	addc	a,r3
   0558 FB                  988 	mov	r3,a
                            989 ;     genPlus
                            990 ;	Peephole 236.g	used r2 instead of ar2
   0559 EA                  991 	mov	a,r2
   055A 24 00               992 	add	a,#__usb_autovector
   055C F5 82               993 	mov	dpl,a
                            994 ;	Peephole 236.g	used r3 instead of ar3
   055E EB                  995 	mov	a,r3
   055F 34 01               996 	addc	a,#(__usb_autovector >> 8)
   0561 F5 83               997 	mov	dph,a
                            998 ;     genAnd
   0563 AA 2B               999 	mov	r2,_hook_uv_PARM_2
   0565 7B 00              1000 	mov	r3,#0x00
                           1001 ;     genCast
                           1002 ;     genPointerSet
                           1003 ;     genFarPointerSet
   0567 EA                 1004 	mov	a,r2
   0568 F0                 1005 	movx	@dptr,a
                           1006 ;src/lib/isr.c:87: EA = t;
                           1007 ;     genAssign
   0569 A2 01              1008 	mov	c,_hook_uv_t_1_1
   056B 92 AF              1009 	mov	_EA,c
   056D                    1010 00106$:
   056D 22                 1011 	ret
                           1012 ;------------------------------------------------------------
                           ...
                           1017 ;------------------------------------------------------------
                           1018 ;src/lib/isr.c:97: hook_fgv (unsigned char vector_number, unsigned short addr)
                           1019 ;	-----------------------------------------
                           1020 ;	 function hook_fgv
                           1021 ;	-----------------------------------------
   056E                    1022 _hook_fgv:
                           1023 ;     genReceive
   056E AA 82              1024 	mov	r2,dpl
                           1025 ;src/lib/isr.c:103: if (vector_number < FGV_MIN || vector_number > FGV_MAX)
                           1026 ;     genCmpLt
                           1027 ;     genCmp
   0570 BA 80 00           1028 	cjne	r2,#0x80,00110$
   0573                    1029 00110$:
                           1030 ;     genIfxJump
                           1031 ;	Peephole 112.b	changed ljmp to sjmp
                           1032 ;	Peephole 160	removed sjmp by inverse jump logic
   0573 40 05              1033 	jc	00101$
   0575                    1034 00111$:
                           1035 ;     genCmpGt
                           1036 ;     genCmp
                           1037 ;     genIfxJump
   ...
   0575 EA                 1040 	mov	a,r2
   0576 24 4B              1041 	add	a,#0xff - 0xB4
   0578 50 01              1042 	jnc	00102$
   057A                    1043 00112$:
   057A                    1044 00101$:
                           1045 ;src/lib/isr.c:104: return;
                           1046 ;     genRet
                           1047 ;	Peephole 112.b	changed ljmp to sjmp
                           1048 ;	Peephole 251.b	replaced sjmp to ret with ret
   057A 22                 1049 	ret
   057B                    1050 00102$:
                           1051 ;src/lib/isr.c:106: if ((vector_number & 0x3) != 0)
                           1052 ;     genAnd
   057B 74 03              1053 	mov	a,#0x03
   057D 5A                 1054 	anl	a,r2
                           1055 ;     genCmpEq
                           1056 ;	Peephole 112.b	changed ljmp to sjmp
                           1057 ;	Peephole 115.b	jump optimization
   057E FB                 1058 	mov	r3,a
   057F 60 01              1059 	jz	00105$
   0581                    1060 00113$:
                           1061 ;src/lib/isr.c:107: return;
                           1062 ;     genRet
                           1063 ;	Peephole 112.b	changed ljmp to sjmp
                           1064 ;	Peephole 251.b	replaced sjmp to ret with ret
   0581 22                 1065 	ret
   0582                    1066 00105$:
                           1067 ;src/lib/isr.c:109: t = EA;
                           1068 ;     genAssign
   0582 A2 AF              1069 	mov	c,_EA
   0584 92 02              1070 	mov	_hook_fgv_t_1_1,c
                           1071 ;src/lib/isr.c:110: EA = 0;
                           1072 ;     genAssign
   0586 C2 AF              1073 	clr	_EA
                           1074 ;src/lib/isr.c:111: _fifo_gpif_autovector[vector_number] = LJMP_OPCODE;
                           1075 ;     genPlus
                           1076 ;	Peephole 236.g	used r2 instead of ar2
   0588 EA                 1077 	mov	a,r2
   0589 24 80              1078 	add	a,#__fifo_gpif_autovector
   058B F5 82              1079 	mov	dpl,a
                           1080 ;	Peephole 181	changed mov to clr
   058D E4                 1081 	clr	a
   058E 34 00              1082 	addc	a,#(__fifo_gpif_autovector >> 8)
   0590 F5 83              1083 	mov	dph,a
                           1084 ;     genPointerSet
                           1085 ;     genFarPointerSet
   0592 74 02              1086 	mov	a,#0x02
   0594 F0                 1087 	movx	@dptr,a
                           1088 ;src/lib/isr.c:112: _fifo_gpif_autovector[vector_number + 1] = addr >> 8;
                           1089 ;     genCast
   0595 7B 00              1090 	mov	r3,#0x00
                           1091 ;     genPlus
                           1092 ;     genPlusIncr
   0597 74 01              1093 	mov	a,#0x01
                           1094 ;	Peephole 236.a	used r2 instead of ar2
   0599 2A                 1095 	add	a,r2
   059A FC                 1096 	mov	r4,a
                           1097 ;	Peephole 181	changed mov to clr
   059B E4                 1098 	clr	a
                           1099 ;	Peephole 236.b	used r3 instead of ar3
   059C 3B                 1100 	addc	a,r3
   059D FD                 1101 	mov	r5,a
                           1102 ;     genPlus
                           1103 ;	Peephole 236.g	used r4 instead of ar4
   059E EC                 1104 	mov	a,r4
   059F 24 80              1105 	add	a,#__fifo_gpif_autovector
   05A1 F5 82              1106 	mov	dpl,a
                           1107 ;	Peephole 236.g	used r5 instead of ar5
   05A3 ED                 1108 	mov	a,r5
   05A4 34 00              1109 	addc	a,#(__fifo_gpif_autovector >> 8)
   05A6 F5 83              1110 	mov	dph,a
                           1111 ;     genRightShift
                           1112 ;     genRightShiftLiteral
                           1113 ;     genrshTwo
   05A8 AC 2C              1114 	mov	r4,(_hook_fgv_PARM_2 + 1)
   05AA 7D 00              1115 	mov	r5,#0x00
                           1116 ;     genCast
                           1117 ;     genPointerSet
                           1118 ;     genFarPointerSet
   05AC EC                 1119 	mov	a,r4
   05AD F0                 1120 	movx	@dptr,a
                           1121 ;src/lib/isr.c:113: _fifo_gpif_autovector[vector_number + 2] = addr & 0xff;
                           1122 ;     genPlus
                           1123 ;     genPlusIncr
   05AE 74 02              1124 	mov	a,#0x02
                           1125 ;	Peephole 236.a	used r2 instead of ar2
   05B0 2A                 1126 	add	a,r2
   05B1 FA                 1127 	mov	r2,a
                           1128 ;	Peephole 181	changed mov to clr
   05B2 E4                 1129 	clr	a
                           1130 ;	Peephole 236.b	used r3 instead of ar3
   05B3 3B                 1131 	addc	a,r3
   05B4 FB                 1132 	mov	r3,a
                           1133 ;     genPlus
                           1134 ;	Peephole 236.g	used r2 instead of ar2
   05B5 EA                 1135 	mov	a,r2
   05B6 24 80              1136 	add	a,#__fifo_gpif_autovector
   05B8 F5 82              1137 	mov	dpl,a
                           1138 ;	Peephole 236.g	used r3 instead of ar3
   05BA EB                 1139 	mov	a,r3
   05BB 34 00              1140 	addc	a,#(__fifo_gpif_autovector >> 8)
   05BD F5 83              1141 	mov	dph,a
                           1142 ;     genAnd
   05BF AA 2B              1143 	mov	r2,_hook_fgv_PARM_2
   05C1 7B 00              1144 	mov	r3,#0x00
                           1145 ;     genCast
                           1146 ;     genPointerSet
                           1147 ;     genFarPointerSet
   05C3 EA                 1148 	mov	a,r2
   05C4 F0                 1149 	movx	@dptr,a
                           1150 ;src/lib/isr.c:114: EA = t;
                           1151 ;     genAssign
   05C5 A2 02              1152 	mov	c,_hook_fgv_t_1_1
   05C7 92 AF              1153 	mov	_EA,c
   05C9                    1154 00106$:
   05C9 22                 1155 	ret
                           1156 ;------------------------------------------------------------
                           ...
                           1158 ;------------------------------------------------------------
                           1159 ;------------------------------------------------------------
                           1160 ;src/lib/isr.c:125: setup_autovectors (void)
                           1161 ;	-----------------------------------------
                           1162 ;	 function setup_autovectors
                           1163 ;	-----------------------------------------
   05CA                    1164 _setup_autovectors:
                           1165 ;src/lib/isr.c:128: EIUSB = 0;
                           1166 ;     genAssign
   05CA C2 E8              1167 	clr	_EIUSB
                           1168 ;src/lib/isr.c:129: EIEX4 = 0;
                           1169 ;     genAssign
   05CC C2 EA              1170 	clr	_EIEX4
                           1171 ;src/lib/isr.c:131: hook_sv (SV_INT_2, (unsigned short) _usb_autovector);
                           1172 ;     genCast
   05CE 75 2B 00           1173 	mov	_hook_sv_PARM_2,#__usb_autovector
   05D1 75 2C 01           1174 	mov	(_hook_sv_PARM_2 + 1),#(__usb_autovector >> 8)
                           1175 ;     genCall
   05D4 75 82 43           1176 	mov	dpl,#0x43
   05D7 12 04 AD           1177 	lcall	_hook_sv
                           1178 ;src/lib/isr.c:132: hook_sv (SV_INT_4, (unsigned short) _fifo_gpif_autovector);
                           1179 ;     genCast
   05DA 75 2B 80           1180 	mov	_hook_sv_PARM_2,#__fifo_gpif_autovector
   05DD 75 2C 00           1181 	mov	(_hook_sv_PARM_2 + 1),#(__fifo_gpif_autovector >> 8)
                           1182 ;     genCall
   05E0 75 82 53           1183 	mov	dpl,#0x53
   05E3 12 04 AD           1184 	lcall	_hook_sv
                           1185 ;src/lib/isr.c:135: SYNCDELAY;
                           1186 ;     genInline
   05E6 00                 1187 	 nop; nop; nop; 
                           1188 ;src/lib/isr.c:136: EP2FIFOIE = 0;	SYNCDELAY;
                           1189 ;     genAssign
   05E7 90 E6 50           1190 	mov	dptr,#_EP2FIFOIE
                           1191 ;	Peephole 181	changed mov to clr
   05EA E4                 1192 	clr	a
   05EB F0                 1193 	movx	@dptr,a
                           1194 ;     genInline
   05EC 00                 1195 	 nop; nop; nop; 
                           1196 ;src/lib/isr.c:137: EP4FIFOIE = 0;	SYNCDELAY;
                           1197 ;     genAssign
   05ED 90 E6 52           1198 	mov	dptr,#_EP4FIFOIE
                           1199 ;	Peephole 181	changed mov to clr
   05F0 E4                 1200 	clr	a
   05F1 F0                 1201 	movx	@dptr,a
                           1202 ;     genInline
   05F2 00                 1203 	 nop; nop; nop; 
                           1204 ;src/lib/isr.c:138: EP6FIFOIE = 0;	SYNCDELAY;
                           1205 ;     genAssign
   05F3 90 E6 54           1206 	mov	dptr,#_EP6FIFOIE
                           1207 ;	Peephole 181	changed mov to clr
   05F6 E4                 1208 	clr	a
   05F7 F0                 1209 	movx	@dptr,a
                           1210 ;     genInline
   05F8 00                 1211 	 nop; nop; nop; 
                           1212 ;src/lib/isr.c:139: EP8FIFOIE = 0;	SYNCDELAY;
                           1213 ;     genAssign
   05F9 90 E6 56           1214 	mov	dptr,#_EP8FIFOIE
                           1215 ;	Peephole 181	changed mov to clr
   05FC E4                 1216 	clr	a
   05FD F0                 1217 	movx	@dptr,a
                           1218 ;     genInline
   05FE 00                 1219 	 nop; nop; nop; 
                           1220 ;src/lib/isr.c:142: EP2FIFOIRQ = 0xff;	SYNCDELAY;
                           1221 ;     genAssign
   05FF 90 E6 51           1222 	mov	dptr,#_EP2FIFOIRQ
   0602 74 FF              1223 	mov	a,#0xFF
   0604 F0                 1224 	movx	@dptr,a
                           1225 ;     genInline
   0605 00                 1226 	 nop; nop; nop; 
                           1227 ;src/lib/isr.c:143: EP4FIFOIRQ = 0xff;	SYNCDELAY;
                           1228 ;     genAssign
   0606 90 E6 53           1229 	mov	dptr,#_EP4FIFOIRQ
   0609 74 FF              1230 	mov	a,#0xFF
   060B F0                 1231 	movx	@dptr,a
                           1232 ;     genInline
   060C 00                 1233 	 nop; nop; nop; 
                           1234 ;src/lib/isr.c:144: EP6FIFOIRQ = 0xff;	SYNCDELAY;
                           1235 ;     genAssign
   060D 90 E6 55           1236 	mov	dptr,#_EP6FIFOIRQ
   0610 74 FF              1237 	mov	a,#0xFF
   0612 F0                 1238 	movx	@dptr,a
                           1239 ;     genInline
   0613 00                 1240 	 nop; nop; nop; 
                           1241 ;src/lib/isr.c:145: EP8FIFOIRQ = 0xff;	SYNCDELAY;
                           1242 ;     genAssign
   0614 90 E6 57           1243 	mov	dptr,#_EP8FIFOIRQ
   0617 74 FF              1244 	mov	a,#0xFF
   0619 F0                 1245 	movx	@dptr,a
                           1246 ;     genInline
   061A 00                 1247 	 nop; nop; nop; 
                           1248 ;src/lib/isr.c:147: IBNIE  = 0;
                           1249 ;     genAssign
   061B 90 E6 58           1250 	mov	dptr,#_IBNIE
                           1251 ;	Peephole 181	changed mov to clr
   061E E4                 1252 	clr	a
   061F F0                 1253 	movx	@dptr,a
                           1254 ;src/lib/isr.c:148: IBNIRQ = 0xff;
                           1255 ;     genAssign
   0620 90 E6 59           1256 	mov	dptr,#_IBNIRQ
   0623 74 FF              1257 	mov	a,#0xFF
   0625 F0                 1258 	movx	@dptr,a
                           1259 ;src/lib/isr.c:149: NAKIE  = 0;
                           1260 ;     genAssign
   0626 90 E6 5A           1261 	mov	dptr,#_NAKIE
                           1262 ;	Peephole 181	changed mov to clr
   0629 E4                 1263 	clr	a
   062A F0                 1264 	movx	@dptr,a
                           1265 ;src/lib/isr.c:150: NAKIRQ = 0xff;
                           1266 ;     genAssign
   062B 90 E6 5B           1267 	mov	dptr,#_NAKIRQ
   062E 74 FF              1268 	mov	a,#0xFF
   0630 F0                 1269 	movx	@dptr,a
                           1270 ;src/lib/isr.c:151: USBIE  = 0;
                           1271 ;     genAssign
   0631 90 E6 5C           1272 	mov	dptr,#_USBIE
                           1273 ;	Peephole 181	changed mov to clr
   0634 E4                 1274 	clr	a
   0635 F0                 1275 	movx	@dptr,a
                           1276 ;src/lib/isr.c:152: USBIRQ = 0xff;
                           1277 ;     genAssign
   0636 90 E6 5D           1278 	mov	dptr,#_USBIRQ
   0639 74 FF              1279 	mov	a,#0xFF
   063B F0                 1280 	movx	@dptr,a
                           1281 ;src/lib/isr.c:153: EPIE   = 0;
                           1282 ;     genAssign
   063C 90 E6 5E           1283 	mov	dptr,#_EPIE
                           1284 ;	Peephole 181	changed mov to clr
   063F E4                 1285 	clr	a
   0640 F0                 1286 	movx	@dptr,a
                           1287 ;src/lib/isr.c:154: EPIRQ  = 0xff;
                           1288 ;     genAssign
   0641 90 E6 5F           1289 	mov	dptr,#_EPIRQ
   0644 74 FF              1290 	mov	a,#0xFF
   0646 F0                 1291 	movx	@dptr,a
                           1292 ;src/lib/isr.c:155: SYNCDELAY;	GPIFIE = 0;
                           1293 ;     genInline
   0647 00                 1294 	 nop; nop; nop; 
                           1295 ;     genAssign
   0648 90 E6 60           1296 	mov	dptr,#_GPIFIE
                           1297 ;	Peephole 181	changed mov to clr
   064B E4                 1298 	clr	a
   064C F0                 1299 	movx	@dptr,a
                           1300 ;src/lib/isr.c:156: SYNCDELAY;	GPIFIRQ = 0xff;
                           1301 ;     genInline
   064D 00                 1302 	 nop; nop; nop; 
                           1303 ;     genAssign
   064E 90 E6 61           1304 	mov	dptr,#_GPIFIRQ
   0651 74 FF              1305 	mov	a,#0xFF
   0653 F0                 1306 	movx	@dptr,a
                           1307 ;src/lib/isr.c:157: USBERRIE = 0;
                           1308 ;     genAssign
   0654 90 E6 62           1309 	mov	dptr,#_USBERRIE
                           1310 ;	Peephole 181	changed mov to clr
   0657 E4                 1311 	clr	a
   0658 F0                 1312 	movx	@dptr,a
                           1313 ;src/lib/isr.c:158: USBERRIRQ = 0xff;
                           1314 ;     genAssign
   0659 90 E6 63           1315 	mov	dptr,#_USBERRIRQ
   065C 74 FF              1316 	mov	a,#0xFF
   065E F0                 1317 	movx	@dptr,a
                           1318 ;src/lib/isr.c:159: CLRERRCNT = 0;
                           1319 ;     genAssign
   065F 90 E6 65           1320 	mov	dptr,#_CLRERRCNT
                           1321 ;	Peephole 181	changed mov to clr
   0662 E4                 1322 	clr	a
   0663 F0                 1323 	movx	@dptr,a
                           1324 ;src/lib/isr.c:161: INTSETUP = bmAV2EN | bmAV4EN | bmINT4IN;
                           1325 ;     genAssign
   0664 90 E6 68           1326 	mov	dptr,#_INTSETUP
   0667 74 0B              1327 	mov	a,#0x0B
   0669 F0                 1328 	movx	@dptr,a
                           1329 ;src/lib/isr.c:164: EXIF &= ~bmEXIF_USBINT;
                           1330 ;     genAnd
                           1331 ;src/lib/isr.c:165: EXIF &= ~bmEXIF_IE4;
                           1332 ;     genAnd
                           1333 ;	Peephole 183	avoided anl during execution
   066A 53 91 AF           1334 	anl	_EXIF,#(0xEF & 0xBF)
                           1335 ;src/lib/isr.c:168: EIUSB = 1;
                           1336 ;     genAssign
   066D D2 E8              1337 	setb	_EIUSB
                           1338 ;src/lib/isr.c:169: EIEX4 = 1;
                           1339 ;     genAssign
   066F D2 EA              1340 	setb	_EIEX4
   0671                    1341 00101$:
   0671 22                 1342 	ret
                           1343 	.area CSEG    (CODE)
