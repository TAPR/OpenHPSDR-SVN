...
DttSP_EXP extern ResStF newPolyPhaseFIRF (int filterMemoryBuffLength,
					  int indexfiltMemBuf,
					  int interpFactor,
					  int filterPhaseNum, int deciFactor);
DttSP_EXP extern void PolyPhaseFIRF (ResStF resst);
DttSP_EXP extern void delpolyPhaseFIRF (ResStF resst);
#endif
