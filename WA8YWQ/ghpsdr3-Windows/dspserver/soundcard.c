...
/** 
* @brief Set soundcard
* Set appropriate values for  multimeterCalibrationOffset  and  displayCalibrationOffset,
* depending on which sound card is being used.
* @param card
*/
...
/** 
* @brief Get soundcard
* Return an integer corresponding to the (string) name of the sound card being used
* @param name
* 
* @return 
*/
