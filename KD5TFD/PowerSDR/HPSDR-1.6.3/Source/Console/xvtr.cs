...
namespace PowerSDR
{
	public class XVTRForm : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.CheckBoxTS chkHideTuneStep;
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(XVTRForm));
			...
			this.chkHideTuneStep = new System.Windows.Forms.CheckBoxTS();
			...
			this.txtBandButton0.TabIndex = 3;
			...
			this.txtBandButton1.TabIndex = 4;
			...
			this.txtBandButton2.TabIndex = 5;
			...
			this.txtBandButton3.TabIndex = 6;
			...
			this.txtBandButton4.TabIndex = 7;
			...
			this.txtBandButton5.TabIndex = 8;
			...
			this.txtBandButton6.TabIndex = 9;
			...
			this.txtBandButton7.TabIndex = 10;
			...
			this.txtBandButton8.TabIndex = 11;
			...
			this.txtBandButton9.TabIndex = 12;
			...
			this.txtBandButton10.TabIndex = 13;
			...
			this.txtBandButton11.TabIndex = 14;
			...
			this.txtBandButton12.TabIndex = 15;
			...
			this.txtBandButton13.TabIndex = 16;
			...
			this.txtBandButton14.TabIndex = 17;
			this.txtBandButton14.Text = "";
			...
			this.txtBandButton15.TabIndex = 18;
			this.txtBandButton15.Text = "";
			...
			this.udUCBAddr0.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udUCBAddr0.Location = new System.Drawing.Point(160, 48);
			this.udUCBAddr0.Maximum = new System.Decimal(new int[] {
																	   15,
																	   0,
																	   0,
																	   0});
			this.udUCBAddr0.Minimum = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udUCBAddr0.TabIndex = 19;
			this.udUCBAddr0.Value = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udUCBAddr1.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udUCBAddr1.Location = new System.Drawing.Point(160, 72);
			this.udUCBAddr1.Maximum = new System.Decimal(new int[] {
																	   15,
																	   0,
																	   0,
																	   0});
			this.udUCBAddr1.Minimum = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udUCBAddr1.TabIndex = 20;
			this.udUCBAddr1.Value = new System.Decimal(new int[] {
																	 1,
																	 0,
																	 0,
																	 0});
			...
			this.udUCBAddr2.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udUCBAddr2.Location = new System.Drawing.Point(160, 96);
			this.udUCBAddr2.Maximum = new System.Decimal(new int[] {
																	   15,
																	   0,
																	   0,
																	   0});
			this.udUCBAddr2.Minimum = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udUCBAddr2.TabIndex = 21;
			this.udUCBAddr2.Value = new System.Decimal(new int[] {
																	 2,
																	 0,
																	 0,
																	 0});
			...
			this.udUCBAddr3.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udUCBAddr3.Location = new System.Drawing.Point(160, 120);
			this.udUCBAddr3.Maximum = new System.Decimal(new int[] {
																	   15,
																	   0,
																	   0,
																	   0});
			this.udUCBAddr3.Minimum = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udUCBAddr3.TabIndex = 22;
			this.udUCBAddr3.Value = new System.Decimal(new int[] {
																	 3,
																	 0,
																	 0,
																	 0});
			...
			this.udUCBAddr4.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udUCBAddr4.Location = new System.Drawing.Point(160, 144);
			this.udUCBAddr4.Maximum = new System.Decimal(new int[] {
																	   15,
																	   0,
																	   0,
																	   0});
			this.udUCBAddr4.Minimum = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udUCBAddr4.TabIndex = 23;
			this.udUCBAddr4.Value = new System.Decimal(new int[] {
																	 4,
																	 0,
																	 0,
																	 0});
			...
			this.udUCBAddr5.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udUCBAddr5.Location = new System.Drawing.Point(160, 168);
			this.udUCBAddr5.Maximum = new System.Decimal(new int[] {
																	   15,
																	   0,
																	   0,
																	   0});
			this.udUCBAddr5.Minimum = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udUCBAddr5.TabIndex = 24;
			this.udUCBAddr5.Value = new System.Decimal(new int[] {
																	 5,
																	 0,
																	 0,
																	 0});
			...
			this.udUCBAddr6.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udUCBAddr6.Location = new System.Drawing.Point(160, 192);
			this.udUCBAddr6.Maximum = new System.Decimal(new int[] {
																	   15,
																	   0,
																	   0,
																	   0});
			this.udUCBAddr6.Minimum = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udUCBAddr6.TabIndex = 25;
			this.udUCBAddr6.Value = new System.Decimal(new int[] {
																	 6,
																	 0,
																	 0,
																	 0});
			...
			this.udUCBAddr7.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udUCBAddr7.Location = new System.Drawing.Point(160, 216);
			this.udUCBAddr7.Maximum = new System.Decimal(new int[] {
																	   15,
																	   0,
																	   0,
																	   0});
			this.udUCBAddr7.Minimum = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udUCBAddr7.TabIndex = 26;
			this.udUCBAddr7.Value = new System.Decimal(new int[] {
																	 7,
																	 0,
																	 0,
																	 0});
			...
			this.udUCBAddr8.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udUCBAddr8.Location = new System.Drawing.Point(160, 240);
			this.udUCBAddr8.Maximum = new System.Decimal(new int[] {
																	   15,
																	   0,
																	   0,
																	   0});
			this.udUCBAddr8.Minimum = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udUCBAddr8.TabIndex = 27;
			this.udUCBAddr8.Value = new System.Decimal(new int[] {
																	 8,
																	 0,
																	 0,
																	 0});
			...
			this.udUCBAddr9.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udUCBAddr9.Location = new System.Drawing.Point(160, 264);
			this.udUCBAddr9.Maximum = new System.Decimal(new int[] {
																	   15,
																	   0,
																	   0,
																	   0});
			this.udUCBAddr9.Minimum = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udUCBAddr9.TabIndex = 28;
			this.udUCBAddr9.Value = new System.Decimal(new int[] {
																	 9,
																	 0,
																	 0,
																	 0});
			...
			this.udUCBAddr10.Increment = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			this.udUCBAddr10.Location = new System.Drawing.Point(160, 288);
			this.udUCBAddr10.Maximum = new System.Decimal(new int[] {
																		15,
																		0,
																		0,
																		0});
			this.udUCBAddr10.Minimum = new System.Decimal(new int[] {
																		0,
																		0,
																		0,
																		0});
			...
			this.udUCBAddr10.TabIndex = 29;
			this.udUCBAddr10.Value = new System.Decimal(new int[] {
																	  10,
																	  0,
																	  0,
																	  0});
			...
			this.udUCBAddr11.Increment = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			this.udUCBAddr11.Location = new System.Drawing.Point(160, 312);
			this.udUCBAddr11.Maximum = new System.Decimal(new int[] {
																		15,
																		0,
																		0,
																		0});
			this.udUCBAddr11.Minimum = new System.Decimal(new int[] {
																		0,
																		0,
																		0,
																		0});
			...
			this.udUCBAddr11.TabIndex = 30;
			this.udUCBAddr11.Value = new System.Decimal(new int[] {
																	  11,
																	  0,
																	  0,
																	  0});
			...
			this.udUCBAddr12.Increment = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			this.udUCBAddr12.Location = new System.Drawing.Point(160, 336);
			this.udUCBAddr12.Maximum = new System.Decimal(new int[] {
																		15,
																		0,
																		0,
																		0});
			this.udUCBAddr12.Minimum = new System.Decimal(new int[] {
																		0,
																		0,
																		0,
																		0});
			...
			this.udUCBAddr12.TabIndex = 31;
			this.udUCBAddr12.Value = new System.Decimal(new int[] {
																	  12,
																	  0,
																	  0,
																	  0});
			...
			this.udUCBAddr13.Increment = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			this.udUCBAddr13.Location = new System.Drawing.Point(160, 360);
			this.udUCBAddr13.Maximum = new System.Decimal(new int[] {
																		15,
																		0,
																		0,
																		0});
			this.udUCBAddr13.Minimum = new System.Decimal(new int[] {
																		0,
																		0,
																		0,
																		0});
			...
			this.udUCBAddr13.TabIndex = 32;
			this.udUCBAddr13.Value = new System.Decimal(new int[] {
																	  13,
																	  0,
																	  0,
																	  0});
			...
			this.udUCBAddr14.Increment = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			this.udUCBAddr14.Location = new System.Drawing.Point(160, 384);
			this.udUCBAddr14.Maximum = new System.Decimal(new int[] {
																		15,
																		0,
																		0,
																		0});
			this.udUCBAddr14.Minimum = new System.Decimal(new int[] {
																		0,
																		0,
																		0,
																		0});
			...
			this.udUCBAddr14.TabIndex = 33;
			this.udUCBAddr14.Value = new System.Decimal(new int[] {
																	  14,
																	  0,
																	  0,
																	  0});
			...
			this.udUCBAddr15.Increment = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			this.udUCBAddr15.Location = new System.Drawing.Point(160, 408);
			this.udUCBAddr15.Maximum = new System.Decimal(new int[] {
																		15,
																		0,
																		0,
																		0});
			this.udUCBAddr15.Minimum = new System.Decimal(new int[] {
																		0,
																		0,
																		0,
																		0});
			...
			this.udUCBAddr15.TabIndex = 34;
			this.udUCBAddr15.Value = new System.Decimal(new int[] {
																	  15,
																	  0,
																	  0,
																	  0});
			...
			this.chkEnable0.TabIndex = 35;
			this.chkEnable0.Text = "checkBox1";
			...
			this.chkEnable1.TabIndex = 36;
			this.chkEnable1.Text = "checkBox2";
			...
			this.chkEnable2.TabIndex = 37;
			this.chkEnable2.Text = "checkBox3";
			...
			this.chkEnable3.TabIndex = 38;
			this.chkEnable3.Text = "checkBox4";
			...
			this.chkEnable4.TabIndex = 39;
			this.chkEnable4.Text = "checkBox5";
			...
			this.chkEnable5.TabIndex = 40;
			this.chkEnable5.Text = "checkBox6";
			...
			this.chkEnable6.TabIndex = 41;
			this.chkEnable6.Text = "checkBox7";
			...
			this.chkEnable7.TabIndex = 42;
			this.chkEnable7.Text = "checkBox8";
			...
			this.chkEnable8.TabIndex = 43;
			this.chkEnable8.Text = "checkBox9";
			...
			this.chkEnable9.TabIndex = 44;
			this.chkEnable9.Text = "checkBox10";
			...
			this.chkEnable10.TabIndex = 45;
			this.chkEnable10.Text = "checkBox11";
			...
			this.chkEnable11.TabIndex = 46;
			this.chkEnable11.Text = "checkBox12";
			...
			this.chkEnable12.TabIndex = 47;
			this.chkEnable12.Text = "checkBox13";
			...
			this.chkEnable13.TabIndex = 48;
			this.chkEnable13.Text = "checkBox14";
			...
			this.chkEnable14.TabIndex = 49;
			this.chkEnable14.Text = "checkBox15";
			...
			this.chkEnable15.TabIndex = 50;
			this.chkEnable15.Text = "checkBox16";
			...
			this.txtButtonText15.TabIndex = 67;
			this.txtButtonText15.Text = "";
			...
			this.txtButtonText14.TabIndex = 66;
			this.txtButtonText14.Text = "";
			...
			this.txtButtonText13.TabIndex = 65;
			...
			this.txtButtonText12.TabIndex = 64;
			...
			this.txtButtonText11.TabIndex = 63;
			...
			this.txtButtonText10.TabIndex = 62;
			...
			this.txtButtonText9.TabIndex = 61;
			...
			this.txtButtonText8.TabIndex = 60;
			...
			this.txtButtonText7.TabIndex = 59;
			...
			this.txtButtonText6.TabIndex = 58;
			...
			this.txtButtonText5.TabIndex = 57;
			...
			this.txtButtonText4.TabIndex = 56;
			...
			this.txtButtonText3.TabIndex = 55;
			...
			this.txtButtonText2.TabIndex = 54;
			...
			this.txtButtonText1.TabIndex = 53;
			...
			this.txtButtonText0.TabIndex = 52;
			...
			this.udLOOffset15.Increment = new System.Decimal(new int[] {
																		   1,
																		   0,
																		   0,
																		   0});
			this.udLOOffset15.Location = new System.Drawing.Point(304, 408);
			this.udLOOffset15.Maximum = new System.Decimal(new int[] {
																		 50000,
																		 0,
																		 0,
																		 0});
			this.udLOOffset15.Minimum = new System.Decimal(new int[] {
																		 144,
																		 0,
																		 0,
																		 -2147483648});
			...
			this.udLOOffset15.TabIndex = 84;
			this.udLOOffset15.Value = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udLOOffset14.Increment = new System.Decimal(new int[] {
																		   1,
																		   0,
																		   0,
																		   0});
			this.udLOOffset14.Location = new System.Drawing.Point(304, 384);
			this.udLOOffset14.Maximum = new System.Decimal(new int[] {
																		 50000,
																		 0,
																		 0,
																		 0});
			this.udLOOffset14.Minimum = new System.Decimal(new int[] {
																		 144,
																		 0,
																		 0,
																		 -2147483648});
			...
			this.udLOOffset14.TabIndex = 83;
			this.udLOOffset14.Value = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udLOOffset13.Increment = new System.Decimal(new int[] {
																		   1,
																		   0,
																		   0,
																		   0});
			this.udLOOffset13.Location = new System.Drawing.Point(304, 360);
			this.udLOOffset13.Maximum = new System.Decimal(new int[] {
																		 50000,
																		 0,
																		 0,
																		 0});
			this.udLOOffset13.Minimum = new System.Decimal(new int[] {
																		 144,
																		 0,
																		 0,
																		 -2147483648});
			...
			this.udLOOffset13.TabIndex = 82;
			this.udLOOffset13.Value = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udLOOffset12.Increment = new System.Decimal(new int[] {
																		   1,
																		   0,
																		   0,
																		   0});
			this.udLOOffset12.Location = new System.Drawing.Point(304, 336);
			this.udLOOffset12.Maximum = new System.Decimal(new int[] {
																		 50000,
																		 0,
																		 0,
																		 0});
			this.udLOOffset12.Minimum = new System.Decimal(new int[] {
																		 144,
																		 0,
																		 0,
																		 -2147483648});
			...
			this.udLOOffset12.TabIndex = 81;
			this.udLOOffset12.Value = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udLOOffset11.Increment = new System.Decimal(new int[] {
																		   1,
																		   0,
																		   0,
																		   0});
			this.udLOOffset11.Location = new System.Drawing.Point(304, 312);
			this.udLOOffset11.Maximum = new System.Decimal(new int[] {
																		 50000,
																		 0,
																		 0,
																		 0});
			this.udLOOffset11.Minimum = new System.Decimal(new int[] {
																		 144,
																		 0,
																		 0,
																		 -2147483648});
			...
			this.udLOOffset11.TabIndex = 80;
			this.udLOOffset11.Value = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udLOOffset10.Increment = new System.Decimal(new int[] {
																		   1,
																		   0,
																		   0,
																		   0});
			this.udLOOffset10.Location = new System.Drawing.Point(304, 288);
			this.udLOOffset10.Maximum = new System.Decimal(new int[] {
																		 50000,
																		 0,
																		 0,
																		 0});
			this.udLOOffset10.Minimum = new System.Decimal(new int[] {
																		 144,
																		 0,
																		 0,
																		 -2147483648});
			...
			this.udLOOffset10.TabIndex = 79;
			this.udLOOffset10.Value = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udLOOffset9.Increment = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			this.udLOOffset9.Location = new System.Drawing.Point(304, 264);
			this.udLOOffset9.Maximum = new System.Decimal(new int[] {
																		50000,
																		0,
																		0,
																		0});
			this.udLOOffset9.Minimum = new System.Decimal(new int[] {
																		144,
																		0,
																		0,
																		-2147483648});
			...
			this.udLOOffset9.TabIndex = 78;
			this.udLOOffset9.Value = new System.Decimal(new int[] {
																	  0,
																	  0,
																	  0,
																	  0});
			...
			this.udLOOffset8.Increment = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			this.udLOOffset8.Location = new System.Drawing.Point(304, 240);
			this.udLOOffset8.Maximum = new System.Decimal(new int[] {
																		50000,
																		0,
																		0,
																		0});
			this.udLOOffset8.Minimum = new System.Decimal(new int[] {
																		144,
																		0,
																		0,
																		-2147483648});
			...
			this.udLOOffset8.TabIndex = 77;
			this.udLOOffset8.Value = new System.Decimal(new int[] {
																	  0,
																	  0,
																	  0,
																	  0});
			...
			this.udLOOffset7.Increment = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			this.udLOOffset7.Location = new System.Drawing.Point(304, 216);
			this.udLOOffset7.Maximum = new System.Decimal(new int[] {
																		50000,
																		0,
																		0,
																		0});
			this.udLOOffset7.Minimum = new System.Decimal(new int[] {
																		144,
																		0,
																		0,
																		-2147483648});
			...
			this.udLOOffset7.TabIndex = 76;
			this.udLOOffset7.Value = new System.Decimal(new int[] {
																	  0,
																	  0,
																	  0,
																	  0});
			...
			this.udLOOffset6.Increment = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			this.udLOOffset6.Location = new System.Drawing.Point(304, 192);
			this.udLOOffset6.Maximum = new System.Decimal(new int[] {
																		50000,
																		0,
																		0,
																		0});
			this.udLOOffset6.Minimum = new System.Decimal(new int[] {
																		144,
																		0,
																		0,
																		-2147483648});
			...
			this.udLOOffset6.TabIndex = 75;
			this.udLOOffset6.Value = new System.Decimal(new int[] {
																	  0,
																	  0,
																	  0,
																	  0});
			...
			this.udLOOffset5.Increment = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			this.udLOOffset5.Location = new System.Drawing.Point(304, 168);
			this.udLOOffset5.Maximum = new System.Decimal(new int[] {
																		50000,
																		0,
																		0,
																		0});
			this.udLOOffset5.Minimum = new System.Decimal(new int[] {
																		144,
																		0,
																		0,
																		-2147483648});
			...
			this.udLOOffset5.TabIndex = 74;
			this.udLOOffset5.Value = new System.Decimal(new int[] {
																	  0,
																	  0,
																	  0,
																	  0});
			...
			this.udLOOffset4.Increment = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			this.udLOOffset4.Location = new System.Drawing.Point(304, 144);
			this.udLOOffset4.Maximum = new System.Decimal(new int[] {
																		50000,
																		0,
																		0,
																		0});
			this.udLOOffset4.Minimum = new System.Decimal(new int[] {
																		144,
																		0,
																		0,
																		-2147483648});
			...
			this.udLOOffset4.TabIndex = 73;
			this.udLOOffset4.Value = new System.Decimal(new int[] {
																	  0,
																	  0,
																	  0,
																	  0});
			...
			this.udLOOffset3.Increment = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			this.udLOOffset3.Location = new System.Drawing.Point(304, 120);
			this.udLOOffset3.Maximum = new System.Decimal(new int[] {
																		50000,
																		0,
																		0,
																		0});
			this.udLOOffset3.Minimum = new System.Decimal(new int[] {
																		144,
																		0,
																		0,
																		-2147483648});
			...
			this.udLOOffset3.TabIndex = 72;
			this.udLOOffset3.Value = new System.Decimal(new int[] {
																	  0,
																	  0,
																	  0,
																	  0});
			...
			this.udLOOffset2.Increment = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			this.udLOOffset2.Location = new System.Drawing.Point(304, 96);
			this.udLOOffset2.Maximum = new System.Decimal(new int[] {
																		50000,
																		0,
																		0,
																		0});
			this.udLOOffset2.Minimum = new System.Decimal(new int[] {
																		144,
																		0,
																		0,
																		-2147483648});
			...
			this.udLOOffset2.TabIndex = 71;
			this.udLOOffset2.Value = new System.Decimal(new int[] {
																	  0,
																	  0,
																	  0,
																	  0});
			...
			this.udLOOffset1.Increment = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			this.udLOOffset1.Location = new System.Drawing.Point(304, 72);
			this.udLOOffset1.Maximum = new System.Decimal(new int[] {
																		50000,
																		0,
																		0,
																		0});
			this.udLOOffset1.Minimum = new System.Decimal(new int[] {
																		144,
																		0,
																		0,
																		-2147483648});
			...
			this.udLOOffset1.TabIndex = 70;
			this.udLOOffset1.Value = new System.Decimal(new int[] {
																	  0,
																	  0,
																	  0,
																	  0});
			...
			this.udLOOffset0.Increment = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			this.udLOOffset0.Location = new System.Drawing.Point(304, 48);
			this.udLOOffset0.Maximum = new System.Decimal(new int[] {
																		50000,
																		0,
																		0,
																		0});
			this.udLOOffset0.Minimum = new System.Decimal(new int[] {
																		144,
																		0,
																		0,
																		-2147483648});
			...
			this.udLOOffset0.TabIndex = 69;
			this.udLOOffset0.Value = new System.Decimal(new int[] {
																	  0,
																	  0,
																	  0,
																	  0});
			...
			this.udFreqBegin15.Increment = new System.Decimal(new int[] {
																			1,
																			0,
																			0,
																			0});
			this.udFreqBegin15.Location = new System.Drawing.Point(456, 408);
			this.udFreqBegin15.Maximum = new System.Decimal(new int[] {
																		  50000,
																		  0,
																		  0,
																		  0});
			this.udFreqBegin15.Minimum = new System.Decimal(new int[] {
																		  0,
																		  0,
																		  0,
																		  0});
			...
			this.udFreqBegin15.TabIndex = 101;
			this.udFreqBegin15.Value = new System.Decimal(new int[] {
																		0,
																		0,
																		0,
																		0});
			...
			this.udFreqBegin14.Increment = new System.Decimal(new int[] {
																			1,
																			0,
																			0,
																			0});
			this.udFreqBegin14.Location = new System.Drawing.Point(456, 384);
			this.udFreqBegin14.Maximum = new System.Decimal(new int[] {
																		  50000,
																		  0,
																		  0,
																		  0});
			this.udFreqBegin14.Minimum = new System.Decimal(new int[] {
																		  0,
																		  0,
																		  0,
																		  0});
			...
			this.udFreqBegin14.TabIndex = 100;
			this.udFreqBegin14.Value = new System.Decimal(new int[] {
																		0,
																		0,
																		0,
																		0});
			...
			this.udFreqBegin13.Increment = new System.Decimal(new int[] {
																			1,
																			0,
																			0,
																			0});
			this.udFreqBegin13.Location = new System.Drawing.Point(456, 360);
			this.udFreqBegin13.Maximum = new System.Decimal(new int[] {
																		  50000,
																		  0,
																		  0,
																		  0});
			this.udFreqBegin13.Minimum = new System.Decimal(new int[] {
																		  0,
																		  0,
																		  0,
																		  0});
			...
			this.udFreqBegin13.TabIndex = 99;
			this.udFreqBegin13.Value = new System.Decimal(new int[] {
																		0,
																		0,
																		0,
																		0});
			...
			this.udFreqBegin12.Increment = new System.Decimal(new int[] {
																			1,
																			0,
																			0,
																			0});
			this.udFreqBegin12.Location = new System.Drawing.Point(456, 336);
			this.udFreqBegin12.Maximum = new System.Decimal(new int[] {
																		  50000,
																		  0,
																		  0,
																		  0});
			this.udFreqBegin12.Minimum = new System.Decimal(new int[] {
																		  0,
																		  0,
																		  0,
																		  0});
			...
			this.udFreqBegin12.TabIndex = 98;
			this.udFreqBegin12.Value = new System.Decimal(new int[] {
																		0,
																		0,
																		0,
																		0});
			...
			this.udFreqBegin11.Increment = new System.Decimal(new int[] {
																			1,
																			0,
																			0,
																			0});
			this.udFreqBegin11.Location = new System.Drawing.Point(456, 312);
			this.udFreqBegin11.Maximum = new System.Decimal(new int[] {
																		  50000,
																		  0,
																		  0,
																		  0});
			this.udFreqBegin11.Minimum = new System.Decimal(new int[] {
																		  0,
																		  0,
																		  0,
																		  0});
			...
			this.udFreqBegin11.TabIndex = 97;
			this.udFreqBegin11.Value = new System.Decimal(new int[] {
																		0,
																		0,
																		0,
																		0});
			...
			this.udFreqBegin10.Increment = new System.Decimal(new int[] {
																			1,
																			0,
																			0,
																			0});
			this.udFreqBegin10.Location = new System.Drawing.Point(456, 288);
			this.udFreqBegin10.Maximum = new System.Decimal(new int[] {
																		  50000,
																		  0,
																		  0,
																		  0});
			this.udFreqBegin10.Minimum = new System.Decimal(new int[] {
																		  0,
																		  0,
																		  0,
																		  0});
			...
			this.udFreqBegin10.TabIndex = 96;
			this.udFreqBegin10.Value = new System.Decimal(new int[] {
																		0,
																		0,
																		0,
																		0});
			...
			this.udFreqBegin9.Increment = new System.Decimal(new int[] {
																		   1,
																		   0,
																		   0,
																		   0});
			this.udFreqBegin9.Location = new System.Drawing.Point(456, 264);
			this.udFreqBegin9.Maximum = new System.Decimal(new int[] {
																		 50000,
																		 0,
																		 0,
																		 0});
			this.udFreqBegin9.Minimum = new System.Decimal(new int[] {
																		 0,
																		 0,
																		 0,
																		 0});
			...
			this.udFreqBegin9.TabIndex = 95;
			this.udFreqBegin9.Value = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udFreqBegin8.Increment = new System.Decimal(new int[] {
																		   1,
																		   0,
																		   0,
																		   0});
			this.udFreqBegin8.Location = new System.Drawing.Point(456, 240);
			this.udFreqBegin8.Maximum = new System.Decimal(new int[] {
																		 50000,
																		 0,
																		 0,
																		 0});
			this.udFreqBegin8.Minimum = new System.Decimal(new int[] {
																		 0,
																		 0,
																		 0,
																		 0});
			...
			this.udFreqBegin8.TabIndex = 94;
			this.udFreqBegin8.Value = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udFreqBegin7.Increment = new System.Decimal(new int[] {
																		   1,
																		   0,
																		   0,
																		   0});
			this.udFreqBegin7.Location = new System.Drawing.Point(456, 216);
			this.udFreqBegin7.Maximum = new System.Decimal(new int[] {
																		 50000,
																		 0,
																		 0,
																		 0});
			this.udFreqBegin7.Minimum = new System.Decimal(new int[] {
																		 0,
																		 0,
																		 0,
																		 0});
			...
			this.udFreqBegin7.TabIndex = 93;
			this.udFreqBegin7.Value = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udFreqBegin6.Increment = new System.Decimal(new int[] {
																		   1,
																		   0,
																		   0,
																		   0});
			this.udFreqBegin6.Location = new System.Drawing.Point(456, 192);
			this.udFreqBegin6.Maximum = new System.Decimal(new int[] {
																		 50000,
																		 0,
																		 0,
																		 0});
			this.udFreqBegin6.Minimum = new System.Decimal(new int[] {
																		 0,
																		 0,
																		 0,
																		 0});
			...
			this.udFreqBegin6.TabIndex = 92;
			this.udFreqBegin6.Value = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udFreqBegin5.Increment = new System.Decimal(new int[] {
																		   1,
																		   0,
																		   0,
																		   0});
			this.udFreqBegin5.Location = new System.Drawing.Point(456, 168);
			this.udFreqBegin5.Maximum = new System.Decimal(new int[] {
																		 50000,
																		 0,
																		 0,
																		 0});
			this.udFreqBegin5.Minimum = new System.Decimal(new int[] {
																		 0,
																		 0,
																		 0,
																		 0});
			...
			this.udFreqBegin5.TabIndex = 91;
			this.udFreqBegin5.Value = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udFreqBegin4.Increment = new System.Decimal(new int[] {
																		   1,
																		   0,
																		   0,
																		   0});
			this.udFreqBegin4.Location = new System.Drawing.Point(456, 144);
			this.udFreqBegin4.Maximum = new System.Decimal(new int[] {
																		 50000,
																		 0,
																		 0,
																		 0});
			this.udFreqBegin4.Minimum = new System.Decimal(new int[] {
																		 0,
																		 0,
																		 0,
																		 0});
			...
			this.udFreqBegin4.TabIndex = 90;
			this.udFreqBegin4.Value = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udFreqBegin3.Increment = new System.Decimal(new int[] {
																		   1,
																		   0,
																		   0,
																		   0});
			this.udFreqBegin3.Location = new System.Drawing.Point(456, 120);
			this.udFreqBegin3.Maximum = new System.Decimal(new int[] {
																		 50000,
																		 0,
																		 0,
																		 0});
			this.udFreqBegin3.Minimum = new System.Decimal(new int[] {
																		 0,
																		 0,
																		 0,
																		 0});
			...
			this.udFreqBegin3.TabIndex = 89;
			this.udFreqBegin3.Value = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udFreqBegin2.Increment = new System.Decimal(new int[] {
																		   1,
																		   0,
																		   0,
																		   0});
			this.udFreqBegin2.Location = new System.Drawing.Point(456, 96);
			this.udFreqBegin2.Maximum = new System.Decimal(new int[] {
																		 50000,
																		 0,
																		 0,
																		 0});
			this.udFreqBegin2.Minimum = new System.Decimal(new int[] {
																		 0,
																		 0,
																		 0,
																		 0});
			...
			this.udFreqBegin2.TabIndex = 88;
			this.udFreqBegin2.Value = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udFreqBegin1.Increment = new System.Decimal(new int[] {
																		   1,
																		   0,
																		   0,
																		   0});
			this.udFreqBegin1.Location = new System.Drawing.Point(456, 72);
			this.udFreqBegin1.Maximum = new System.Decimal(new int[] {
																		 50000,
																		 0,
																		 0,
																		 0});
			this.udFreqBegin1.Minimum = new System.Decimal(new int[] {
																		 0,
																		 0,
																		 0,
																		 0});
			...
			this.udFreqBegin1.TabIndex = 87;
			this.udFreqBegin1.Value = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udFreqBegin0.Increment = new System.Decimal(new int[] {
																		   1,
																		   0,
																		   0,
																		   0});
			this.udFreqBegin0.Location = new System.Drawing.Point(456, 48);
			this.udFreqBegin0.Maximum = new System.Decimal(new int[] {
																		 50000,
																		 0,
																		 0,
																		 0});
			this.udFreqBegin0.Minimum = new System.Decimal(new int[] {
																		 0,
																		 0,
																		 0,
																		 0});
			...
			this.udFreqBegin0.TabIndex = 86;
			this.udFreqBegin0.Value = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udFreqEnd15.Increment = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			this.udFreqEnd15.Location = new System.Drawing.Point(560, 408);
			this.udFreqEnd15.Maximum = new System.Decimal(new int[] {
																		50000,
																		0,
																		0,
																		0});
			this.udFreqEnd15.Minimum = new System.Decimal(new int[] {
																		0,
																		0,
																		0,
																		0});
			...
			this.udFreqEnd15.TabIndex = 118;
			this.udFreqEnd15.Value = new System.Decimal(new int[] {
																	  0,
																	  0,
																	  0,
																	  0});
			...
			this.udFreqEnd14.Increment = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			this.udFreqEnd14.Location = new System.Drawing.Point(560, 384);
			this.udFreqEnd14.Maximum = new System.Decimal(new int[] {
																		50000,
																		0,
																		0,
																		0});
			this.udFreqEnd14.Minimum = new System.Decimal(new int[] {
																		0,
																		0,
																		0,
																		0});
			...
			this.udFreqEnd14.TabIndex = 117;
			this.udFreqEnd14.Value = new System.Decimal(new int[] {
																	  0,
																	  0,
																	  0,
																	  0});
			...
			this.udFreqEnd13.Increment = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			this.udFreqEnd13.Location = new System.Drawing.Point(560, 360);
			this.udFreqEnd13.Maximum = new System.Decimal(new int[] {
																		50000,
																		0,
																		0,
																		0});
			this.udFreqEnd13.Minimum = new System.Decimal(new int[] {
																		0,
																		0,
																		0,
																		0});
			...
			this.udFreqEnd13.TabIndex = 116;
			this.udFreqEnd13.Value = new System.Decimal(new int[] {
																	  0,
																	  0,
																	  0,
																	  0});
			...
			this.udFreqEnd12.Increment = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			this.udFreqEnd12.Location = new System.Drawing.Point(560, 336);
			this.udFreqEnd12.Maximum = new System.Decimal(new int[] {
																		50000,
																		0,
																		0,
																		0});
			this.udFreqEnd12.Minimum = new System.Decimal(new int[] {
																		0,
																		0,
																		0,
																		0});
			...
			this.udFreqEnd12.TabIndex = 115;
			this.udFreqEnd12.Value = new System.Decimal(new int[] {
																	  0,
																	  0,
																	  0,
																	  0});
			...
			this.udFreqEnd11.Increment = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			this.udFreqEnd11.Location = new System.Drawing.Point(560, 312);
			this.udFreqEnd11.Maximum = new System.Decimal(new int[] {
																		50000,
																		0,
																		0,
																		0});
			this.udFreqEnd11.Minimum = new System.Decimal(new int[] {
																		0,
																		0,
																		0,
																		0});
			...
			this.udFreqEnd11.TabIndex = 114;
			this.udFreqEnd11.Value = new System.Decimal(new int[] {
																	  0,
																	  0,
																	  0,
																	  0});
			...
			this.udFreqEnd10.Increment = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			this.udFreqEnd10.Location = new System.Drawing.Point(560, 288);
			this.udFreqEnd10.Maximum = new System.Decimal(new int[] {
																		50000,
																		0,
																		0,
																		0});
			this.udFreqEnd10.Minimum = new System.Decimal(new int[] {
																		0,
																		0,
																		0,
																		0});
			...
			this.udFreqEnd10.TabIndex = 113;
			this.udFreqEnd10.Value = new System.Decimal(new int[] {
																	  0,
																	  0,
																	  0,
																	  0});
			...
			this.udFreqEnd9.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udFreqEnd9.Location = new System.Drawing.Point(560, 264);
			this.udFreqEnd9.Maximum = new System.Decimal(new int[] {
																	   50000,
																	   0,
																	   0,
																	   0});
			this.udFreqEnd9.Minimum = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udFreqEnd9.TabIndex = 112;
			this.udFreqEnd9.Value = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udFreqEnd8.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udFreqEnd8.Location = new System.Drawing.Point(560, 240);
			this.udFreqEnd8.Maximum = new System.Decimal(new int[] {
																	   50000,
																	   0,
																	   0,
																	   0});
			this.udFreqEnd8.Minimum = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udFreqEnd8.TabIndex = 111;
			this.udFreqEnd8.Value = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udFreqEnd7.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udFreqEnd7.Location = new System.Drawing.Point(560, 216);
			this.udFreqEnd7.Maximum = new System.Decimal(new int[] {
																	   50000,
																	   0,
																	   0,
																	   0});
			this.udFreqEnd7.Minimum = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udFreqEnd7.TabIndex = 110;
			this.udFreqEnd7.Value = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udFreqEnd6.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udFreqEnd6.Location = new System.Drawing.Point(560, 192);
			this.udFreqEnd6.Maximum = new System.Decimal(new int[] {
																	   50000,
																	   0,
																	   0,
																	   0});
			this.udFreqEnd6.Minimum = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udFreqEnd6.TabIndex = 109;
			this.udFreqEnd6.Value = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udFreqEnd5.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udFreqEnd5.Location = new System.Drawing.Point(560, 168);
			this.udFreqEnd5.Maximum = new System.Decimal(new int[] {
																	   50000,
																	   0,
																	   0,
																	   0});
			this.udFreqEnd5.Minimum = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udFreqEnd5.TabIndex = 108;
			this.udFreqEnd5.Value = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udFreqEnd4.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udFreqEnd4.Location = new System.Drawing.Point(560, 144);
			this.udFreqEnd4.Maximum = new System.Decimal(new int[] {
																	   50000,
																	   0,
																	   0,
																	   0});
			this.udFreqEnd4.Minimum = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udFreqEnd4.TabIndex = 107;
			this.udFreqEnd4.Value = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udFreqEnd3.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udFreqEnd3.Location = new System.Drawing.Point(560, 120);
			this.udFreqEnd3.Maximum = new System.Decimal(new int[] {
																	   50000,
																	   0,
																	   0,
																	   0});
			this.udFreqEnd3.Minimum = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udFreqEnd3.TabIndex = 106;
			this.udFreqEnd3.Value = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udFreqEnd2.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udFreqEnd2.Location = new System.Drawing.Point(560, 96);
			this.udFreqEnd2.Maximum = new System.Decimal(new int[] {
																	   50000,
																	   0,
																	   0,
																	   0});
			this.udFreqEnd2.Minimum = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udFreqEnd2.TabIndex = 105;
			this.udFreqEnd2.Value = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udFreqEnd1.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udFreqEnd1.Location = new System.Drawing.Point(560, 72);
			this.udFreqEnd1.Maximum = new System.Decimal(new int[] {
																	   50000,
																	   0,
																	   0,
																	   0});
			this.udFreqEnd1.Minimum = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udFreqEnd1.TabIndex = 104;
			this.udFreqEnd1.Value = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udFreqEnd0.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udFreqEnd0.Location = new System.Drawing.Point(560, 48);
			this.udFreqEnd0.Maximum = new System.Decimal(new int[] {
																	   50000,
																	   0,
																	   0,
																	   0});
			this.udFreqEnd0.Minimum = new System.Decimal(new int[] {
																	   0,
																	   0,
																	   0,
																	   0});
			...
			this.udFreqEnd0.TabIndex = 103;
			this.udFreqEnd0.Value = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.chkRXOnly15.TabIndex = 135;
			this.chkRXOnly15.Text = "checkBox17";
			// 
			// chkRXOnly14
			// 
			...
			this.chkRXOnly14.TabIndex = 134;
			this.chkRXOnly14.Text = "checkBox18";
			// 
			// chkRXOnly13
			// 
			...
			this.chkRXOnly13.TabIndex = 133;
			this.chkRXOnly13.Text = "checkBox19";
			// 
			// chkRXOnly12
			// 
			...
			this.chkRXOnly12.TabIndex = 132;
			this.chkRXOnly12.Text = "checkBox20";
			// 
			// chkRXOnly11
			// 
			...
			this.chkRXOnly11.TabIndex = 131;
			this.chkRXOnly11.Text = "checkBox21";
			// 
			// chkRXOnly10
			// 
			...
			this.chkRXOnly10.TabIndex = 130;
			this.chkRXOnly10.Text = "checkBox22";
			// 
			// chkRXOnly9
			// 
			...
			this.chkRXOnly9.TabIndex = 129;
			this.chkRXOnly9.Text = "checkBox23";
			// 
			// chkRXOnly8
			// 
			...
			this.chkRXOnly8.TabIndex = 128;
			this.chkRXOnly8.Text = "checkBox24";
			// 
			// chkRXOnly7
			// 
			...
			this.chkRXOnly7.TabIndex = 127;
			this.chkRXOnly7.Text = "checkBox25";
			// 
			// chkRXOnly6
			// 
			...
			this.chkRXOnly6.TabIndex = 126;
			this.chkRXOnly6.Text = "checkBox26";
			// 
			// chkRXOnly5
			// 
			...
			this.chkRXOnly5.TabIndex = 125;
			this.chkRXOnly5.Text = "checkBox27";
			// 
			// chkRXOnly4
			// 
			...
			this.chkRXOnly4.TabIndex = 124;
			this.chkRXOnly4.Text = "checkBox28";
			// 
			// chkRXOnly3
			// 
			...
			this.chkRXOnly3.TabIndex = 123;
			this.chkRXOnly3.Text = "checkBox29";
			// 
			// chkRXOnly2
			// 
			...
			this.chkRXOnly2.TabIndex = 122;
			this.chkRXOnly2.Text = "checkBox30";
			// 
			// chkRXOnly1
			// 
			...
			this.chkRXOnly1.TabIndex = 121;
			this.chkRXOnly1.Text = "checkBox31";
			// 
			// chkRXOnly0
			// 
			...
			this.chkRXOnly0.TabIndex = 120;
			this.chkRXOnly0.Text = "checkBox32";
			// 
			// udLOError15
			// 
			this.udLOError15.DecimalPlaces = 3;
			this.udLOError15.Enabled = false;
			this.udLOError15.Increment = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			this.udLOError15.Location = new System.Drawing.Point(392, 408);
			this.udLOError15.Maximum = new System.Decimal(new int[] {
																		1000,
																		0,
																		0,
																		0});
			this.udLOError15.Minimum = new System.Decimal(new int[] {
																		1000,
																		0,
																		0,
																		-2147483648});
			...
			this.udLOError15.TabIndex = 152;
			this.udLOError15.Value = new System.Decimal(new int[] {
																	  0,
																	  0,
																	  0,
																	  0});
			...
			this.udLOError14.Increment = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			this.udLOError14.Location = new System.Drawing.Point(392, 384);
			this.udLOError14.Maximum = new System.Decimal(new int[] {
																		1000,
																		0,
																		0,
																		0});
			this.udLOError14.Minimum = new System.Decimal(new int[] {
																		1000,
																		0,
																		0,
																		-2147483648});
			...
			this.udLOError14.TabIndex = 151;
			this.udLOError14.Value = new System.Decimal(new int[] {
																	  0,
																	  0,
																	  0,
																	  0});
			...
			this.udLOError13.Increment = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			this.udLOError13.Location = new System.Drawing.Point(392, 360);
			this.udLOError13.Maximum = new System.Decimal(new int[] {
																		1000,
																		0,
																		0,
																		0});
			this.udLOError13.Minimum = new System.Decimal(new int[] {
																		1000,
																		0,
																		0,
																		-2147483648});
			...
			this.udLOError13.TabIndex = 150;
			this.udLOError13.Value = new System.Decimal(new int[] {
																	  0,
																	  0,
																	  0,
																	  0});
			...
			this.udLOError12.Increment = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			this.udLOError12.Location = new System.Drawing.Point(392, 336);
			this.udLOError12.Maximum = new System.Decimal(new int[] {
																		1000,
																		0,
																		0,
																		0});
			this.udLOError12.Minimum = new System.Decimal(new int[] {
																		1000,
																		0,
																		0,
																		-2147483648});
			...
			this.udLOError12.Value = new System.Decimal(new int[] {
																	  0,
																	  0,
																	  0,
																	  0});
			...
			this.udLOError11.Increment = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			this.udLOError11.Location = new System.Drawing.Point(392, 312);
			this.udLOError11.Maximum = new System.Decimal(new int[] {
																		1000,
																		0,
																		0,
																		0});
			this.udLOError11.Minimum = new System.Decimal(new int[] {
																		1000,
																		0,
																		0,
																		-2147483648});
			...
			this.udLOError11.TabIndex = 148;
			this.udLOError11.Value = new System.Decimal(new int[] {
																	  0,
																	  0,
																	  0,
																	  0});
			...
			this.udLOError10.Increment = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			this.udLOError10.Location = new System.Drawing.Point(392, 288);
			this.udLOError10.Maximum = new System.Decimal(new int[] {
																		1000,
																		0,
																		0,
																		0});
			this.udLOError10.Minimum = new System.Decimal(new int[] {
																		1000,
																		0,
																		0,
																		-2147483648});
			...
			this.udLOError10.TabIndex = 147;
			this.udLOError10.Value = new System.Decimal(new int[] {
																	  0,
																	  0,
																	  0,
																	  0});
			...
			this.udLOError9.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udLOError9.Location = new System.Drawing.Point(392, 264);
			this.udLOError9.Maximum = new System.Decimal(new int[] {
																	   1000,
																	   0,
																	   0,
																	   0});
			this.udLOError9.Minimum = new System.Decimal(new int[] {
																	   1000,
																	   0,
																	   0,
																	   -2147483648});
			...
			this.udLOError9.TabIndex = 146;
			this.udLOError9.Value = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udLOError8.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udLOError8.Location = new System.Drawing.Point(392, 240);
			this.udLOError8.Maximum = new System.Decimal(new int[] {
																	   1000,
																	   0,
																	   0,
																	   0});
			this.udLOError8.Minimum = new System.Decimal(new int[] {
																	   1000,
																	   0,
																	   0,
																	   -2147483648});
			...
			this.udLOError8.TabIndex = 145;
			this.udLOError8.Value = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udLOError7.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udLOError7.Location = new System.Drawing.Point(392, 216);
			this.udLOError7.Maximum = new System.Decimal(new int[] {
																	   1000,
																	   0,
																	   0,
																	   0});
			this.udLOError7.Minimum = new System.Decimal(new int[] {
																	   1000,
																	   0,
																	   0,
																	   -2147483648});
			...
			this.udLOError7.TabIndex = 144;
			this.udLOError7.Value = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udLOError6.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udLOError6.Location = new System.Drawing.Point(392, 192);
			this.udLOError6.Maximum = new System.Decimal(new int[] {
																	   1000,
																	   0,
																	   0,
																	   0});
			this.udLOError6.Minimum = new System.Decimal(new int[] {
																	   1000,
																	   0,
																	   0,
																	   -2147483648});
			...
			this.udLOError6.TabIndex = 143;
			this.udLOError6.Value = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udLOError5.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udLOError5.Location = new System.Drawing.Point(392, 168);
			this.udLOError5.Maximum = new System.Decimal(new int[] {
																	   1000,
																	   0,
																	   0,
																	   0});
			this.udLOError5.Minimum = new System.Decimal(new int[] {
																	   1000,
																	   0,
																	   0,
																	   -2147483648});
			...
			this.udLOError5.TabIndex = 142;
			this.udLOError5.Value = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udLOError4.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udLOError4.Location = new System.Drawing.Point(392, 144);
			this.udLOError4.Maximum = new System.Decimal(new int[] {
																	   1000,
																	   0,
																	   0,
																	   0});
			this.udLOError4.Minimum = new System.Decimal(new int[] {
																	   1000,
																	   0,
																	   0,
																	   -2147483648});
			...
			this.udLOError4.TabIndex = 141;
			this.udLOError4.Value = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udLOError3.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udLOError3.Location = new System.Drawing.Point(392, 120);
			this.udLOError3.Maximum = new System.Decimal(new int[] {
																	   1000,
																	   0,
																	   0,
																	   0});
			this.udLOError3.Minimum = new System.Decimal(new int[] {
																	   1000,
																	   0,
																	   0,
																	   -2147483648});
			...
			this.udLOError3.TabIndex = 140;
			this.udLOError3.Value = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udLOError2.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udLOError2.Location = new System.Drawing.Point(392, 96);
			this.udLOError2.Maximum = new System.Decimal(new int[] {
																	   1000,
																	   0,
																	   0,
																	   0});
			this.udLOError2.Minimum = new System.Decimal(new int[] {
																	   1000,
																	   0,
																	   0,
																	   -2147483648});
			...
			this.udLOError2.TabIndex = 139;
			this.udLOError2.Value = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udLOError1.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udLOError1.Location = new System.Drawing.Point(392, 72);
			this.udLOError1.Maximum = new System.Decimal(new int[] {
																	   1000,
																	   0,
																	   0,
																	   0});
			this.udLOError1.Minimum = new System.Decimal(new int[] {
																	   1000,
																	   0,
																	   0,
																	   -2147483648});
			...
			this.udLOError1.TabIndex = 138;
			this.udLOError1.Value = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udLOError0.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udLOError0.Location = new System.Drawing.Point(392, 48);
			this.udLOError0.Maximum = new System.Decimal(new int[] {
																	   1000,
																	   0,
																	   0,
																	   0});
			this.udLOError0.Minimum = new System.Decimal(new int[] {
																	   1000,
																	   0,
																	   0,
																	   -2147483648});
			...
			this.udLOError0.TabIndex = 137;
			this.udLOError0.Value = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udPower15.Increment = new System.Decimal(new int[] {
																		1,
																		0,
																		0,
																		0});
			this.udPower15.Location = new System.Drawing.Point(784, 408);
			this.udPower15.Maximum = new System.Decimal(new int[] {
																	  100,
																	  0,
																	  0,
																	  0});
			this.udPower15.Minimum = new System.Decimal(new int[] {
																	  0,
																	  0,
																	  0,
																	  0});
			...
			this.udPower15.TabIndex = 169;
			this.udPower15.Value = new System.Decimal(new int[] {
																	100,
																	0,
																	0,
																	0});
			...
			this.udPower14.Increment = new System.Decimal(new int[] {
																		1,
																		0,
																		0,
																		0});
			this.udPower14.Location = new System.Drawing.Point(784, 384);
			this.udPower14.Maximum = new System.Decimal(new int[] {
																	  100,
																	  0,
																	  0,
																	  0});
			this.udPower14.Minimum = new System.Decimal(new int[] {
																	  0,
																	  0,
																	  0,
																	  0});
			...
			this.udPower14.TabIndex = 168;
			this.udPower14.Value = new System.Decimal(new int[] {
																	100,
																	0,
																	0,
																	0});
			...
			this.udPower13.Increment = new System.Decimal(new int[] {
																		1,
																		0,
																		0,
																		0});
			this.udPower13.Location = new System.Drawing.Point(784, 360);
			this.udPower13.Maximum = new System.Decimal(new int[] {
																	  100,
																	  0,
																	  0,
																	  0});
			this.udPower13.Minimum = new System.Decimal(new int[] {
																	  0,
																	  0,
																	  0,
																	  0});
			...
			this.udPower13.TabIndex = 167;
			this.udPower13.Value = new System.Decimal(new int[] {
																	100,
																	0,
																	0,
																	0});
			...
			this.udPower12.Increment = new System.Decimal(new int[] {
																		1,
																		0,
																		0,
																		0});
			this.udPower12.Location = new System.Drawing.Point(784, 336);
			this.udPower12.Maximum = new System.Decimal(new int[] {
																	  100,
																	  0,
																	  0,
																	  0});
			this.udPower12.Minimum = new System.Decimal(new int[] {
																	  0,
																	  0,
																	  0,
																	  0});
			...
			this.udPower12.TabIndex = 166;
			this.udPower12.Value = new System.Decimal(new int[] {
																	100,
																	0,
																	0,
																	0});
			...
			this.udPower11.Increment = new System.Decimal(new int[] {
																		1,
																		0,
																		0,
																		0});
			this.udPower11.Location = new System.Drawing.Point(784, 312);
			this.udPower11.Maximum = new System.Decimal(new int[] {
																	  100,
																	  0,
																	  0,
																	  0});
			this.udPower11.Minimum = new System.Decimal(new int[] {
																	  0,
																	  0,
																	  0,
																	  0});
			...
			this.udPower11.TabIndex = 165;
			this.udPower11.Value = new System.Decimal(new int[] {
																	100,
																	0,
																	0,
																	0});
			...
			this.udPower10.Increment = new System.Decimal(new int[] {
																		1,
																		0,
																		0,
																		0});
			this.udPower10.Location = new System.Drawing.Point(784, 288);
			this.udPower10.Maximum = new System.Decimal(new int[] {
																	  100,
																	  0,
																	  0,
																	  0});
			this.udPower10.Minimum = new System.Decimal(new int[] {
																	  0,
																	  0,
																	  0,
																	  0});
			...
			this.udPower10.TabIndex = 164;
			this.udPower10.Value = new System.Decimal(new int[] {
																	100,
																	0,
																	0,
																	0});
			...
			this.udPower9.Increment = new System.Decimal(new int[] {
																	   1,
																	   0,
																	   0,
																	   0});
			this.udPower9.Location = new System.Drawing.Point(784, 264);
			this.udPower9.Maximum = new System.Decimal(new int[] {
																	 100,
																	 0,
																	 0,
																	 0});
			this.udPower9.Minimum = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udPower9.TabIndex = 163;
			this.udPower9.Value = new System.Decimal(new int[] {
																   100,
																   0,
																   0,
																   0});
			...
			this.udPower8.Increment = new System.Decimal(new int[] {
																	   1,
																	   0,
																	   0,
																	   0});
			this.udPower8.Location = new System.Drawing.Point(784, 240);
			this.udPower8.Maximum = new System.Decimal(new int[] {
																	 100,
																	 0,
																	 0,
																	 0});
			this.udPower8.Minimum = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udPower8.TabIndex = 162;
			this.udPower8.Value = new System.Decimal(new int[] {
																   100,
																   0,
																   0,
																   0});
			...
			this.udPower7.Increment = new System.Decimal(new int[] {
																	   1,
																	   0,
																	   0,
																	   0});
			this.udPower7.Location = new System.Drawing.Point(784, 216);
			this.udPower7.Maximum = new System.Decimal(new int[] {
																	 100,
																	 0,
																	 0,
																	 0});
			this.udPower7.Minimum = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udPower7.TabIndex = 161;
			this.udPower7.Value = new System.Decimal(new int[] {
																   100,
																   0,
																   0,
																   0});
			...
			this.udPower6.Increment = new System.Decimal(new int[] {
																	   1,
																	   0,
																	   0,
																	   0});
			this.udPower6.Location = new System.Drawing.Point(784, 192);
			this.udPower6.Maximum = new System.Decimal(new int[] {
																	 100,
																	 0,
																	 0,
																	 0});
			this.udPower6.Minimum = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udPower6.TabIndex = 160;
			this.udPower6.Value = new System.Decimal(new int[] {
																   100,
																   0,
																   0,
																   0});
			...
			this.udPower5.Increment = new System.Decimal(new int[] {
																	   1,
																	   0,
																	   0,
																	   0});
			this.udPower5.Location = new System.Drawing.Point(784, 168);
			this.udPower5.Maximum = new System.Decimal(new int[] {
																	 100,
																	 0,
																	 0,
																	 0});
			this.udPower5.Minimum = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udPower5.TabIndex = 159;
			this.udPower5.Value = new System.Decimal(new int[] {
																   100,
																   0,
																   0,
																   0});
			...
			this.udPower4.Increment = new System.Decimal(new int[] {
																	   1,
																	   0,
																	   0,
																	   0});
			this.udPower4.Location = new System.Drawing.Point(784, 144);
			this.udPower4.Maximum = new System.Decimal(new int[] {
																	 100,
																	 0,
																	 0,
																	 0});
			this.udPower4.Minimum = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udPower4.TabIndex = 158;
			this.udPower4.Value = new System.Decimal(new int[] {
																   100,
																   0,
																   0,
																   0});
			...
			this.udPower3.Increment = new System.Decimal(new int[] {
																	   1,
																	   0,
																	   0,
																	   0});
			this.udPower3.Location = new System.Drawing.Point(784, 120);
			this.udPower3.Maximum = new System.Decimal(new int[] {
																	 100,
																	 0,
																	 0,
																	 0});
			this.udPower3.Minimum = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udPower3.TabIndex = 157;
			this.udPower3.Value = new System.Decimal(new int[] {
																   100,
																   0,
																   0,
																   0});
			...
			this.udPower2.Increment = new System.Decimal(new int[] {
																	   1,
																	   0,
																	   0,
																	   0});
			this.udPower2.Location = new System.Drawing.Point(784, 96);
			this.udPower2.Maximum = new System.Decimal(new int[] {
																	 100,
																	 0,
																	 0,
																	 0});
			this.udPower2.Minimum = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udPower2.TabIndex = 156;
			this.udPower2.Value = new System.Decimal(new int[] {
																   100,
																   0,
																   0,
																   0});
			...
			this.udPower1.Increment = new System.Decimal(new int[] {
																	   1,
																	   0,
																	   0,
																	   0});
			this.udPower1.Location = new System.Drawing.Point(784, 72);
			this.udPower1.Maximum = new System.Decimal(new int[] {
																	 100,
																	 0,
																	 0,
																	 0});
			this.udPower1.Minimum = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udPower1.TabIndex = 155;
			this.udPower1.Value = new System.Decimal(new int[] {
																   100,
																   0,
																   0,
																   0});
			...
			this.udPower0.Increment = new System.Decimal(new int[] {
																	   1,
																	   0,
																	   0,
																	   0});
			this.udPower0.Location = new System.Drawing.Point(784, 48);
			this.udPower0.Maximum = new System.Decimal(new int[] {
																	 100,
																	 0,
																	 0,
																	 0});
			this.udPower0.Minimum = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udPower0.TabIndex = 154;
			this.udPower0.Value = new System.Decimal(new int[] {
																   100,
																   0,
																   0,
																   0});
			...
			this.chkXVTRRF15.TabIndex = 186;
			this.chkXVTRRF15.Text = "checkBox33";
			// 
			// chkXVTRRF14
			// 
			...
			this.chkXVTRRF14.TabIndex = 185;
			this.chkXVTRRF14.Text = "checkBox34";
			// 
			// chkXVTRRF13
			// 
			...
			this.chkXVTRRF13.TabIndex = 184;
			this.chkXVTRRF13.Text = "checkBox35";
			// 
			// chkXVTRRF12
			// 
			...
			this.chkXVTRRF12.TabIndex = 183;
			this.chkXVTRRF12.Text = "checkBox36";
			// 
			// chkXVTRRF11
			// 
			...
			this.chkXVTRRF11.TabIndex = 182;
			this.chkXVTRRF11.Text = "checkBox37";
			// 
			// chkXVTRRF10
			// 
			...
			this.chkXVTRRF10.TabIndex = 181;
			this.chkXVTRRF10.Text = "checkBox38";
			// 
			// chkXVTRRF9
			// 
			...
			this.chkXVTRRF9.TabIndex = 180;
			this.chkXVTRRF9.Text = "checkBox39";
			// 
			// chkXVTRRF8
			// 
			...
			this.chkXVTRRF8.TabIndex = 179;
			this.chkXVTRRF8.Text = "checkBox40";
			// 
			// chkXVTRRF7
			// 
			...
			this.chkXVTRRF7.TabIndex = 178;
			this.chkXVTRRF7.Text = "checkBox41";
			// 
			// chkXVTRRF6
			// 
			...
			this.chkXVTRRF6.TabIndex = 177;
			this.chkXVTRRF6.Text = "checkBox42";
			// 
			// chkXVTRRF5
			// 
			...
			this.chkXVTRRF5.TabIndex = 176;
			this.chkXVTRRF5.Text = "checkBox43";
			// 
			// chkXVTRRF4
			// 
			...
			this.chkXVTRRF4.TabIndex = 175;
			this.chkXVTRRF4.Text = "checkBox44";
			// 
			// chkXVTRRF3
			// 
			...
			this.chkXVTRRF3.TabIndex = 174;
			this.chkXVTRRF3.Text = "checkBox45";
			// 
			// chkXVTRRF2
			// 
			...
			this.chkXVTRRF2.TabIndex = 173;
			this.chkXVTRRF2.Text = "checkBox46";
			// 
			// chkXVTRRF1
			// 
			...
			this.chkXVTRRF1.TabIndex = 172;
			this.chkXVTRRF1.Text = "checkBox47";
			// 
			// chkXVTRRF0
			// 
			...
			this.chkXVTRRF0.TabIndex = 171;
			this.chkXVTRRF0.Text = "checkBox48";
			// 
			// lblXVTRRF
			// 
			...
			this.udRXGain15.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udRXGain15.Location = new System.Drawing.Point(664, 408);
			this.udRXGain15.Maximum = new System.Decimal(new int[] {
																	   100,
																	   0,
																	   0,
																	   0});
			this.udRXGain15.Minimum = new System.Decimal(new int[] {
																	   100,
																	   0,
																	   0,
																	   -2147483648});
			...
			this.udRXGain15.TabIndex = 203;
			this.udRXGain15.Value = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udRXGain14.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udRXGain14.Location = new System.Drawing.Point(664, 384);
			this.udRXGain14.Maximum = new System.Decimal(new int[] {
																	   100,
																	   0,
																	   0,
																	   0});
			this.udRXGain14.Minimum = new System.Decimal(new int[] {
																	   100,
																	   0,
																	   0,
																	   -2147483648});
			...
			this.udRXGain14.TabIndex = 202;
			this.udRXGain14.Value = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udRXGain13.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udRXGain13.Location = new System.Drawing.Point(664, 360);
			this.udRXGain13.Maximum = new System.Decimal(new int[] {
																	   100,
																	   0,
																	   0,
																	   0});
			this.udRXGain13.Minimum = new System.Decimal(new int[] {
																	   100,
																	   0,
																	   0,
																	   -2147483648});
			...
			this.udRXGain13.TabIndex = 201;
			this.udRXGain13.Value = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udRXGain12.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udRXGain12.Location = new System.Drawing.Point(664, 336);
			this.udRXGain12.Maximum = new System.Decimal(new int[] {
																	   100,
																	   0,
																	   0,
																	   0});
			this.udRXGain12.Minimum = new System.Decimal(new int[] {
																	   100,
																	   0,
																	   0,
																	   -2147483648});
			...
			this.udRXGain12.TabIndex = 200;
			this.udRXGain12.Value = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udRXGain11.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udRXGain11.Location = new System.Drawing.Point(664, 312);
			this.udRXGain11.Maximum = new System.Decimal(new int[] {
																	   100,
																	   0,
																	   0,
																	   0});
			this.udRXGain11.Minimum = new System.Decimal(new int[] {
																	   100,
																	   0,
																	   0,
																	   -2147483648});
			...
			this.udRXGain11.TabIndex = 199;
			this.udRXGain11.Value = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udRXGain10.Increment = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			this.udRXGain10.Location = new System.Drawing.Point(664, 288);
			this.udRXGain10.Maximum = new System.Decimal(new int[] {
																	   100,
																	   0,
																	   0,
																	   0});
			this.udRXGain10.Minimum = new System.Decimal(new int[] {
																	   100,
																	   0,
																	   0,
																	   -2147483648});
			...
			this.udRXGain10.TabIndex = 198;
			this.udRXGain10.Value = new System.Decimal(new int[] {
																	 0,
																	 0,
																	 0,
																	 0});
			...
			this.udRXGain9.Increment = new System.Decimal(new int[] {
																		1,
																		0,
																		0,
																		0});
			this.udRXGain9.Location = new System.Drawing.Point(664, 264);
			this.udRXGain9.Maximum = new System.Decimal(new int[] {
																	  100,
																	  0,
																	  0,
																	  0});
			this.udRXGain9.Minimum = new System.Decimal(new int[] {
																	  100,
																	  0,
																	  0,
																	  -2147483648});
			...
			this.udRXGain9.TabIndex = 197;
			this.udRXGain9.Value = new System.Decimal(new int[] {
																	0,
																	0,
																	0,
																	0});
			...
			this.udRXGain8.Increment = new System.Decimal(new int[] {
																		1,
																		0,
																		0,
																		0});
			this.udRXGain8.Location = new System.Drawing.Point(664, 240);
			this.udRXGain8.Maximum = new System.Decimal(new int[] {
																	  100,
																	  0,
																	  0,
																	  0});
			this.udRXGain8.Minimum = new System.Decimal(new int[] {
																	  100,
																	  0,
																	  0,
																	  -2147483648});
			...
			this.udRXGain8.TabIndex = 196;
			this.udRXGain8.Value = new System.Decimal(new int[] {
																	0,
																	0,
																	0,
																	0});
			...
			this.udRXGain7.Increment = new System.Decimal(new int[] {
																		1,
																		0,
																		0,
																		0});
			this.udRXGain7.Location = new System.Drawing.Point(664, 216);
			this.udRXGain7.Maximum = new System.Decimal(new int[] {
																	  100,
																	  0,
																	  0,
																	  0});
			this.udRXGain7.Minimum = new System.Decimal(new int[] {
																	  100,
																	  0,
																	  0,
																	  -2147483648});
			...
			this.udRXGain7.TabIndex = 195;
			this.udRXGain7.Value = new System.Decimal(new int[] {
																	0,
																	0,
																	0,
																	0});
			...
			this.udRXGain6.Increment = new System.Decimal(new int[] {
																		1,
																		0,
																		0,
																		0});
			this.udRXGain6.Location = new System.Drawing.Point(664, 192);
			this.udRXGain6.Maximum = new System.Decimal(new int[] {
																	  100,
																	  0,
																	  0,
																	  0});
			this.udRXGain6.Minimum = new System.Decimal(new int[] {
																	  100,
																	  0,
																	  0,
																	  -2147483648});
			...
			this.udRXGain6.TabIndex = 194;
			this.udRXGain6.Value = new System.Decimal(new int[] {
																	0,
																	0,
																	0,
																	0});
			...
			this.udRXGain5.Increment = new System.Decimal(new int[] {
																		1,
																		0,
																		0,
																		0});
			this.udRXGain5.Location = new System.Drawing.Point(664, 168);
			this.udRXGain5.Maximum = new System.Decimal(new int[] {
																	  100,
																	  0,
																	  0,
																	  0});
			this.udRXGain5.Minimum = new System.Decimal(new int[] {
																	  100,
																	  0,
																	  0,
																	  -2147483648});
			...
			this.udRXGain5.TabIndex = 193;
			this.udRXGain5.Value = new System.Decimal(new int[] {
																	0,
																	0,
																	0,
																	0});
			...
			this.udRXGain4.Increment = new System.Decimal(new int[] {
																		1,
																		0,
																		0,
																		0});
			this.udRXGain4.Location = new System.Drawing.Point(664, 144);
			this.udRXGain4.Maximum = new System.Decimal(new int[] {
																	  100,
																	  0,
																	  0,
																	  0});
			this.udRXGain4.Minimum = new System.Decimal(new int[] {
																	  100,
																	  0,
																	  0,
																	  -2147483648});
			...
			this.udRXGain4.TabIndex = 192;
			this.udRXGain4.Value = new System.Decimal(new int[] {
																	0,
																	0,
																	0,
																	0});
			...
			this.udRXGain3.Increment = new System.Decimal(new int[] {
																		1,
																		0,
																		0,
																		0});
			this.udRXGain3.Location = new System.Drawing.Point(664, 120);
			this.udRXGain3.Maximum = new System.Decimal(new int[] {
																	  100,
																	  0,
																	  0,
																	  0});
			this.udRXGain3.Minimum = new System.Decimal(new int[] {
																	  100,
																	  0,
																	  0,
																	  -2147483648});
			...
			this.udRXGain3.TabIndex = 191;
			this.udRXGain3.Value = new System.Decimal(new int[] {
																	0,
																	0,
																	0,
																	0});
			...
			this.udRXGain2.Increment = new System.Decimal(new int[] {
																		1,
																		0,
																		0,
																		0});
			this.udRXGain2.Location = new System.Drawing.Point(664, 96);
			this.udRXGain2.Maximum = new System.Decimal(new int[] {
																	  100,
																	  0,
																	  0,
																	  0});
			this.udRXGain2.Minimum = new System.Decimal(new int[] {
																	  100,
																	  0,
																	  0,
																	  -2147483648});
			...
			this.udRXGain2.TabIndex = 190;
			this.udRXGain2.Value = new System.Decimal(new int[] {
																	0,
																	0,
																	0,
																	0});
			...
			this.udRXGain1.Increment = new System.Decimal(new int[] {
																		1,
																		0,
																		0,
																		0});
			this.udRXGain1.Location = new System.Drawing.Point(664, 72);
			this.udRXGain1.Maximum = new System.Decimal(new int[] {
																	  100,
																	  0,
																	  0,
																	  0});
			this.udRXGain1.Minimum = new System.Decimal(new int[] {
																	  100,
																	  0,
																	  0,
																	  -2147483648});
			...
			this.udRXGain1.TabIndex = 189;
			this.udRXGain1.Value = new System.Decimal(new int[] {
																	0,
																	0,
																	0,
																	0});
			...
			this.udRXGain0.Increment = new System.Decimal(new int[] {
																		1,
																		0,
																		0,
																		0});
			this.udRXGain0.Location = new System.Drawing.Point(664, 48);
			this.udRXGain0.Maximum = new System.Decimal(new int[] {
																	  100,
																	  0,
																	  0,
																	  0});
			this.udRXGain0.Minimum = new System.Decimal(new int[] {
																	  100,
																	  0,
																	  0,
																	  -2147483648});
			...
			this.udRXGain0.TabIndex = 188;
			this.udRXGain0.Value = new System.Decimal(new int[] {
																	0,
																	0,
																	0,
																	0});
			...
			// chkHideTuneStep
			// 
			this.chkHideTuneStep.Image = null;
			this.chkHideTuneStep.Location = new System.Drawing.Point(80, 432);
			this.chkHideTuneStep.Name = "chkHideTuneStep";
			this.chkHideTuneStep.TabIndex = 204;
			this.chkHideTuneStep.Text = "Hide Tune Step";
			this.chkHideTuneStep.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
			this.chkHideTuneStep.CheckedChanged += new System.EventHandler(this.chkHideTuneStep_CheckedChanged);
			// 
			// XVTRForm
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
			this.ClientSize = new System.Drawing.Size(896, 462);
			this.Controls.Add(this.chkHideTuneStep);
			...
			this.Closing += new System.ComponentModel.CancelEventHandler(this.UCBXVTRForm_Closing);
		...
		public void SaveSettings()
		{
			...
			DB.SaveVars("XVTR", ref a);		// save the values to the DB
		}
		...
		public void RestoreSettings()
		{
			...
			ArrayList a = DB.GetVars("XVTR");				// Get the saved list of controls
			a.Sort();
		...
		private void chkHideTuneStep_CheckedChanged(object sender, System.EventArgs e)
		{
			console.HideTuneStep = !chkHideTuneStep.Checked;
		}

		private void UCBXVTRForm_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
			this.Hide();
			e.Cancel = true;
		}
