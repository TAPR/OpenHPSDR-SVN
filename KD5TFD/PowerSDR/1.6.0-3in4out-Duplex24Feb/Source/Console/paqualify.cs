...
//			}
		...
		private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
		{
			...
			text += "\nEnter these values when prompted by the PowerSDR Setup wizard.";
			e.Graphics.DrawString(text, 
				new Font("Lucida Console", 11), Brushes.Black, 80, 80);

			text = "Documentation Information";
			e.Graphics.DrawString(text,
				new Font("Times New Roman", 14, FontStyle.Bold), Brushes.Black, 80, 370);

			text = "All manuals and software can be downloaded from www.flex-radio.com (click on download)";
			e.Graphics.DrawString(text,
				new Font("Times New Roman", 12), Brushes.Black, 80, 400);

			text = "Important documents to read are:\n" +
				"\t1. SDR-1000 Operating Manual\n" +
				"\t2. Delta 44 Quick Start Guide\n" +
				"\t3. PowerSDR Quick Start Guide\n" +
				"\nSchematics and Hardware Installation guides can be downloaded from:\n"+
				"URL: http://www.flex-radio.com/Download     (All case sensitive)\n"+
				"user: FlexRadioCustomer      pass: futureofradio\n" +
			...
			e.Graphics.DrawString(text,
				new Font("Times New Roman", 12), Brushes.Black, 80, 430);

			text = "Warning:";
			e.Graphics.DrawString(text,
				new Font("Times New Roman", 14, FontStyle.Bold), Brushes.Black, 80, 720);
			...
			e.Graphics.DrawString(text,
				new Font("Times New Roman", 12, FontStyle.Regular), Brushes.Black, 80, 750);			
		}
