...
//			modes.Add(new DataBind(9, "DRM"));
			...
			filters.Add(new DataBind(0, "6.0kHz"));
			filters.Add(new DataBind(1, "4.0kHz"));
			filters.Add(new DataBind(2, "2.6kHz"));
			filters.Add(new DataBind(3, "2.1kHz"));
			filters.Add(new DataBind(4, "1.0kHz"));
			filters.Add(new DataBind(5, "500Hz"));
			filters.Add(new DataBind(6, "250Hz"));
			filters.Add(new DataBind(7, "100Hz"));
			filters.Add(new DataBind(8, "50Hz"));
			filters.Add(new DataBind(9, "25Hz"));
			...
			step_sizes.Add(new DataBind(2, "100Hz"));
			step_sizes.Add(new DataBind(3, "1kHz"));
			step_sizes.Add(new DataBind(4, "10kHz"));
			step_sizes.Add(new DataBind(5, "100kHz"));
			step_sizes.Add(new DataBind(6, "1MHz"));
			step_sizes.Add(new DataBind(7, "10MHz"));
