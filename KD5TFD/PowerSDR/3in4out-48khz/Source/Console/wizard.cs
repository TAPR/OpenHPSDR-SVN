	...
	public class SetupWizard : System.Windows.Forms.Form
	{
			...
			switch(p)
			{
				case Page.WELCOME:
					...
					lblMessage1.Text = "Welcome to the PowerSDR Setup Wizard.  This Setup Wizard is " +
						...
						"and can be emailed to eric@flex-radio.com or posted on our forums at " +
		...
		private void btnFinished_Click(object sender, System.EventArgs e)
		{
			...
			if(sound_card_index >= 0)
				console.CurrentSoundCard = (SoundCard)sound_card_index;
			if(xvtr_present)
		...
		private void comboBox3_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			if(comboBox3.Text == "Unsupported Card")
				MessageBox.Show("Proper operation of the SDR-1000 depends on the use of a sound card that is\n"+
					"officially supported by FlexRadio Systems.  Refer to the Specifications page on\n"+
					"www.flex-radio.com to determine which sound cards are currently supported.  Use only\n"+
					...
					"THAN THOSE CURRENTLY SUPPORTED AS STATED ON THE FLEXRADIO SYSTEMS WEBSITE.\n"+
