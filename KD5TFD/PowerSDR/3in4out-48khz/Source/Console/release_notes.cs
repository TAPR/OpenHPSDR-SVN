...
//		Description:	The TX Profile controls have been modified so that when
...
//		Description:	The variable filters are designed to remember their
...
//		Description:	We rewrote the level calibration routine and it now
...
//						enabled.
//		Description:	This was a problem with how we handled turning off the
...
//		Description:	This problem was caused by processing the silenced
...
//		Description:	This issue was due to multiple calls to StartKeyer
...
//		Description:	This was an oversight and is now fixed. 
//      Reported by:	NJ1H
//		Fixed by:		KE5DTO 
...
//		Description:	This is due to the tuning limits for SoftRock Tuning
...
//		Description:	Tuning is not correct for DRM mode with SoftRock.
...
//		Description:	This turned out to be an initialization ordering bug.
...
//						manually selected.
//		Description:	With the changes to the ATU related controls, we failed
...
//		Description:	In many places in the display code there were hard coded
...
//		Description:	The DSP core has been returned to operating on signals in the
...
//		Description:	In the continuing tradition of allowing monitoring of every
...
//		Description:	The DRM receive filter was about 1 kHz (!) too wide. The DRM
//						and DREAM measured SNR both went up after this modification.
//		Coded By:		N4HY
//
//		Feature:		AGC Slope Setting.
//		Description:	The AGC Slope was in steps of centiBels and was confusing.
...
//		Description:	In the DSP code, if the ring buffer loading and
...
//		Description:	This issue stems from problems with importing
...
//		Description:	This state was not being handled properly in the event
//						handler for the TUN button.  This has been fixed.
//		Fixed By:		KE5DTO
//		SVN Rev:		310		
//
//		Issue:			Preview 16 crashes on startup.
//		Description:	This was a problem with initialization after the
...
//		Description:	We have added a hard clipper at 1.5V RMS to protect the
...
//		Description:	Upon MOX, PTT, key press and/or release and at random
...
//		Description:	This is another case of the initialization monster.
...
//		Description:	There was a race condition in the UpdateMultimeter
...
//						VFO frequency.
//		Description:	This was a visual bug only (frequency stayed locked).
//						The VFO no longer changes when it is locked.
//		Reported By:	W4TME
//		Fixed By:		KE5DTO
//
//		Issue:			BIN does not work in AM/SAM/FM modes.
//		Description:	This is not really a bug, but more of a consequence
...
//		Description:	This was a bug and it has been fixed.  Also, the TUN
...
//		Description:	There was a bug in the PollPTT() function that would
...
//		Description:	The default Up/Down control behaviour was causing this
...
//		Description:	In the audio callback processing class there were
...
//		Descruption:	The slope calculation has been included in the agc code.
...
//		Description:	The receive agc now has hang threshold implemented. If the
...
//		Description:	The duration of real world pulses was not taken into account
...
//		Description:	Audio rates of 96000 samples per second and 192000 are
...
//		Description:	The forgetting factor on both BLMS-NR and BLMS-ANF were
...
//		Description:	Ooops.  The TX equalizer call was not wrapped
...
//		Description:	The preset code had all been brought into compliance
...
//		Description:	This was a threading issue.  Added protection prevents
//						functions from being re-entered that could cause
//						problems.
//		Fixed By:		KE5DTO
//
//		Issue:			Mono/Stereo selection on VAC was broken.
//		Description:	Mono/Stereo selection was being attempted irrespective
...
//		Description:	This ended up being an issue related to the new CWX
...
//		Description:	Word space was 5 instead of the standard 7 elements.
//		Reported By:	N6VS
//		Fixed By:		W5SXD
//
//  Modifications:
...
//		Description:	Removed Peak Power meter and replaced it with TX ALC gain
//		Coded By:		N4HY
//
//		Feature:		Leveler default is now on.
//		Description:	Now that we have the ALC working properly, many have
...
//		Description:	The Block LMS ANF and NR are still under development
...
//		Description:	The VAC controls are now enabled by default so you can
//						set them without having to turn it on.
//		Suggested By:	AB1DO
//		Coded By:		KE5DTO
//
//		Feature:		TX EQ Preamp re-enabled.
//		Description:	This control was disabled when we realized the ALC was
...
//		Description:	While removing the TX EQ Preamp (duplicate
...
//		Description:	This gotcha was added to allow the VHF people to view
...
//		Description:	Changes to the TXEQ caused this issue back in Preview
//						12.  This has been fixed.
//		Reported By:	LA9EX
//		Fixed By:		KE5DTO
//
//		Issue:			The filter is not restored after the Level calibration.
//		Description:	This was a result of restoring the filter followed by
...
//		Description:	Zero Beat is now disabled initially until the AVG is
//						turned on.  This keeps the state consistent.
//		Reported By:	KC9FOL
//		Fixed By:		KE5DTO
//
//		Issue:			ALC computed in the wrong place on AM and FM.
//		Description:	The ALC was computed on FM output (where it is not
...
//		Description:	When we changed to the use of pthreads, we
...
//		Description:	The ALC function was being calculated and then
...
//		Description:	There was an inconsistency between the DSP and the GUI
...
//		Description:	This was a design oversight and has been addressed.
//		Reported By:	K2OX
//		Fixed By:		KE5DTO
#endregion
...
//		Description:	There was a bug that caused the display thread to not
...
//		Description:	Similar to the peak bug in a previous version, this bug
...
//		Description:	The title was labeled incorrectly.  This has been fixed
...
//		Issue:			It was a misnomer to call the "MIC setting" meter ALC.
...
//		Description:	As a protective measure, when VFO A changes bands, if
...
//		Description:	The Delta 44 Input and Output level settings (-10dBv,
...
//		Description:	DRM now works in addition to DIGL and DIGU for the Auto
...
//		Description:	The equalizer has been replaced with a simpler design
...
//		Description:	The fast channel of the agc, intended to prevent
...
//		Description:	An ordering problem with the MOX handler was introduced
...
//		Description:	There was one leftover that was overlooked in the
...
//		Description:	This problem was related to the changes made to include
...
//		Description:	There was a bug in the original source where it was
...
//		Description:	While the EQ is being rewritten, this feature has been
...
//		Description:	Because this feature was written before the DIGx modes
...
//		Description:	We (FlexRadio) have made a decision to hold off on
...
//		Description:	The DSP code has been modified to largely use floats
...
//		Description:	We have had custom settings for receive AGC on the
...
//		Description:	Attack setting for the slow channel on the agc was
...
//		Description:	The unimplemented fast attack AGC channel was
...
//		Description:	This was an oversight and has been fixed.
//		Reported By:	KC9FOL
//		Coded By:		KE5DTO
//
//  Modifications:
...
//		Description:	The dual channel agc system is active.  We may not have
...
//		Description:	This problem was due to the abstraction layer for
...
//		Description:	A programming error caused the DC removal in SSB
...
//		Description:	The compressor and compander have been approximately
...
//		Description:	A race condition was found in the hardware code when
...
//		Description:	Changes to the default database caused this issue when
...
//		Description:	The alias free end points were being calculated using
//						the wrong variable.  This has been corrected.
//		Reported By:	K9JRI
//		Coded By:		KD5TFD
//
//		Issue:			RX audio output is low (since around Beta 1.3.11).
//		Description:	The AGC attempts to achieve power 1.0 in the complex
...
//		Description:	The variable center frequency for the Softrock40 was
...
//		Description:	The AF changed flag was being used incorrectly and was
...
//		Description:	When fixing several issues related to changing display
...
//
//		Issue:			DRM is broken.
//		Description:	In the rewrite of the DDSFreq and hardware code, the
...
//		Description:	If you went into SPEC mode or if you did "Phase" display
...
//		Description:	In fixing the AF issues in the previous preview, we
...
//		Description:	When you do not have semi breakin selected,  and you
...
//		Description:	This was an initialization issue that has been fixed.
//		Reported By:	K3IB
//		Coded By:		KE5DTO
#endregion
...
//		Description:	A problem was found within the callback function that
//						was causing this issue.  This has been fixed.
//		Reported By:	N4HY, K5KDN, AH6JR
//		Coded By:		KE5DTO
//
//		Issue:			Misc glitches and audio artifacts.
//		Description:	The way that we were doing VOX within the callback was
...
//						duplicate entries.
//		Description:	This turned out to be a case of poor naming.  In the
...
//		Description:	The MIC scaling was being done to the incoming samples
...
//						not enabled.
//		Description:	With the new options for keying the radio via third
...
//		Description:	While the sliders were being set, the values were not
...
//		Description:	Users with 3 board stacks (no RFE) noticed that we had
...
//		Description:	Careless use of Replace(":", " ") caused an issue with
...
//		Description:	Due to some rearranging associated with the new FireBox
...
//		Description:	Some initialization code associated with the new
...
//		Description:	There was a bug in the XVTR code that was causing the
...
//		Description:	The Leveler is a piece of code intended to level out
...
//		Description:	Compander was accidentally initialized as an expander,
...
//		Description:	The Transmitter ALC had its minimum gain, which set the
...
//		Description:	There was a problem in the hardware code that was
...
//						filters.
//		Description:	The panadapter graphics now limit the filter width to a
...
//		Description:	The save function has been changed to properly handle
...
//		Description:	The function for calculating the max VRMS for the
...
//		Description:	A problem with the new TX RF setting was causing this
//						issue and it is now fixed.
//		Reported By:	K5BOT
//		Coded By:		KE5DTO
//
//		Issue:			VOX and footswitch do not work well together.
//		Description:	If using VOX with a footswitch (or any other automatic
...
//						console to crash.
//		Description:	This was due to poor exception handling.  The driver
...
//		Description:	There were cases where the current filter setting was
...
//		Description:	Due to the way the import algorithm tries to
...
//		Description:	Rather than making these options mutually exclusive
...
//		Description:	The error value needs to be +/-.  This was an oversight
...
//						panel.
//		Description:	This was an oversight that has now been addressed.
//		Reported by:	K3IB
//		Coded By:		KE5DTO
//
//	Modifications:
...
//		Description:	A flaw in the design of the new hardware code was
...
//		Description:	In the recent QST review, it was pointed out that our
...
//		Description:	This problems arises from calling a MessageBox up from
...
//		Description:	This problem can be attributed to default mouse wheel
...
//		Description:	The new checkboxes in 1.4.4 were missing event
...
//		Description:	A logical error was in the database code that caused
...
//		Description:	In sideband modes, we take the microphone, a real input
...
//		Description:	The monitor comes on automatically in CW modes unless
...
//		Description:	There was an ordering problem with the new CW keyer
...
//		Description:	A value of "0.0 %" was being set in the multimeter.  
...
//		Description:	The DrawBackground routine was writing the background
...
//		Description:	The semi breakin control on the setup panel	was
...
//		Description:	When we go to MOX and reset the ring buffers for the
