...
namespace SharpDSP2._1
{
	...
	/// </summary>
	public class PowerSpectrumSignal : IDSPObject
	{
		...
		public void Process()
		{
			...
			{	        	
				...
				{
					tmp_cpx[i].real = d.cpx[i].real * this.window[i];
					tmp_cpx[i].imag = d.cpx[i].imag * this.window[i];				
				}	
                ...
                if (this.psaveragingon)
                {
                    ...
                    ps_event(this, new PSpectrumEvent(ref this.ps_results,
		...
		public PSpectrumEventHandler EventHandler
        {
            get { return ps_event; }
            set { ps_event += value; }
		}
