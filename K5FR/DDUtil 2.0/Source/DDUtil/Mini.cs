...
namespace DataDecoder
{
    public partial class Mini : Form
    {
        ...
        public Mini(Setup setup)
        {
            ...
            if (set.WindowPositionMini != Rectangle.Empty &&
                IsVisibleOnAnyScreen(set.WindowPositionMini))
            {
                // first set the bounds
                this.StartPosition = FormStartPosition.Manual;
                this.DesktopBounds = set.WindowPositionMini;

                // afterwards set the window state to the saved value (which could be Maximized)
                this.WindowState = set.WindowStateMini;
            }
            else
            {
                ...
                if (set.WindowPositionMini != Rectangle.Empty)
                {
                    this.Size = set.WindowPositionMini.Size;
                }
            }
 ...
 //           set.miniGeo = DataDecoder.Setup.GeometryToString(this);
     ...
     //       this.Close();
        ...
        protected override void OnClosed(EventArgs e)
        {
            ...
            switch (this.WindowState)
            {
                ...
                case FormWindowState.Maximized:
                    set.WindowStateMini = this.WindowState;
                    break;

                default:
                    set.WindowStateMini = FormWindowState.Normal;
                    break;
            }
        ...
        private void TrackWindowState()
        {
            ...
            {
                set.WindowPositionMini = this.DesktopBounds;
            }
        }
